...
// 3. gen-гейтед "венцы" (eco_crown_*/mil_crown_* с полем gen:0|1) видны
//    только игроку с ВЫБРАННЫМ конкретным генералом (nodeVisibleFor:
//    n.gen!==(p.gen.id||0)) — генералы на сервер не перенесены вообще
//    (p.gen.id всегда null у новых игроков, mp-join), поэтому венцы сейчас
//    физически недостижимы в общем мире — честно, а не подделано обходом.
//
