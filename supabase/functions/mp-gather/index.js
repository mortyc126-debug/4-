...
// 3. Респаун истощённой точки (index.html: EV.gathered → mapDelete + новый
//    узел через CFG.NODE_RESPAWN) — НЕ перенесён в этом кусочке. Точка с
//    amount:0 просто остаётся на карте пустой, честно как есть — respawn
//    отдельным следующим шагом Фазы 8.
//
