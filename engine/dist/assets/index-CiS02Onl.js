...
`,Et=.5,Y=1.4,Dt=new Float32Array([0,Y,0,Et,0,0,0,0,Et,0,Y,0,0,0,Et,-.5,0,0,0,Y,0,-.5,0,0,0,0,-.5,0,Y,0,0,0,-.5,Et,0,0]),Ot=Dt.length/3,kt=7;async function At(e,t,n){let r=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),i=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),a=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),o=e.createTexture({size:[J,J],format:`depth32float`,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}).createView(),s=e.createSampler({compare:`less`,magFilter:`linear`,minFilter:`linear`}),c=He(-1,1,-1,1,.1,1),l=!0,u=1/0,d=1/0,f=1.5;function p(t,n){let r=t-u,i=n-d;if(!l&&r*r+i*i<f*f)return;u=t,d=n;let o=qe([t+ht[0]*_t,ht[1]*_t,n+ht[2]*_t],[t,0,n],[0,1,0]);c=Be(He(-60,gt,-60,gt,vt,yt),o),e.queue.writeBuffer(a,0,c),l=!0}let[m,h,g,_,v,y,b,x,S,ee,C,w]=await Promise.all([q(e,`/textures/ground/sand.jpg`),q(e,`/textures/ground/grass.jpg`),q(e,`/textures/ground/dry_meadow.jpg`),q(e,`/textures/ground/scree.jpg`),q(e,`/textures/ground/rock.jpg`),q(e,`/textures/ground/snow.jpg`),q(e,`/textures/ground/forest_floor.jpg`),q(e,`/textures/ground/desert.jpg`),q(e,`/textures/ground/marsh.jpg`),q(e,`/textures/ground/tundra_moss.jpg`),q(e,`/textures/water/detail.jpg`),q(e,`/textures/world/regions_borders.png`,2400)]),te=e.createSampler({addressModeU:`repeat`,addressModeV:`repeat`,magFilter:`linear`,minFilter:`linear`}),ne=e.createShaderModule({code:bt}),re=e.createRenderPipeline({layout:`auto`,vertex:{module:ne,entryPoint:`vs`,buffers:[{arrayStride:60,attributes:[{shaderLocation:0,offset:0,format:`float32x3`},{shaderLocation:1,offset:12,format:`float32x3`},{shaderLocation:2,offset:24,format:`float32x3`},{shaderLocation:3,offset:36,format:`float32x2`},{shaderLocation:4,offset:44,format:`float32`},{shaderLocation:5,offset:48,format:`float32`},{shaderLocation:6,offset:52,format:`float32`},{shaderLocation:7,offset:56,format:`float32`}]}]},fragment:{module:ne,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`,cullMode:`back`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),ie=e.createBindGroup({layout:re.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}},{binding:2,resource:te},{binding:3,resource:m.createView()},{binding:4,resource:h.createView()},{binding:5,resource:g.createView()},{binding:6,resource:_.createView()},{binding:7,resource:v.createView()},{binding:8,resource:{buffer:a}},{binding:9,resource:s},{binding:10,resource:o},{binding:11,resource:y.createView()},{binding:12,resource:b.createView()},{binding:13,resource:x.createView()},{binding:14,resource:S.createView()},{binding:15,resource:ee.createView()},{binding:16,resource:C.createView()},{binding:17,resource:w.createView()}]}),[ae,T]=await Promise.all([q(e,`/textures/sky/sky.jpg`),q(e,`/textures/sky/clouds.png`)]),oe=e.createSampler({addressModeU:`repeat`,addressModeV:`clamp-to-edge`,magFilter:`linear`,minFilter:`linear`}),se=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),ce=e.createShaderModule({code:Tt}),le=e.createRenderPipeline({layout:`auto`,vertex:{module:ce,entryPoint:`vs`},fragment:{module:ce,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`,cullMode:`none`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!1,depthCompare:`always`}}),E=e.createBindGroup({layout:le.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:se}},{binding:1,resource:oe},{binding:2,resource:ae.createView()},{binding:3,resource:T.createView()}]}),ue=new Float32Array(16);function de(t,n,r,i,a,o){let s=ue;s[0]=t[0],s[1]=t[1],s[2]=t[2],s[3]=0,s[4]=n[0],s[5]=n[1],s[6]=n[2],s[7]=0,s[8]=r[0],s[9]=r[1],s[10]=r[2],s[11]=0,s[12]=i,s[13]=a,s[14]=o,s[15]=0,e.queue.writeBuffer(se,0,s)}let fe=e.createShaderModule({code:Ct}),pe=e.createRenderPipeline({layout:`auto`,vertex:{module:fe,entryPoint:`vs`,buffers:[{arrayStride:60,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]}]},primitive:{topology:`triangle-list`,cullMode:`back`},depthStencil:{format:`depth32float`,depthWriteEnabled:!0,depthCompare:`less`}}),me=e.createBindGroup({layout:pe.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:a}}]}),D=new Set;function he(e){return e===`world-backdrop`?`backdrop`:e.startsWith(`far:`)?`far`:`near`}let O={near:null,far:null,backdrop:null},ge=t=>new mt({createBuffer(n){O[t]?.destroy(),O[t]=e.createBuffer({size:n,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST})},write(n,r){let i=O[t];i&&e.queue.writeBuffer(i,n,r,0,r.length)}}),_e={near:ge(`near`),far:ge(`far`),backdrop:ge(`backdrop`)},ve=e.createShaderModule({code:xt}),ye=e.createBuffer({size:Dt.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(ye,0,Dt);let k=e.createRenderPipeline({layout:`auto`,vertex:{module:ve,entryPoint:`vs`,buffers:[{arrayStride:12,stepMode:`vertex`,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]},{arrayStride:28,stepMode:`instance`,attributes:[{shaderLocation:1,offset:0,format:`float32x3`},{shaderLocation:2,offset:12,format:`float32`},{shaderLocation:3,offset:16,format:`float32x3`}]}]},fragment:{module:ve,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),be=e.createBindGroup({layout:k.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}}]}),A=null,xe=null,Se=0,j=0,Ce=e.createShaderModule({code:St});function we(t){let n=e.createBuffer({size:Math.max(t.vertexCount*10*4,4),usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),r=new Float32Array(t.vertexCount*10);for(let e=0;e<t.vertexCount;e++)r.set(t.positions.subarray(e*3,e*3+3),e*10),r.set(t.normals.subarray(e*3,e*3+3),e*10+3),r[e*10+6]=t.materialIds[e],r[e*10+7]=t.shades[e],r.set(t.uvs.subarray(e*2,e*2+2),e*10+8);return e.queue.writeBuffer(n,0,r),n}let Te=await Promise.all(Object.entries({bark:`/textures/decor/bark.jpg`,birchBark:`/textures/decor/birch_bark.jpg`,conifer:`/textures/decor/conifer_a.png`,conifer2:`/textures/decor/conifer_b.png`,broadleaf:`/textures/decor/broadleaf.png`,autumn:`/textures/decor/autumn.png`,birchLeaf:`/textures/decor/birch_leaf.png`,bush:`/textures/decor/bush.png`,grassTuft:`/textures/decor/grass_tuft.png`}).map(async([t,n])=>[t,await q(e,n)])),M={...Object.fromEntries(Te),rock:v},N=e.createSampler({magFilter:`linear`,minFilter:`linear`}),P={spruce:{trunk:`bark`,canopy:`conifer`},pine:{trunk:`bark`,canopy:`conifer2`},broadleaf:{trunk:`bark`,canopy:`broadleaf`},autumn:{trunk:`bark`,canopy:`autumn`},birch:{trunk:`birchBark`,canopy:`birchLeaf`},dead:{trunk:`bark`,canopy:`bark`},bush:{trunk:`bark`,canopy:`bush`},grass:{trunk:`bark`,canopy:`grassTuft`},rock:{trunk:`bark`,canopy:`rock`}},Ee={spruce:nt,pine:rt,broadleaf:G,autumn:G,birch:it,dead:at,bush:ot,grass:st,rock:pt},De=[{arrayStride:40,stepMode:`vertex`,attributes:[{shaderLocation:0,offset:0,format:`float32x3`},{shaderLocation:1,offset:12,format:`float32x3`},{shaderLocation:2,offset:24,format:`float32`},{shaderLocation:3,offset:28,format:`float32`},{shaderLocation:4,offset:32,format:`float32x2`}]},{arrayStride:40,stepMode:`instance`,attributes:[{shaderLocation:5,offset:0,format:`float32x3`},{shaderLocation:6,offset:12,format:`float32x3`},{shaderLocation:7,offset:24,format:`float32`},{shaderLocation:8,offset:28,format:`float32x3`}]}],Oe=e.createRenderPipeline({layout:`auto`,vertex:{module:Ce,entryPoint:`vs`,buffers:De},fragment:{module:Ce,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),ke=e.createShaderModule({code:wt}),Ae=e.createRenderPipeline({layout:`auto`,vertex:{module:ke,entryPoint:`vs`,buffers:De},fragment:{module:ke,entryPoint:`fs`,targets:[]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth32float`,depthWriteEnabled:!0,depthCompare:`less`}}),F=new Map;for(let t of Object.keys(P)){let n=Ee[t](),c=P[t],l=e.createBindGroup({layout:Oe.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}},{binding:2,resource:N},{binding:3,resource:M[c.trunk].createView()},{binding:4,resource:M[c.canopy].createView()},{binding:5,resource:{buffer:a}},{binding:6,resource:s},{binding:7,resource:o}]}),u=e.createBindGroup({layout:Ae.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:a}},{binding:1,resource:N},{binding:2,resource:M[c.canopy].createView()}]});F.set(t,{mesh:n,localBuf:we(n),instBuf:null,instCapacity:0,instanceCount:0,bindGroup:l,shadowBindGroup:u,scratch:null,shadowInstBuf:null,shadowInstCapacity:0,shadowInstanceCount:0,shadowScratch:null})}let I=null,L=null;function je(){let n=t.canvas.width,r=t.canvas.height;I&&I.width===n&&I.height===r||(I?.destroy(),I=e.createTexture({size:[n,r],format:`depth24plus`,usage:GPUTextureUsage.RENDER_ATTACHMENT}),L=I.createView())}function R(e,t){let n=new Float32Array(t.vertexCount*15);for(let e=0;e<t.vertexCount;e++)n.set(t.positions.subarray(e*3,e*3+3),e*15),n.set(t.colors.subarray(e*3,e*3+3),e*15+3),n.set(t.normals.subarray(e*3,e*3+3),e*15+6),n.set(t.uvs.subarray(e*2,e*2+2),e*15+9),n[e*15+11]=t.elevations[e],n[e*15+12]=t.waterFlags[e],n[e*15+13]=t.forestFracs[e],n[e*15+14]=t.moistureFracs[e];D.add(e);let r=he(e);_e[r].put(e,n,t.vertexCount),r===`near`&&(l=!0)}function Me(e){if(!D.has(e))return;D.delete(e);let t=he(e);_e[t].remove(e),t===`near`&&(l=!0)}function Ne(t){if(j=t.length,j>Se&&(A?.destroy(),Se=Math.max(j,8),A=e.createBuffer({size:Se*kt*4,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),xe=new Float32Array(Se*kt)),j===0||!A)return;let n=xe;t.forEach((e,t)=>{let r=t*kt;n[r]=e.x,n[r+1]=e.y,n[r+2]=e.z,n[r+3]=1,n[r+4]=e.color[0],n[r+5]=e.color[1],n[r+6]=e.color[2]}),e.queue.writeBuffer(A,0,n,0,j*kt)}function z(t,n,r){let i=t.scratch;if(!i||t.instanceCount===0){t.shadowInstanceCount=0;return}let a=n-gt,o=n+gt,s=r-gt,c=r+gt;t.instanceCount>t.shadowInstCapacity&&(t.shadowInstBuf?.destroy(),t.shadowInstCapacity=Math.max(t.instanceCount,8),t.shadowInstBuf=e.createBuffer({size:t.shadowInstCapacity*10*4,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),t.shadowScratch=new Float32Array(t.shadowInstCapacity*10));let l=t.shadowScratch,u=0;for(let e=0;e<t.instanceCount;e++){let t=e*10,n=i[t],r=i[t+2];n<a||n>o||r<s||r>c||(l.set(i.subarray(t,t+10),u*10),u++)}t.shadowInstanceCount=u,u>0&&t.shadowInstBuf&&e.queue.writeBuffer(t.shadowInstBuf,0,l,0,u*10)}function Pe(t,n){let r=t.length;if(r>n.instCapacity&&(n.instBuf?.destroy(),n.instCapacity=Math.max(r,8),n.instBuf=e.createBuffer({size:n.instCapacity*10*4,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),n.scratch=new Float32Array(n.instCapacity*10)),n.instanceCount=r,r===0||!n.instBuf)return;let i=n.scratch;t.forEach((e,t)=>{let n=t*10;i[n]=e.x,i[n+1]=e.y,i[n+2]=e.z,i[n+3]=e.scale[0],i[n+4]=e.scale[1],i[n+5]=e.scale[2],i[n+6]=e.yaw,i[n+7]=e.color[0],i[n+8]=e.color[1],i[n+9]=e.color[2]}),e.queue.writeBuffer(n.instBuf,0,i,0,r*10)}function Fe(e){let t=new Map;for(let n of e){let e=t.get(n.kind);e||(e=[],t.set(n.kind,e)),e.push(n)}for(let[e,n]of F)Pe(t.get(e)??[],n);l=!0}function Ie(t){e.queue.writeBuffer(r,0,t)}let Le=new Float32Array(8);function B(t,n,r,a){let o=Le;o[0]=t[0],o[1]=t[1],o[2]=t[2],o[3]=a,o[4]=n[0],o[5]=n[1],o[6]=n[2],o[7]=r,e.queue.writeBuffer(i,0,o)}function Re(n,r){je();let i=e.createCommandEncoder();if(l){let e=i.beginRenderPass({colorAttachments:[],depthStencilAttachment:{view:o,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}});_e.near.vertexCount>0&&O.near&&(e.setPipeline(pe),e.setBindGroup(0,me),e.setVertexBuffer(0,O.near),e.draw(_e.near.vertexCount));let t=!1;for(let e of F.values()){if(e.instanceCount===0){e.shadowInstanceCount=0;continue}z(e,u,d),e.shadowInstanceCount>0&&(t=!0)}if(t){e.setPipeline(Ae);for(let t of F.values())t.shadowInstanceCount===0||!t.shadowInstBuf||(e.setBindGroup(0,t.shadowBindGroup),e.setVertexBuffer(0,t.localBuf),e.setVertexBuffer(1,t.shadowInstBuf),e.draw(t.mesh.vertexCount,t.shadowInstanceCount))}e.end(),l=!1}let a=t.getCurrentTexture().createView(),s=i.beginRenderPass({colorAttachments:[{view:a,clearValue:n,loadOp:`clear`,storeOp:`store`}],depthStencilAttachment:{view:L,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}});if(s.setPipeline(le),s.setBindGroup(0,E),s.draw(3),D.size>0){s.setPipeline(re),s.setBindGroup(0,ie);for(let e of[`near`,`far`,`backdrop`]){let t=_e[e],n=O[e];t.vertexCount===0||!n||(s.setVertexBuffer(0,n),s.draw(t.vertexCount))}}j>0&&A&&(s.setPipeline(k),s.setBindGroup(0,be),s.setVertexBuffer(0,ye),s.setVertexBuffer(1,A),s.draw(Ot,j));let c=!1;for(let e of F.values())if(e.instanceCount>0){c=!0;break}if(c){s.setPipeline(Oe);for(let e of F.values())e.instanceCount===0||!e.instBuf||(s.setBindGroup(0,e.bindGroup),s.setVertexBuffer(0,e.localBuf),s.setVertexBuffer(1,e.instBuf),s.draw(e.mesh.vertexCount,e.instanceCount))}r?.(s),s.end(),e.queue.submit([i.finish()])}function V(){return{lightBuf:a,shadowView:o,shadowSampler:s}}return{setTerrainChunk:R,removeTerrainChunk:Me,setMarkers:Ne,setDecor:Fe,setVP:Ie,setFog:B,setSunTarget:p,setSkyCamera:de,getShadowResources:V,frame:Re}}var X=12345,jt=.235,Mt=2400,Nt=1200,Pt=Mt/2;Nt/2;var Ft=2.5;function Z(e,t,n){let r=e*374761393+t*668265263+n*1274126177;return r=Math.imul(r^r>>>13,1274126177),((r^r>>>16)>>>0)/4294967296}function It(e,t,n){let r=Math.floor(e),i=Math.floor(t),a=e-r,o=t-i,s=a*a*(3-2*a),c=o*o*(3-2*o),l=Z(r,i,n),u=Z(r+1,i,n),d=Z(r,i+1,n),f=Z(r+1,i+1,n);return(l*(1-s)+u*s)*(1-c)+(d*(1-s)+f*s)*c}var Lt=null,Rt=null,zt=null;async function Bt(e,t){let n=await fetch(e);if(!n.ok)throw Error(`${e}: HTTP ${n.status}`);let r=await n.arrayBuffer();if(r.byteLength!==t)throw Error(`${e}: неверный размер (${r.byteLength} байт, ожидалось ${t})`);return r}async function Vt(){let e=Mt*Nt,[t,n,r]=await Promise.all([Bt(`/heightmap/elevation-v6.bin`,e*2),Bt(`/heightmap/forest.bin`,e),Bt(`/heightmap/moisture.bin`,e)]);Lt=new Uint16Array(t),Rt=new Uint8Array(n),zt=new Uint8Array(r)}function Q(e,t,n,r){let i=Math.floor(t),a=Math.floor(n),o=Math.min(i+1,2399),s=Math.min(a+1,1199),c=t-i,l=n-a,u=a*Mt+i,d=a*Mt+o,f=s*Mt+i,p=s*Mt+o,m=e[u]+(e[d]-e[u])*c;return(m+(e[f]+(e[p]-e[f])*c-m)*l)*r}function Ht(e,t){return[Math.max(0,Math.min(2399,e+Pt)),Math.max(0,Math.min(1199,t+600))]}function Ut(e,t){if(!Lt)return .285;let[n,r]=Ht(e,t);return Q(Lt,n,r,Ft/65535)}function Wt(e,t){let n=Ut(e,t),r=(Ut(e+.7,t)+Ut(e-.7,t)+Ut(e,t+.7)+Ut(e,t-.7))*.25;return n*.55+r*.45}var Gt=32,Kt=new Map;function qt(e,t){return Math.floor(e/Gt)+`,`+Math.floor(t/Gt)}function Jt(e,t,n){let r={x:e,z:t,targetH:Math.max(Wt(e,t),.245),radius:n},i=qt(e,t),a=Kt.get(i);a?a.push(r):Kt.set(i,[r])}function $(e,t){let n=Ut(e,t);if(n<.235||Kt.size===0)return n;let r=Math.floor(e/Gt),i=Math.floor(t/Gt),a=0,o=0;for(let n=-1;n<=1;n++)for(let s=-1;s<=1;s++){let c=Kt.get(r+s+`,`+(i+n));if(c)for(let n of c){let r=Math.hypot(e-n.x,t-n.z);if(r>=n.radius)continue;let i=n.radius*.55,s=r<=i?1:1-((r-i)/(n.radius-i))**2*(3-2*((r-i)/(n.radius-i)));a+=s,o+=s*n.targetH}}return a<=0?n:a>=1?o/a:n*(1-a)+o}function Yt(e,t){return $(e,t)<jt}function Xt(e,t){if(!zt)return .5;let[n,r]=Ht(e,t);return Q(zt,n,r,1/255)}function Zt(e,t){if(!Rt)return 0;let[n,r]=Ht(e,t);return Q(Rt,n,r,1/255)}var Qt=(e,t,n)=>[e[0]+(t[0]-e[0])*n,e[1]+(t[1]-e[1])*n,e[2]+(t[2]-e[2])*n],$t=[.14,.24,.28],en=[.05,.11,.19];function tn(e){return Qt($t,en,Math.min(1,e))}var nn=[0,1,0],rn=6;function an(e,t){let n=.5,r=$(e-n,t)*13,i=$(e+n,t)*13,a=$(e,t-n)*13,o=$(e,t+n)*13;return H([-(i-r)/(2*n),1,-(o-a)/(2*n)])}var on=6;function sn(e,t,n){let r=n/2,i=1/0;for(let a=0;a<=on;a++){let o=-r+a/on*n;for(let a=0;a<=on;a++){let s=$(e+(-r+a/on*n),t+o);s<i&&(i=s)}}return i}function cn(e,t,n,r,i=1,a=0){let o=Math.round((n-e)/i),s=Math.round((r-t)/i),c=i===1,l=[],u=[],d=[],f=[],p=[],m=[],h=[],g=[];function _(e,t){let n=c?$(e,t):sn(e,t,i),r=n<jt,o=r?[e,jt*13-a,t]:[e,n*13-a,t],s=r?tn((jt-n)*3):[0,0,0],l=r?nn:c?an(e,t):nn,u=r?0:Zt(e,t),d=r?0:Xt(e,t);return{p:o,c:s,n:l,uv:[e/rn,t/rn],e:n,water:+!!r,forest:u,moisture:d}}let v=[];for(let n=0;n<=s;n++){let r=[];for(let a=0;a<=o;a++)r.push(_(e+a*i,t+n*i));v.push(r)}function y(e,t,n){let r=c?null:H(ze(Re(t.p,e.p),Re(n.p,e.p)));for(let i of[e,t,n]){l.push(i.p[0],i.p[1],i.p[2]),u.push(i.c[0],i.c[1],i.c[2]);let e=r??i.n;d.push(e[0],e[1],e[2]),f.push(i.uv[0],i.uv[1]),p.push(i.e),m.push(i.water),h.push(i.forest),g.push(i.moisture)}}for(let e=0;e<s;e++)for(let t=0;t<o;t++){let n=v[e][t],r=v[e][t+1],i=v[e+1][t],a=v[e+1][t+1];y(n,a,r),y(n,i,a)}return{positions:new Float32Array(l),colors:new Float32Array(u),normals:new Float32Array(d),uvs:new Float32Array(f),elevations:new Float32Array(p),waterFlags:new Float32Array(m),forestFracs:new Float32Array(h),moistureFracs:new Float32Array(g),vertexCount:l.length/3}}var ln=9,un=10,dn=380,fn={d:[1,0],arrowright:[1,0],a:[-1,0],arrowleft:[-1,0],w:[0,1],arrowup:[0,1],s:[0,-1],arrowdown:[0,-1]},pn=700;function mn(e,t){let n=!0,r=new Map,i=null,a=null,o=null,s=null,c=null,l=null,u=null,d=!1,f=null;function p(){n=!1,f?.()}function m(){let e=[...r.values()];return{x:(e[0].x+e[1].x)/2,y:(e[0].y+e[1].y)/2,d:Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y)}}function h(){let e=[...r.values()];return Math.atan2(e[1].y-e[0].y,e[1].x-e[0].x)}function g(e,n){let r=t.dist*.0022,i=e*r,a=n*r,o=Math.cos(t.yaw),s=Math.sin(t.yaw);t.target[0]=Math.max(-Pt,Math.min(Pt,t.target[0]-(i*o-a*s))),t.target[2]=Math.max(-600,Math.min(600,t.target[2]+(i*s+a*o))),t.target[1]=$(t.target[0],t.target[2])*13+1}e.addEventListener(`pointerdown`,n=>{n.preventDefault(),p(),r.set(n.pointerId,{x:n.clientX,y:n.clientY});try{e.setPointerCapture(n.pointerId)}catch{}if(r.size===1)d=!!c?.(n.clientX,n.clientY),d?(i=null,o={x:n.clientX,y:n.clientY,t:performance.now()}):(i={x:n.clientX,y:n.clientY,tx:t.target[0],tz:t.target[2]},o={x:n.clientX,y:n.clientY,t:performance.now()});else if(r.size===2){d&&(d=!1,u?.(NaN,NaN)),i=null,o=null;let e=m();a={d:e.d,y:e.y,dist:t.dist,yaw:t.yaw,pitch:t.pitch,angle:h()}}}),e.addEventListener(`pointermove`,e=>{if(r.has(e.pointerId)){if(e.preventDefault(),r.set(e.pointerId,{x:e.clientX,y:e.clientY}),o&&Math.hypot(e.clientX-o.x,e.clientY-o.y)>un&&(o=null),d){l?.(e.clientX,e.clientY);return}if(r.size>=2&&a){let e=m();t.dist=Math.max(ln,Math.min(140,a.dist*(a.d/Math.max(12,e.d)))),t.yaw=a.yaw+(h()-a.angle),t.pitch=Math.max(.08,Math.min(1.42,a.pitch+(e.y-a.y)*.005));return}i&&(t.target[0]=i.tx,t.target[2]=i.tz,g(e.clientX-i.x,i.y-e.clientY))}});function _(e){let n=!!(o&&r.size===1&&performance.now()-o.t<dn);if(d&&(d=!1,u?.(n?NaN:e.clientX,n?NaN:e.clientY)),n&&s?.(o.x,o.y),o=null,r.delete(e.pointerId),r.size<2&&(a=null),r.size===0)i=null;else if(r.size===1){let e=[...r.values()][0];i={x:e.x,y:e.y,tx:t.target[0],tz:t.target[2]}}}e.addEventListener(`pointerup`,_),e.addEventListener(`pointercancel`,_),e.addEventListener(`wheel`,e=>{e.preventDefault(),p(),t.dist=Math.max(ln,Math.min(140,t.dist*(e.deltaY<0?.9:1.11)))},{passive:!1});let v=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();t in fn&&(v.add(t),p())}),window.addEventListener(`keyup`,e=>{v.delete(e.key.toLowerCase())});let y=null;function b(e){if(y===null){y=e;return}let t=Math.min(.1,(e-y)/1e3);if(y=e,v.size===0||i)return;let n=0,r=0;for(let e of v){let[t,i]=fn[e];n+=t,r+=i}(n!==0||r!==0)&&g(n*pn*t,r*pn*t)}return{isAutoOrbiting:()=>n,stopAuto:p,update:b,onGrab(e,t,n){c=e,l=t,u=n},onTap(e){s=e},onInteract(e){f=e}}}var hn={5121:Uint8Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},gn={SCALAR:1,VEC2:2,VEC3:3,VEC4:4};async function _n(e){let t=await(await fetch(e)).arrayBuffer(),n=new DataView(t);if(n.getUint32(0,!0)!==1179937895)throw Error(`не glTF-контейнер: `+e);let r=n.getUint32(8,!0),i=12,a=null,o=null;for(;i<r;){let e=n.getUint32(i,!0),r=n.getUint32(i+4,!0),s=t.slice(i+8,i+8+e);r===1313821514?a=JSON.parse(new TextDecoder().decode(s)):r===5130562&&(o=s),i+=8+e}if(!a||!o)throw Error(`GLB без JSON/BIN чанка: `+e);let s=e=>a.accessors[e],c=e=>a.bufferViews[e];function l(e){let t=s(e),n=c(t.bufferView),r=hn[t.componentType],i=(n.byteOffset||0)+(t.byteOffset||0);return new r(o,i,t.count*gn[t.type])}let u=a.meshes[0].primitives[0],d=l(u.attributes.POSITION),f=l(u.attributes.NORMAL),p=l(u.attributes.TEXCOORD_0),m=l(u.indices),h=a.materials[u.material].pbrMetallicRoughness.baseColorTexture.index,g=a.images[a.textures[h].source],_=c(g.bufferView);return{positions:d,normals:f,uvs:p,indices:m,imageBytes:o.slice(_.byteOffset||0,(_.byteOffset||0)+_.byteLength),imageMimeType:g.mimeType}}var vn=`
...
`;async function yn(e,t){let n=e.createBuffer({size:t.positions.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(n,0,t.positions);let r=e.createBuffer({size:t.normals.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(r,0,t.normals);let i=e.createBuffer({size:t.uvs.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(i,0,t.uvs);let a=t.indices.byteLength,o=Math.ceil(a/4)*4,s=e.createBuffer({size:o,usage:GPUBufferUsage.INDEX|GPUBufferUsage.COPY_DST});if(o===a)e.queue.writeBuffer(s,0,t.indices);else{let n=new Uint8Array(o);n.set(new Uint8Array(t.indices.buffer,t.indices.byteOffset,a)),e.queue.writeBuffer(s,0,n)}let c=await createImageBitmap(new Blob([t.imageBytes],{type:t.imageMimeType})),l=Math.min(1,1024/Math.max(c.width,c.height)),u=l<1?await createImageBitmap(c,{resizeWidth:Math.round(c.width*l),resizeHeight:Math.round(c.height*l),resizeQuality:`medium`}):c;l<1&&c.close();let d=e.createTexture({size:[u.width,u.height],format:`rgba8unorm`,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT});return e.queue.copyExternalImageToTexture({source:u},{texture:d},[u.width,u.height]),u.close(),{vao:{posBuf:n,nrmBuf:r,uvBuf:i,idxBuf:s,indexFormat:t.indices instanceof Uint16Array?`uint16`:`uint32`,indexCount:t.indices.length},texture:d}}function bn(e,t,n){let r=e.createShaderModule({code:vn}),i=e.createRenderPipeline({layout:`auto`,vertex:{module:r,entryPoint:`vs`,buffers:[{arrayStride:12,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]},{arrayStride:12,attributes:[{shaderLocation:1,offset:0,format:`float32x3`}]},{arrayStride:8,attributes:[{shaderLocation:2,offset:0,format:`float32x2`}]}]},fragment:{module:r,entryPoint:`fs`,targets:[{format:t}]},primitive:{topology:`triangle-list`,cullMode:`back`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),a=e.createSampler({magFilter:`linear`,minFilter:`linear`,mipmapFilter:`linear`}),o=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});function s(t,n,r){let i=l;i[0]=t[0],i[1]=t[1],i[2]=t[2],i[3]=0,i[4]=n[0],i[5]=n[1],i[6]=n[2],i[7]=r,e.queue.writeBuffer(o,0,i)}let c=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),l=new Float32Array(8);function u(t){e.queue.writeBuffer(c,0,t)}function d(t,r){let s=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return e.queue.writeBuffer(s,0,r),{model:t,modelBuf:s,bindGroup:e.createBindGroup({layout:i.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:c}},{binding:1,resource:a},{binding:2,resource:t.texture.createView()},{binding:3,resource:{buffer:o}},{binding:4,resource:{buffer:n.lightBuf}},{binding:5,resource:n.shadowSampler},{binding:6,resource:n.shadowView},{binding:7,resource:{buffer:s}}]})}}function f(e){if(e)try{e.modelBuf.destroy()}catch{}}function p(e){e.setPipeline(i)}function m(e,t){e.setBindGroup(0,t.bindGroup),e.setVertexBuffer(0,t.model.vao.posBuf),e.setVertexBuffer(1,t.model.vao.nrmBuf),e.setVertexBuffer(2,t.model.vao.uvBuf),e.setIndexBuffer(t.model.vao.idxBuf,t.model.vao.indexFormat),e.drawIndexed(t.model.vao.indexCount)}return{createInstance:d,destroyInstance:f,beginModels:p,draw:m,setFog:s,setVP:u}}var xn={food:`farm`,wood:`sawmill`,stone:`quarry`,gold:`gold-mine`,amber:`amber-vein`},Sn={food:`Пашня`,wood:`Лесопилка`,stone:`Каменоломня`,gold:`Рудник`,amber:`Янтарная жила`};function Cn(e){return e>=25?5:e>=19?4:e>=13?3:e>=7?2:1}function wn(){try{let e=window.parent;if(e&&e!==window){let t=e.mpWorldSnapshot;if(typeof t==`function`){let e=t();if(e)return e}if(e.W)return e.W}}catch{}return null}function Tn(){let e=wn();return!e||!e.players[0]?null:{x:e.players[0].x,y:e.players[0].y}}var En=16;function Dn(e,t,n){let r=wn();if(!r)return null;let i=[],a=e!==void 0&&t!==void 0&&n!==void 0&&!!r.mapChunks,o=[];if(a){let i=Math.floor((e-n)/En),a=Math.floor((e+n)/En),s=Math.floor((t-n)/En),c=Math.floor((t+n)/En);for(let e=s;e<=c;e++)for(let t=i;t<=a;t++){let n=r.mapChunks[t+`,`+e];if(n)for(let e of n)o.push(e)}}else for(let e in r.map)o.push(e);let s=n===void 0?1/0:n*n,c=n!==void 0&&e!==void 0&&t!==void 0,l=new Map;for(let e of r.players)l.set(e.id,e);let u=r.players[0]?r.players[0].id:-1;for(let n of o){let a=r.map[n];if(a){if(c){let n=a.x-e,r=a.y-t;if(n*n+r*r>s)continue}if(a.t===`city`){let e=l.get(a.pid),t=e?e.race:`human`,r=e?Math.max(1,Math.min(5,Cn(e.b.hall))):1,o=!!e&&e.id===u,s=e?e.nick??`?`:`?`,c=e?`Ратуша `+e.b.hall:``;i.push({key:n,x:a.x+.5,y:a.y+.5,gx:a.x,gy:a.y,kind:0,model:`/models/castles/${t}-${r}.glb`,scale:10,own:o,nm:s,lv:c})}else if(a.t===`camp`||a.t===`fort`){let e=(a.t===`fort`?`Форт`:`Лагерь`)+` варваров`,t=`ур. `+(a.lv??`?`);i.push({key:n,x:a.x+.5,y:a.y+.5,gx:a.x,gy:a.y,kind:1,model:`/models/camps/barbarians.glb`,scale:a.t===`fort`?6.5:5,nm:e,lv:t})}else if(a.t===`node`){let e=xn[a.res]||`farm`,t=Sn[a.res]||`Точка`,r=`ур. `+(a.lv??`?`);i.push({key:n,x:a.x+.5,y:a.y+.5,gx:a.x,gy:a.y,kind:2,model:`/models/resources/${e}.glb`,scale:5,nm:t,lv:r})}}}return i}function On(e){let t=0;for(let n in e)for(let r in e[n])t+=e[n][+r]||0;return t}function kn(){try{let e=window.parent;if(e&&e!==window){let t=e.mpWorldSnapshot;if(typeof t==`function`){let e=t();if(e)return e}if(e.W)return e.W}}catch{}return null}function An(e,t){let n=e.path,r=e.pathCum;if(!n||n.length<2)return n&&n[0]||{x:e.tx,y:e.ty};let i=t*(e.pathLen??0);for(let e=1;e<r.length;e++)if(r[e]>=i){let t=r[e]-r[e-1],a=t>0?(i-r[e-1])/t:0,o=n[e-1],s=n[e];return{x:o.x+(s.x-o.x)*a,y:o.y+(s.y-o.y)*a}}return n[n.length-1]}function jn(){let e=kn();if(!e||!e.marches)return null;let t=e.players[0]?e.players[0].id:-1,n=new Map;for(let t of e.players)n.set(t.id,t);let r=[];for(let i of e.marches){let a=i.state===`gather`||i.state===`siege`||i.state===`hold`?{x:i.tx,y:i.ty}:An(i,Math.max(0,Math.min(1,(e.t-i.t0)/Math.max(1,i.t1-i.t0)))),o=n.get(i.pid),s=i.state===`siege`&&i.data&&i.data.battle?i.data.battle:null,c=s?{round:s.round??0,revealFromRound:s.revealFromRound??0,retreating:!!(s.retreatRequested||s.retreated),attHpLeft:s.attHpLeft??0,attStartHp:s.attStartHp??1,revealFromAttHp:s.revealFromAttHp??s.attHpLeft??0,defHpLeft:s.defHpLeft??0,defStartHp:s.defStartHp??1,revealFromDefHp:s.revealFromDefHp??s.defHpLeft??0,revealStart:s.revealStart??0,revealAt:s.revealAt??0}:null;r.push({x:a.x,y:a.y,own:i.pid===t,id:i.id,nick:o?.nick??o?.name??`?`,unitsTotal:On(i.units),state:i.state,tx:i.tx,ty:i.ty,t1:i.t1,battle:c})}return r}var Mn=document.getElementById(`status`),Nn=(()=>{try{if(/[?&]debug=1\b/.test(location.search))return!0;if(window.parent&&window.parent!==window)return/[?&]debug=1\b/.test(window.parent.location.search)}catch{}return!1})();Nn&&(Mn.style.display=`block`);function Pn(e){Nn&&(Mn.textContent=e.join(`
`))}function Fn(e){Mn.style.display=`block`,Mn.textContent=e.join(`
`)}async function In(){let e=[];function t(t){Fn([...e,t]);try{window.parent&&window.parent!==window&&typeof window.parent.forceCityView==`function`&&window.parent.forceCityView()}catch{}}if(!(`gpu`in navigator)){t(`WebGPU: navigator.gpu отсутствует.`);return}await Vt(),e.push(`рельеф: настоящие данные высот загружены`);let n=document.getElementById(`hmVersion`);n&&(n.textContent=`h6`);let r={x:42,y:22},i=[.6,.52,.4],a=35e-5,o=Tn(),s=o??r,c=Dn(s.x,s.y,192),l=c!==null;window.parent!==window&&!Nn&&(Mn.style.display=`none`);let d=c??[{key:`demo-0`,x:43,y:14,gx:43,gy:14,kind:0,model:`/models/castles/human-1.glb`,scale:10,nm:`Замок`,lv:`демо`},{key:`demo-1`,x:50,y:20,gx:50,gy:20,kind:1,model:`/models/camps/barbarians.glb`,scale:5,nm:`Лагерь`,lv:`демо`},{key:`demo-2`,x:55,y:12,gx:55,gy:12,kind:2,model:`/models/resources/farm.glb`,scale:5,nm:`Пашня`,lv:`демо`},{key:`demo-3`,x:30,y:30,gx:30,gy:30,kind:2,model:`/models/resources/quarry.glb`,scale:5,nm:`Каменоломня`,lv:`демо`}];e.push(l?`данные: настоящая партия, сущностей — ${d.length}`:`данные: демо (window.parent.W недоступен)`);let f=u(),p={x:[],y:[]},m={value:[]},h=new Map,g=new Map,_=new Map,v=new Map,y=new Map,b=new Map,x=new Map,S=new Map;function ee(e){let t=Fe(f);return Me(f,t,p),Me(f,t,m),p.x[t]=e.x,p.y[t]=e.y,m.value[t]=e.kind,h.set(t,e.model),g.set(t,e.scale),v.set(t,e.nm),y.set(t,e.lv),b.set(t,!!e.own),x.set(t,{x:e.gx,y:e.gy}),S.set(e.key,t),Jt(e.x,e.y,e.scale*1.4),t}for(let e of d)ee(e);let C=Array.from(Ee(f,[p,m]));e.push(`bitECS: сущностей — ${C.length}`);let w=await navigator.gpu.requestAdapter();if(!w){t(`WebGPU: адаптер не найден.`);return}let te=await w.requestDevice();function ne(e){let t=document.getElementById(`gpu-error-banner`);t||(t=document.createElement(`div`),t.id=`gpu-error-banner`,t.style.cssText=`position:fixed;left:0;right:0;bottom:0;z-index:99999;background:#4a0f0f;color:#fff;font:11px/1.4 monospace;padding:6px 8px;max-height:40vh;overflow:auto;white-space:pre-wrap;`,document.body.appendChild(t)),t.textContent+=(t.textContent?`
---
`:``)+e}te.addEventListener(`uncapturederror`,e=>{let t=e.error.message;console.error(`WebGPU error:`,t),ne(t)});let re=`fb-gpu-reload-at`,ie=Number(sessionStorage.getItem(re)||0),ae=ie&&Date.now()-ie<6e4;te.lost.then(e=>{if(console.error(`WebGPU device lost:`,e.reason,e.message),e.reason!==`destroyed`){if(ae){ne(`WebGPU-устройство теряется повторно (${e.reason}) — похоже, объёмная карта нестабильна на этом устройстве/браузере. Карта города ниже работает независимо от WebGPU.`);try{window.parent&&window.parent!==window&&typeof window.parent.forceCityView==`function`&&window.parent.forceCityView()}catch{}return}ne(`WebGPU-устройство потеряно (${e.reason}): ${e.message}\nПерезагрузка через 2с...`),sessionStorage.setItem(re,String(Date.now())),setTimeout(()=>location.reload(),2e3)}});let T=document.getElementById(`gpu`),oe=T.getContext(`webgpu`);if(!oe){t(`WebGPU: getContext('webgpu') вернул null.`);return}let se=navigator.gpu.getPreferredCanvasFormat();function ce(){let e=T.clientWidth,t=T.clientHeight;if(e<=0||t<=0)return;let n=Math.min(2,window.devicePixelRatio||1),r=Math.max(1,Math.floor(e*n)),i=Math.max(1,Math.floor(t*n));T.width!==r&&(T.width=r),T.height!==i&&(T.height=i)}let le=()=>T.offsetParent===null&&T.clientWidth===0;ce(),new ResizeObserver(ce).observe(T),oe.configure({device:te,format:se,alphaMode:`opaque`}),e.push(`WebGPU: устройство получено, формат — ${se}`);let E=await At(te,oe,se);function ue(e,t){return e+`,`+t}function de(e,t){try{let n=window.parent;n&&n!==window&&typeof n.ensureWorldChunk==`function`&&n.ensureWorldChunk(e,t)}catch{}}let fe=new Map;function pe(e,t){return[e[0]*t,e[1]*t,e[2]*t]}function me(e,t,n){if(Yt(e,t))return!0;for(let r=0;r<8;r++){let i=r/8*Math.PI*2;if(Yt(e+Math.cos(i)*n,t+Math.sin(i)*n))return!0}return!1}function D(e,t,n,r){for(let i of C){let a=p.x[i]-e,o=p.y[i]-t,s=(g.get(i)??5)*n+r;if(a*a+o*o<s*s)return!0}return!1}function he(e,t){return e>1.36?t<.62?`spruce`:t<.94?`pine`:`dead`:t<.58?`broadleaf`:t<.8?`birch`:t<.94?`spruce`:`dead`}function O(e,t){let n=[];for(let r=0;r<4;r++)for(let i=0;i<4;i++){let a=e*4+i,o=t*4+r;if(Z(a,o,13122)>=.65)continue;let s=.175+Z(a,o,X+778)*.65,c=.175+Z(a,o,X+779)*.65,l=e*16+i*4+s*4,u=t*16+r*4+c*4,d=l+(It(l/8.5,u/8.5,X+790)*2-1)*2,f=u+(It(l/8.5,u/8.5,X+791)*2-1)*2;if(me(d,f,1.5)||D(d,f,.54,.68))continue;let p=Z(a,o,X+781)*Math.PI*2,m=.85+Z(a,o,X+782)*.3,h=$(d,f),g=h*13,_=.0315+.5355*Zt(d,f),v=Z(a,o,X+780)<_,y=1+Z(a,o,X+785)*1.3,b=.8+Z(a,o,X+786)*.5;if(v){let e=he(h,Z(a,o,X+780));e===`broadleaf`&&Z(a,o,13132)<.35&&(e=`autumn`);let t=e===`spruce`||e===`pine`?Je:Ye,r=t[Math.floor(Z(a,o,X+784)*t.length)];n.push({x:d,y:g,z:f,scale:[b,y,b],yaw:p,color:pe(r,m),kind:e})}else{let e=.019+.056999999999999995*Math.min(1,h/1.6);if(Z(a,o,13140)>=e)continue;let t=Qe[Math.floor(Z(a,o,X+784)*Qe.length)],r=.6+Z(a,o,X+785)*.9,i=.6+Z(a,o,X+786)*.9;n.push({x:d,y:g,z:f,scale:[i,r,i],yaw:p,color:pe(t,m),kind:`rock`})}}for(let r=0;r<8;r++)for(let i=0;i<8;i++){let a=e*8+i,o=t*8+r;if(Z(a,o,13232)>=.14875)continue;let s=Z(a,o,X+888),c=Z(a,o,X+889),l=e*16+i*2+s*2,u=t*16+r*2+c*2;if(me(l,u,.4)||D(l,u,.36,.17))continue;let d=$(l,u);if(d>2)continue;let f=d*13,p=Z(a,o,X+890)*Math.PI*2,m=.8+Z(a,o,X+891)*.4,h=Xe[Math.floor(Z(a,o,X+892)*Xe.length)],g=.8+Z(a,o,X+893)*.6;n.push({x:l,y:f,z:u,scale:[g,g,g],yaw:p,color:pe(h,m),kind:`grass`})}let r=16/3;for(let i=0;i<r;i++)for(let a=0;a<r;a++){let o=e*r+a,s=t*r+i;if(Z(o,s,13342)>=.07875)continue;let c=Z(o,s,X+998),l=Z(o,s,X+999),u=e*16+a*3+c*3,d=t*16+i*3+l*3;if(me(u,d,.9)||D(u,d,.44,.34))continue;let f=$(u,d);if(f>2)continue;let p=f*13,m=Z(o,s,X+1e3)*Math.PI*2,h=.85+Z(o,s,X+1001)*.3,g=Ze[Math.floor(Z(o,s,X+1002)*Ze.length)],_=.9+Z(o,s,X+1003)*.7;n.push({x:u,y:p,z:d,scale:[_,_,_],yaw:m,color:pe(g,h),kind:`bush`})}return n}function ge(){let e=[];for(let t of fe.values())e.push(...t);E.setDecor(e),window.__decorCount=e.length,window.__decorList=e}let _e=.5,ve=1,ye=(e,t)=>e*.8+t*.2,k=new Set,be=new Set,A=[],xe=null,Se=null;function j(e,t,n=!1){let r=Math.floor(e/16),i=Math.floor(t/16);if(!n&&r===xe&&i===Se)return;xe=r,Se=i;let a=!1;for(let e=-3;e<=3;e++)for(let t=-3;t<=3;t++){let n=r+t,o=i+e,s=ue(n,o);k.has(s)||be.has(s)||(be.add(s),A.push({cx:n,cz:o,key:s}),a=!0)}let o=!1;for(let e of Array.from(k)){let[t,n]=e.split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>5&&(E.removeTerrainChunk(e),k.delete(e),fe.delete(e),o=!0)}for(let e of Array.from(be)){let[t,n]=e.split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>5&&(be.delete(e),a=!0)}a&&(A=A.filter(e=>be.has(e.key)),A.sort((e,t)=>(e.cx-r)**2+(e.cz-i)**2-((t.cx-r)**2+(t.cz-i)**2))),window.__terrainChunkCount=k.size,o&&ge()}function Ce(e){let t=!1,n=0;for(;A.length&&!(n>0&&performance.now()+_e>e);){let{cx:e,cz:r,key:i}=A.shift();if(!be.has(i))continue;be.delete(i);let a=performance.now(),o=e*16,s=r*16,c=cn(o,s,o+16,s+16,1);E.setTerrainChunk(i,c),k.add(i),de(e,r),fe.set(i,O(e,r)),t=!0,_e=ye(_e,performance.now()-a),n++}return t&&(window.__terrainChunkCount=k.size,ge()),n}function we(e,t){let n=ue(e,t);if(!k.has(n))return;let r=e*16,i=t*16;E.setTerrainChunk(n,cn(r,i,r+16,i+16,1))}function Te(e,t,n,r){let i=Math.floor(n/16),a=Math.floor(r/16),o=(i-3)*16,s=(i+3+1)*16,c=(a-3)*16,l=(a+3+1)*16,u=e*64,d=t*64;return u>=o&&u+64<=s&&d>=c&&d+64<=l}let M=new Set,N=new Set,P=[],De=null,Oe=null;function ke(e,t,n=!1){let r=Math.floor(e/64),i=Math.floor(t/64);if(!n&&r===De&&i===Oe)return;De=r,Oe=i;let a=!1;for(let n=-2;n<=2;n++)for(let o=-2;o<=2;o++){let s=r+o,c=i+n,l=`far:`+s+`,`+c;M.has(l)||N.has(l)||Te(s,c,e,t)||(N.add(l),P.push({cx:s,cz:c,rkey:l}),a=!0)}for(let n of Array.from(M)){let[a,o]=n.slice(4).split(`,`).map(Number),s=Math.max(Math.abs(a-r),Math.abs(o-i))>3,c=Te(a,o,e,t);(s||c)&&(E.removeTerrainChunk(n),M.delete(n))}for(let e of Array.from(N)){let[t,n]=e.slice(4).split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>3&&(N.delete(e),a=!0)}a&&(P=P.filter(e=>N.has(e.rkey)),P.sort((e,t)=>(e.cx-r)**2+(e.cz-i)**2-((t.cx-r)**2+(t.cz-i)**2))),window.__farChunkCount=M.size}function Ae(e,t){let n=0;for(;P.length&&!(!(n===0&&t)&&performance.now()+ve>e);){let{cx:e,cz:t,rkey:r}=P.shift();if(!N.has(r))continue;N.delete(r);let i=performance.now(),a=e*64,o=t*64,s=cn(a,o,a+64,o+64,4,.35);E.setTerrainChunk(r,s),M.add(r),ve=ye(ve,performance.now()-i),n++}window.__farChunkCount=M.size}let F=bn(te,se,E.getShadowResources()),I=new Map;function L(e){let t=I.get(e);return t||(t=_n(e).then(e=>yn(te,e)),I.set(e,t)),t}let je=new Set(Array.from(C,e=>h.get(e)));await Promise.allSettled(Array.from(je,e=>L(e)));let R=new Map,Ne=0,z=0;for(let t of C){let n=p.x[t],r=p.y[t],i=$(n,r)*13;_.set(t,i);let a=Ue(n,i,r,0,g.get(t)??5),o=h.get(t);try{let e=await L(o);R.set(t,F.createInstance(e,a)),Ne++}catch(t){z++,e.push(`модель: ошибка на ${o} — ${t instanceof Error?t.message:String(t)}`)}}e.push(`модели: загружено ${Ne}/${C.length}${z?`, ошибок: `+z:``}`),Pn(e),window.__ecsFound=C.length,window.__foundPositions=()=>C.map(e=>({x:p.x[e],z:p.y[e],scale:g.get(e)??5}));let Pe=o?o.x:r.x,Le=o?o.y:r.y,B={yaw:0,pitch:.55,dist:42,target:[Pe,$(Pe,Le)*13+2,Le]},V=mn(T,B);j(B.target[0],B.target[2],!0),ke(B.target[0],B.target[2],!0);let He=performance.now()+40;Ce(He),Ae(He,!0);let $e=cn(-Pt,-600,Pt,600,12,1.2);E.setTerrainChunk(`world-backdrop`,$e),e.push(`рельеф: чанков ${k.size} (16×16) + дальних ${M.size} (64×64, шаг 4) + задник (шаг 12, весь мир), в очереди ещё ${A.length+P.length}`),Pn(e),window.__coverageCheck=(e,t)=>{for(let n of k){let[r,i]=n.split(`,`).map(Number),a=r*16,o=i*16;if(e>=a&&e<a+16&&t>=o&&t<o+16)return`near`}for(let n of M){let[r,i]=n.slice(4).split(`,`).map(Number),a=r*64,o=i*64;if(e>=a&&e<a+64&&t>=o&&t<o+64)return`far`}return null},Object.defineProperty(window,"cam",{value:{get tx(){return B.target[0]},set tx(e){B.target[0]=e,V.stopAuto()},get ty(){return B.target[1]},set ty(e){B.target[1]=e,V.stopAuto()},get tz(){return B.target[2]},set tz(e){B.target[2]=e,V.stopAuto()},get dist(){return B.dist},set dist(e){B.dist=e,V.stopAuto()},get pitch(){return B.pitch},set pitch(e){B.pitch=e,V.stopAuto()}}}),window.H=(e,t)=>$(e,t)*13,window.__camState=()=>({yaw:B.yaw,pitch:B.pitch,dist:B.dist,target:[...B.target]}),window.__isAutoOrbiting=()=>V.isAutoOrbiting();let et=document.getElementById(`coordX`),U=document.getElementById(`coordY`),tt=document.getElementById(`coordGo`),W=!1;for(let e of[et,U])e.addEventListener(`input`,()=>{W=!0});function nt(){let e=parseFloat(et.value),t=parseFloat(U.value);!isFinite(e)||!isFinite(t)||(B.target[0]=Math.max(-Pt,Math.min(Pt,e)),B.target[2]=Math.max(-600,Math.min(600,t)),B.target[1]=$(B.target[0],B.target[2])*13+2,V.stopAuto(),W=!1)}tt.addEventListener(`click`,nt);for(let e of[et,U])e.addEventListener(`keydown`,t=>{t.key===`Enter`&&(t.preventDefault(),nt(),e.blur())});let rt=new Float32Array(16),G=[0,0,0],it=document.getElementById(`selected`),at=[.95,.78,.35],ot=[.42,.78,.46],st=[.82,.24,.26],K=null,ct=null,lt=null,ut=[.35,.85,.45],dt=null,ft=null,pt=null;window.startFollowMarch=e=>{V.stopAuto(),pt=e},V.onInteract(()=>{pt=null});function q(e){ft=null,dt=e;let t=(v.get(e)??`?`)+` · `+(y.get(e)??`?`),n=p.x[e],r=p.y[e];K={x:n,y:$(n,r)*13+(g.get(e)??5)*.9+2,z:r,color:at},window.__markerActive=!0,window.__selectedLabel=t,it.textContent=t,it.style.display=`block`}function mt(){dt=null,K=null,window.__markerActive=!1,window.__selectedLabel=null,it.style.display=`none`}function ht(e,t){let n=T.width/Math.max(1,T.height),r=Math.tan(J/2),i=e/T.width*2-1,a=1-t/T.height*2,o=H(Re(G,B.target)),s=H(ze([0,1,0],o)),c=ze(o,s),l=H([i*n*r*s[0]+a*r*c[0]-o[0],i*n*r*s[1]+a*r*c[1]-o[1],i*n*r*s[2]+a*r*c[2]-o[2]]);return{origin:G,dir:l}}let J=.72;function gt(e,t){let n=0;for(let r=2;r<=400;r+=2){let i=e[0]+t[0]*r;if(e[1]+t[1]*r-$(i,e[2]+t[2]*r)*13<=0){let i=n,a=r;for(let n=0;n<12;n++){let n=(i+a)/2,r=e[0]+t[0]*n,o=e[2]+t[2]*n;e[1]+t[1]*n-$(r,o)*13>0?i=n:a=n}return{t:a,x:e[0]+t[0]*a,z:e[2]+t[2]*a}}n=r}return null}function _t(e,t){try{let n=window.parent;n&&n!==window&&typeof n.renderCartoucheFor==`function`&&n.renderCartoucheFor(e,t)}catch{}}function vt(e){try{let t=window.parent;t&&t!==window&&typeof t.renderMarchCartoucheFor==`function`&&t.renderMarchCartoucheFor(e)}catch{}}function yt(e){let t=Ke(rt,e);return t.w<=.001?null:{sx:(t.x/t.w*.5+.5)*T.width,sy:(1-(t.y/t.w*.5+.5))*T.height,w:t.w}}function bt(e,t){let n=.5*T.height/Math.tan(J/2),r=null,i=1/0;for(let a of C){let o=p.x[a],s=p.y[a],c=g.get(a)??5,l=[o,(_.get(a)??$(o,s)*13)+c*.5,s],u=yt(l);if(!u)continue;let d=Math.max(26,n*c/u.w),f=e-u.sx,m=t-u.sy,h=f*f+m*m;h>d*d||h>=i||(i=h,r={kind:`entity`,eid:a,distToCam:Math.hypot(o-G[0],l[1]-G[1],s-G[2])})}for(let a of Y){let o=[a.x,$(a.x,a.y)*13+2.2,a.y],s=yt(o);if(!s)continue;let c=Math.max(26,n*3/s.w),l=e-s.sx,u=t-s.sy,d=l*l+u*u;d>c*c||d>=i||(i=d,r={kind:`march`,march:a,distToCam:Math.hypot(a.x-G[0],o[1]-G[1],a.y-G[2])})}let{origin:a,dir:o}=ht(e,t),s=gt(a,o);return r&&!(s!==null&&s.t+5<r.distToCam)?r.kind===`entity`?{kind:`entity`,eid:r.eid,t:r.distToCam}:{kind:`march`,march:r.march,t:r.distToCam}:s===null?null:{kind:`ground`,x:s.x,z:s.z,t:s.t}}V.onTap((e,t)=>{let n=T.getBoundingClientRect(),r=bt((e-n.left)*(T.width/n.width),(t-n.top)*(T.height/n.height));if(r?.kind===`entity`){q(r.eid);let e=x.get(r.eid);e&&_t(e.x,e.y);return}if(r?.kind===`march`){mt(),ft=r.march.id,window.__selectedMarchId=r.march.id,vt(r.march.id);return}mt(),ft=null,r?.kind===`ground`&&_t(Math.floor(r.x),Math.floor(r.z))});function xt(e,t){let n=T.getBoundingClientRect();return[(e-n.left)*(T.width/n.width),(t-n.top)*(T.height/n.height)]}function St(e,t){let[n,r]=xt(e,t),i=bt(n,r);if(!i)return null;if(i.kind===`ground`)return{x:i.x,z:i.z};if(i.kind===`entity`){let e=x.get(i.eid);if(e)return{x:e.x+.5,z:e.y+.5}}return i.kind===`march`?{x:i.march.x,z:i.march.y}:null}function Ct(e,t){let n=St(e,t);if(!n){lt=null;return}lt={x:n.x,y:$(n.x,n.z)*13+3,z:n.z,color:ut}}V.onGrab((e,t)=>{let[n,r]=xt(e,t),i=bt(n,r);return i?.kind!==`march`||!i.march.own?!1:(ct=i.march.id,Ct(e,t),!0)},(e,t)=>{ct!==null&&Ct(e,t)},(e,t)=>{let n=ct;if(ct=null,lt=null,n===null||!isFinite(e)||!isFinite(t))return;let r=St(e,t);if(r)try{let e=window.parent;e&&e!==window&&typeof e.redirectMarchTo==`function`&&e.redirectMarchTo(n,Math.floor(r.x),Math.floor(r.z))}catch{}});let wt=!1,Tt=0;async function Et(){let e=Dn(B.target[0],B.target[2],192);if(!e)return;let t=new Set,n=[],r=new Set;for(let i of e){t.add(i.key);let e=S.get(i.key);if(e!==void 0){if(v.set(e,i.nm),y.set(e,i.lv),b.set(e,!!i.own),dt===e&&q(e),h.get(e)!==i.model){h.set(e,i.model),g.set(e,i.scale);let t=p.x[e],r=p.y[e],a=$(t,r)*13;_.set(e,a);let o=Ue(t,a,r,0,i.scale);n.push(L(i.model).then(t=>{F.destroyInstance(R.get(e)),R.set(e,F.createInstance(t,o))}).catch(()=>{}))}continue}let a=ee(i),o=$(i.x,i.y)*13;_.set(a,o);let s=Ue(i.x,o,i.y,0,i.scale);n.push(L(i.model).then(e=>{F.destroyInstance(R.get(a)),R.set(a,F.createInstance(e,s))}).catch(()=>{})),r.add(ue(Math.floor(i.x/16),Math.floor(i.y/16))),we(Math.floor(i.x/16),Math.floor(i.y/16))}for(let[e,n]of Array.from(S))t.has(e)||(r.add(ue(Math.floor(p.x[n]/16),Math.floor(p.y[n]/16))),Ie(f,n),F.destroyInstance(R.get(n)),R.delete(n),h.delete(n),g.delete(n),_.delete(n),v.delete(n),y.delete(n),b.delete(n),x.delete(n),S.delete(e),dt===n&&mt());await Promise.allSettled(n),C=Array.from(Ee(f,[p,m]));let i=!1;for(let e of r){if(!k.has(e))continue;let[t,n]=e.split(`,`).map(Number);fe.set(e,O(t,n)),i=!0}i&&ge(),Tt++,window.__ecsFound=C.length,window.__syncCount=Tt}l&&setInterval(()=>{le()||wt||(wt=!0,Et().catch(e=>console.error(`live sync:`,e)).finally(()=>{wt=!1}))},3e3);let Y=[];function Dt(){if(!l)return Y=[],[];let e=jn();return e?(Y=e,window.__marchPositions=e,e.map(e=>({x:e.x,y:$(e.x,e.y)*13+2.2,z:e.y,color:e.own?ot:st}))):(Y=[],[])}let Ot=document.getElementById(`labels`),kt=new Map,jt=We(),Mt=1024;function Nt(){let e=new Set,t=T.clientWidth,n=T.clientHeight;for(let r of C){let i=p.x[r],a=p.y[r],o=i-B.target[0],s=a-B.target[2];if(o*o+s*s>Mt)continue;let c=(_.get(r)??$(i,a)*13)+(g.get(r)??5)*.6+1.1,l=Ge(rt,i,c,a,jt);if(l.w<=.001)continue;let u=(l.x/l.w*.5+.5)*t,d=(1-(l.y/l.w*.5+.5))*n;if(u<-40||u>t+40||d<-40||d>n+40)continue;e.add(r);let f=kt.get(r);if(!f){let e=document.createElement(`div`);e.className=`wlabel`;let t=document.createElement(`div`);t.className=`nm`;let n=document.createElement(`div`);n.className=`lv`,e.appendChild(t),e.appendChild(n),Ot.appendChild(e),f={root:e,nm:t,lv:n,lastNm:``,lastLv:``,lastMine:!1},kt.set(r,f)}let m=v.get(r)??`?`;f.lastNm!==m&&(f.nm.textContent=m,f.lastNm=m);let h=!!b.get(r);f.lastMine!==h&&(f.nm.classList.toggle(`mine`,h),f.lastMine=h);let x=y.get(r)??``;f.lastLv!==x&&(f.lv.textContent=x,f.lastLv=x),f.root.style.transform=`translate(${u.toFixed(1)}px,${d.toFixed(1)}px) translate(-50%,-100%)`}for(let[t,n]of kt)e.has(t)||(n.root.remove(),kt.delete(t))}let Ft=new Map;function Lt(e,t,n,r){if(!r||!n||r<=n)return t;let i=Math.max(0,Math.min(1,(Date.now()-n)/(r-n)));return e+(t-e)*i}function Rt(){let e=new Set,t=T.clientWidth,n=T.clientHeight;for(let r of Y){let i=r.battle;if(!i)continue;let a=r.x-B.target[0],o=r.y-B.target[2];if(a*a+o*o>Mt)continue;let s=$(r.x,r.y)*13+2.2+1.6,c=Ke(rt,[r.x,s,r.y]);if(c.w<=.001)continue;let l=(c.x/c.w*.5+.5)*t,u=(1-(c.y/c.w*.5+.5))*n;if(l<-60||l>t+60||u<-60||u>n+60)continue;e.add(r.id);let d=Ft.get(r.id);if(!d){let e=document.createElement(`div`);e.className=`blabel`;let t=document.createElement(`div`);t.className=`btitle`;let n=document.createElement(`div`);n.className=`bbar atk`;let i=document.createElement(`i`);n.appendChild(i);let a=document.createElement(`div`);a.className=`bbar def`;let o=document.createElement(`i`);a.appendChild(o),e.appendChild(t),e.appendChild(n),e.appendChild(a),Ot.appendChild(e),d={root:e,title:t,atkFill:i,defFill:o},Ft.set(r.id,d)}let f=i.retreating,p=!f&&i.revealFromRound===0;d.root.className=`blabel`+(f?` retreat`:p?` deploy`:``),d.title.textContent=f?`Отступление`:p?`Развёртывание`:`Бой — раунд `+i.round;let m=Math.max(0,Math.min(100,Lt(i.revealFromAttHp,i.attHpLeft,i.revealStart,i.revealAt)/Math.max(1,i.attStartHp)*100)),h=Math.max(0,Math.min(100,Lt(i.revealFromDefHp,i.defHpLeft,i.revealStart,i.revealAt)/Math.max(1,i.defStartHp)*100));d.atkFill.style.width=m.toFixed(1)+`%`,d.defFill.style.width=h.toFixed(1)+`%`,d.root.style.transform=`translate(${l.toFixed(1)}px,${u.toFixed(1)}px) translate(-50%,-100%)`}for(let[t,n]of Ft)e.has(t)||(n.root.remove(),Ft.delete(t))}let zt=We();function Bt(e,t,n,r,i){let a=p.x[e],o=p.y[e],s=g.get(e)??5,c=(_.get(e)??0)+s*.6,l=a-G[0],u=c-G[1],d=o-G[2],f=l*l+u*u+d*d;if(f<3600)return!0;if(f>16900)return!1;let m=Ge(t,a,c,o,zt);if(m.w<=.001)return!1;let h=(m.x/m.w*.5+.5)*n,v=(1-(m.y/m.w*.5+.5))*r,y=i*s/m.w+24;return h>-y&&h<n+y&&v>-y&&v<r+y}let Q={frame:0,chunks:0,render:0,labels:0,maxFrame:0,maxChunks:0,maxRender:0,maxLabels:0,n:0,worstFrame:0,worstChunks:0,worstRender:0,worstLabels:0};function Ht(){Q.maxFrame=Math.max(Q.maxFrame,Q.frame),Q.maxChunks=Math.max(Q.maxChunks,Q.chunks),Q.maxRender=Math.max(Q.maxRender,Q.render),Q.maxLabels=Math.max(Q.maxLabels,Q.labels),++Q.n>=60&&(Q.worstFrame=Q.maxFrame,Q.worstChunks=Q.maxChunks,Q.worstRender=Q.maxRender,Q.worstLabels=Q.maxLabels,Q.maxFrame=Q.maxChunks=Q.maxRender=Q.maxLabels=0,Q.n=0,Pn([`кадр (худший из 60): ${Q.worstFrame.toFixed(1)} мс`,`  стройка чанков: ${Q.worstChunks.toFixed(1)} мс`,`  отрисовка:      ${Q.worstRender.toFixed(1)} мс`,`  подписи:        ${Q.worstLabels.toFixed(1)} мс`,`чанков ${window.__terrainChunkCount??0} · моделей в кадре ${window.__modelDrawCount??0} · сущностей ${window.__ecsFound??C.length} · декора ${window.__decorCount??0}`,`в очереди на стройку: ${A.length} ближних`])),window.__perf=Q}let Ut=!1;function Wt(e){let t=Nn?performance.now():0;try{Gt(e)}catch(e){console.error(`draw:`,e),Ut||(Ut=!0,ne(`Сбой в кадре: ${e instanceof Error?e.message:String(e)}`))}Nn&&(Q.frame=performance.now()-t,Ht()),requestAnimationFrame(Wt)}function Gt(e){if(le())return;V.isAutoOrbiting()&&(B.yaw=e*15e-5),V.update(e);let t=Dt();if(pt!==null){let e=Y.find(e=>e.id===pt);e?(B.target[0]=e.x,B.target[2]=e.y,B.target[1]=$(e.x,e.y)*13+1):pt=null}W||(et.value=B.target[0].toFixed(1),U.value=B.target[2].toFixed(1)),j(B.target[0],B.target[2]),ke(B.target[0],B.target[2]);let n=performance.now(),r=n+3;Ae(r,Ce(r)===0),Nn&&(Q.chunks=performance.now()-n);let o=[B.target[0]+Math.sin(B.yaw)*Math.cos(B.pitch)*B.dist,B.target[1]+Math.sin(B.pitch)*B.dist,B.target[2]+Math.cos(B.yaw)*Math.cos(B.pitch)*B.dist],s=$(o[0],o[2])*13+2;o[1]<s&&(o[1]=s);let c=T.width/Math.max(1,T.height),l=Be(Ve(J,c,.5,392),qe(o,B.target,[0,1,0]));rt=l,G=o,E.setVP(l),E.setFog(o,i,a,e/1e3),E.setSunTarget(B.target[0],B.target[2]);{let t=H(Re(o,B.target)),n=H(ze([0,1,0],t)),r=ze(t,n);E.setSkyCamera(n,r,t,Math.tan(J/2),c,e/1e3)}if(F.setFog(o,i,a),F.setVP(l),ft!==null){let e=Y.find(e=>e.id===ft);e?K={x:e.x,y:$(e.x,e.y)*13+3.2,z:e.y,color:at}:(ft=null,K=null)}K&&t.push(K),lt&&t.push(lt),E.setMarkers(t),window.__marchCount=t.length-+!!K;let u=T.clientWidth,d=T.clientHeight,f=.5*d/Math.tan(J/2),p=0,m=Nn?performance.now():0;E.frame({r:i[0],g:i[1],b:i[2],a:1},e=>{F.beginModels(e);for(let t of C){if(!Bt(t,l,u,d,f))continue;let n=R.get(t);n&&(F.draw(e,n),p++)}}),window.__modelDrawCount=p,Nn&&(Q.render=performance.now()-m);let h=Nn?performance.now():0;Nt(),Rt(),Nn&&(Q.labels=performance.now()-h)}requestAnimationFrame(Wt),window.__engineReady=!0}In().catch(e=>{Fn([`Ошибка: ${e instanceof Error?e.message:String(e)}`]),console.error(e)});