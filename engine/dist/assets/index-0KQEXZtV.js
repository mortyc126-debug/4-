...
---
`:``)+e}te.addEventListener(`uncapturederror`,e=>{let t=e.error.message;console.error(`WebGPU error:`,t),ne(t)});let re=`fb-gpu-reload-at`,ie=Number(sessionStorage.getItem(re)||0),ae=ie&&Date.now()-ie<6e4;te.lost.then(e=>{if(console.error(`WebGPU device lost:`,e.reason,e.message),e.reason!==`destroyed`){if(ae){ne(`WebGPU-устройство теряется повторно (${e.reason}) — похоже, объёмная карта нестабильна на этом устройстве/браузере. Карта города ниже работает независимо от WebGPU.`);try{window.parent&&window.parent!==window&&typeof window.parent.forceCityView==`function`&&window.parent.forceCityView()}catch{}return}ne(`WebGPU-устройство потеряно (${e.reason}): ${e.message}\nПерезагрузка через 2с...`),sessionStorage.setItem(re,String(Date.now())),setTimeout(()=>location.reload(),2e3)}});let T=document.getElementById(`gpu`),oe=T.getContext(`webgpu`);if(!oe){t(`WebGPU: getContext('webgpu') вернул null.`);return}let se=navigator.gpu.getPreferredCanvasFormat();function ce(){let e=T.clientWidth,t=T.clientHeight;if(e<=0||t<=0)return;let n=Math.min(2,window.devicePixelRatio||1),r=Math.max(1,Math.floor(e*n)),i=Math.max(1,Math.floor(t*n));T.width!==r&&(T.width=r),T.height!==i&&(T.height=i)}let le=()=>T.offsetParent===null&&T.clientWidth===0;ce(),new ResizeObserver(ce).observe(T),oe.configure({device:te,format:se,alphaMode:`opaque`}),e.push(`WebGPU: устройство получено, формат — ${se}`);let E=await jt(te,oe,se);function ue(e,t){return e+`,`+t}function de(e,t){try{let n=window.parent;n&&n!==window&&typeof n.ensureWorldChunk==`function`&&n.ensureWorldChunk(e,t)}catch{}}let fe=new Map;function pe(e,t){return[e[0]*t,e[1]*t,e[2]*t]}function me(e,t,n){if(Xt(e,t))return!0;for(let r=0;r<8;r++){let i=r/8*Math.PI*2;if(Xt(e+Math.cos(i)*n,t+Math.sin(i)*n))return!0}return!1}function D(e,t,n,r){for(let i of C){let a=p.x[i]-e,o=p.y[i]-t,s=(g.get(i)??5)*n+r;if(a*a+o*o<s*s)return!0}return!1}function he(e,t){return e>1.36?t<.62?`spruce`:t<.94?`pine`:`dead`:t<.58?`broadleaf`:t<.8?`birch`:t<.94?`spruce`:`dead`}function O(e,t){let n=[];for(let r=0;r<4;r++)for(let i=0;i<4;i++){let a=e*4+i,o=t*4+r;if(Z(a,o,13122)>=.65)continue;let s=.175+Z(a,o,Y+778)*.65,c=.175+Z(a,o,Y+779)*.65,l=e*16+i*4+s*4,u=t*16+r*4+c*4,d=l+(It(l/8.5,u/8.5,Y+790)*2-1)*2,f=u+(It(l/8.5,u/8.5,Y+791)*2-1)*2;if(me(d,f,1.5)||D(d,f,.54,.68))continue;let p=Z(a,o,Y+781)*Math.PI*2,m=.85+Z(a,o,Y+782)*.3,h=Q(d,f),g=h*13,_=.0315+.5355*Qt(d,f),v=Z(a,o,Y+780)<_,y=1+Z(a,o,Y+785)*1.3,b=.8+Z(a,o,Y+786)*.5;if(v){let e=he(h,Z(a,o,Y+780));e===`broadleaf`&&Z(a,o,13132)<.35&&(e=`autumn`);let t=e===`spruce`||e===`pine`?Je:Ye,r=t[Math.floor(Z(a,o,Y+784)*t.length)];n.push({x:d,y:g,z:f,scale:[b,y,b],yaw:p,color:pe(r,m),kind:e})}else{let e=.019+.056999999999999995*Math.min(1,h/1.6);if(Z(a,o,13140)>=e)continue;let t=Qe[Math.floor(Z(a,o,Y+784)*Qe.length)],r=.6+Z(a,o,Y+785)*.9,i=.6+Z(a,o,Y+786)*.9;n.push({x:d,y:g,z:f,scale:[i,r,i],yaw:p,color:pe(t,m),kind:`rock`})}}for(let r=0;r<8;r++)for(let i=0;i<8;i++){let a=e*8+i,o=t*8+r;if(Z(a,o,13232)>=.14875)continue;let s=Z(a,o,Y+888),c=Z(a,o,Y+889),l=e*16+i*2+s*2,u=t*16+r*2+c*2;if(me(l,u,.4)||D(l,u,.36,.17))continue;let d=Q(l,u);if(d>2)continue;let f=d*13,p=Z(a,o,Y+890)*Math.PI*2,m=.8+Z(a,o,Y+891)*.4,h=Xe[Math.floor(Z(a,o,Y+892)*Xe.length)],g=.8+Z(a,o,Y+893)*.6;n.push({x:l,y:f,z:u,scale:[g,g,g],yaw:p,color:pe(h,m),kind:`grass`})}let r=16/3;for(let i=0;i<r;i++)for(let a=0;a<r;a++){let o=e*r+a,s=t*r+i;if(Z(o,s,13342)>=.07875)continue;let c=Z(o,s,Y+998),l=Z(o,s,Y+999),u=e*16+a*3+c*3,d=t*16+i*3+l*3;if(me(u,d,.9)||D(u,d,.44,.34))continue;let f=Q(u,d);if(f>2)continue;let p=f*13,m=Z(o,s,Y+1e3)*Math.PI*2,h=.85+Z(o,s,Y+1001)*.3,g=Ze[Math.floor(Z(o,s,Y+1002)*Ze.length)],_=.9+Z(o,s,Y+1003)*.7;n.push({x:u,y:p,z:d,scale:[_,_,_],yaw:m,color:pe(g,h),kind:`bush`})}return n}function ge(){let e=[];for(let t of fe.values())e.push(...t);E.setDecor(e),window.__decorCount=e.length,window.__decorList=e}let _e=.5,ve=1,ye=(e,t)=>e*.8+t*.2,k=new Set,be=new Set,A=[],xe=null,Se=null;function j(e,t,n=!1){let r=Math.floor(e/16),i=Math.floor(t/16);if(!n&&r===xe&&i===Se)return;xe=r,Se=i;let a=!1;for(let e=-3;e<=3;e++)for(let t=-3;t<=3;t++){let n=r+t,o=i+e,s=ue(n,o);k.has(s)||be.has(s)||(be.add(s),A.push({cx:n,cz:o,key:s}),a=!0)}let o=!1;for(let e of Array.from(k)){let[t,n]=e.split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>5&&(E.removeTerrainChunk(e),k.delete(e),fe.delete(e),o=!0)}for(let e of Array.from(be)){let[t,n]=e.split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>5&&(be.delete(e),a=!0)}a&&(A=A.filter(e=>be.has(e.key)),A.sort((e,t)=>(e.cx-r)**2+(e.cz-i)**2-((t.cx-r)**2+(t.cz-i)**2))),window.__terrainChunkCount=k.size,o&&ge()}function Ce(e){let t=!1,n=0;for(;A.length&&!(n>0&&performance.now()+_e>e);){let{cx:e,cz:r,key:i}=A.shift();if(!be.has(i))continue;be.delete(i);let a=performance.now(),o=e*16,s=r*16,c=ln(o,s,o+16,s+16,1);E.setTerrainChunk(i,c),k.add(i),de(e,r),fe.set(i,O(e,r)),t=!0,_e=ye(_e,performance.now()-a),n++}return t&&(window.__terrainChunkCount=k.size,ge()),n}function we(e,t){let n=ue(e,t);if(!k.has(n))return;let r=e*16,i=t*16;E.setTerrainChunk(n,ln(r,i,r+16,i+16,1))}function Te(e,t,n,r){let i=Math.floor(n/16),a=Math.floor(r/16),o=(i-3)*16,s=(i+3+1)*16,c=(a-3)*16,l=(a+3+1)*16,u=e*64,d=t*64;return u>=o&&u+64<=s&&d>=c&&d+64<=l}let M=new Set,N=new Set,P=[],De=null,Oe=null;function ke(e,t,n=!1){let r=Math.floor(e/64),i=Math.floor(t/64);if(!n&&r===De&&i===Oe)return;De=r,Oe=i;let a=!1;for(let n=-2;n<=2;n++)for(let o=-2;o<=2;o++){let s=r+o,c=i+n,l=`far:`+s+`,`+c;M.has(l)||N.has(l)||Te(s,c,e,t)||(N.add(l),P.push({cx:s,cz:c,rkey:l}),a=!0)}for(let n of Array.from(M)){let[a,o]=n.slice(4).split(`,`).map(Number),s=Math.max(Math.abs(a-r),Math.abs(o-i))>3,c=Te(a,o,e,t);(s||c)&&(E.removeTerrainChunk(n),M.delete(n))}for(let e of Array.from(N)){let[t,n]=e.slice(4).split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>3&&(N.delete(e),a=!0)}a&&(P=P.filter(e=>N.has(e.rkey)),P.sort((e,t)=>(e.cx-r)**2+(e.cz-i)**2-((t.cx-r)**2+(t.cz-i)**2))),window.__farChunkCount=M.size}function Ae(e,t){let n=0;for(;P.length&&!(!(n===0&&t)&&performance.now()+ve>e);){let{cx:e,cz:t,rkey:r}=P.shift();if(!N.has(r))continue;N.delete(r);let i=performance.now(),a=e*64,o=t*64,s=ln(a,o,a+64,o+64,4,.35);E.setTerrainChunk(r,s),M.add(r),ve=ye(ve,performance.now()-i),n++}window.__farChunkCount=M.size}let F=xn(te,se,E.getShadowResources()),I=new Map;function L(e){let t=I.get(e);return t||(t=vn(e).then(e=>bn(te,e)),I.set(e,t)),t}let je=new Set(Array.from(C,e=>h.get(e)));await Promise.allSettled(Array.from(je,e=>L(e)));let R=new Map,Ne=0,z=0;for(let t of C){let n=p.x[t],r=p.y[t],i=Q(n,r)*13;_.set(t,i);let a=Ue(n,i,r,0,g.get(t)??5),o=h.get(t);try{let e=await L(o);R.set(t,F.createInstance(e,a)),Ne++}catch(t){z++,e.push(`модель: ошибка на ${o} — ${t instanceof Error?t.message:String(t)}`)}}e.push(`модели: загружено ${Ne}/${C.length}${z?`, ошибок: `+z:``}`),Pn(e),window.__ecsFound=C.length,window.__foundPositions=()=>C.map(e=>({x:p.x[e],z:p.y[e],scale:g.get(e)??5}));let Pe=o?o.x:r.x,Le=o?o.y:r.y,B={yaw:0,pitch:.55,dist:42,target:[Pe,Q(Pe,Le)*13+2,Le]},V=hn(T,B);j(B.target[0],B.target[2],!0),ke(B.target[0],B.target[2],!0);let He=performance.now()+40;Ce(He),Ae(He,!0);let $e=ln(-Pt,-600,Pt,600,12,1.2);E.setTerrainChunk(`world-backdrop`,$e),e.push(`рельеф: чанков ${k.size} (16×16) + дальних ${M.size} (64×64, шаг 4) + задник (шаг 12, весь мир), в очереди ещё ${A.length+P.length}`),Pn(e),window.__coverageCheck=(e,t)=>{for(let n of k){let[r,i]=n.split(`,`).map(Number),a=r*16,o=i*16;if(e>=a&&e<a+16&&t>=o&&t<o+16)return`near`}for(let n of M){let[r,i]=n.slice(4).split(`,`).map(Number),a=r*64,o=i*64;if(e>=a&&e<a+64&&t>=o&&t<o+64)return`far`}return null},Object.defineProperty(window,"cam",{value:{get tx(){return B.target[0]},set tx(e){B.target[0]=e,V.stopAuto()},get ty(){return B.target[1]},set ty(e){B.target[1]=e,V.stopAuto()},get tz(){return B.target[2]},set tz(e){B.target[2]=e,V.stopAuto()},get dist(){return B.dist},set dist(e){B.dist=e,V.stopAuto()},get pitch(){return B.pitch},set pitch(e){B.pitch=e,V.stopAuto()}}}),window.H=(e,t)=>Q(e,t)*13,window.__camState=()=>({yaw:B.yaw,pitch:B.pitch,dist:B.dist,target:[...B.target]}),window.__isAutoOrbiting=()=>V.isAutoOrbiting();let U=document.getElementById(`coordX`),W=document.getElementById(`coordY`),et=document.getElementById(`coordGo`),G=!1;for(let e of[U,W])e.addEventListener(`input`,()=>{G=!0});function tt(){let e=parseFloat(U.value),t=parseFloat(W.value);!isFinite(e)||!isFinite(t)||(B.target[0]=Math.max(-Pt,Math.min(Pt,e)),B.target[2]=Math.max(-600,Math.min(600,t)),B.target[1]=Q(B.target[0],B.target[2])*13+2,V.stopAuto(),G=!1)}et.addEventListener(`click`,tt);for(let e of[U,W])e.addEventListener(`keydown`,t=>{t.key===`Enter`&&(t.preventDefault(),tt(),e.blur())});let nt=new Float32Array(16),K=[0,0,0],rt=document.getElementById(`selected`),it=[.95,.78,.35],at=[.42,.78,.46],ot=[.82,.24,.26],q=null,st=null,ct=null,lt=null;window.startFollowMarch=e=>{V.stopAuto(),lt=e},V.onInteract(()=>{lt=null});function ut(e){ct=null,st=e;let t=(v.get(e)??`?`)+` · `+(y.get(e)??`?`),n=p.x[e],r=p.y[e];q={x:n,y:Q(n,r)*13+(g.get(e)??5)*.9+2,z:r,color:it},window.__markerActive=!0,window.__selectedLabel=t,rt.textContent=t,rt.style.display=`block`}function dt(){st=null,q=null,window.__markerActive=!1,window.__selectedLabel=null,rt.style.display=`none`}function ft(e,t){let n=T.width/Math.max(1,T.height),r=Math.tan(J/2),i=e/T.width*2-1,a=1-t/T.height*2,o=H(Re(K,B.target)),s=H(ze([0,1,0],o)),c=ze(o,s),l=H([i*n*r*s[0]+a*r*c[0]-o[0],i*n*r*s[1]+a*r*c[1]-o[1],i*n*r*s[2]+a*r*c[2]-o[2]]);return{origin:K,dir:l}}let J=.72;function pt(e,t){let n=0;for(let r=2;r<=400;r+=2){let i=e[0]+t[0]*r;if(e[1]+t[1]*r-Q(i,e[2]+t[2]*r)*13<=0){let i=n,a=r;for(let n=0;n<12;n++){let n=(i+a)/2,r=e[0]+t[0]*n,o=e[2]+t[2]*n;e[1]+t[1]*n-Q(r,o)*13>0?i=n:a=n}return{t:a,x:e[0]+t[0]*a,z:e[2]+t[2]*a}}n=r}return null}function mt(e,t){try{let n=window.parent;n&&n!==window&&typeof n.renderCartoucheFor==`function`&&n.renderCartoucheFor(e,t)}catch{}}function ht(e){try{let t=window.parent;t&&t!==window&&typeof t.renderMarchCartoucheFor==`function`&&t.renderMarchCartoucheFor(e)}catch{}}function gt(e){let t=Ke(nt,e);return t.w<=.001?null:{sx:(t.x/t.w*.5+.5)*T.width,sy:(1-(t.y/t.w*.5+.5))*T.height,w:t.w}}function _t(e,t){let n=.5*T.height/Math.tan(J/2),r=null,i=1/0;for(let a of C){let o=p.x[a],s=p.y[a],c=g.get(a)??5,l=[o,(_.get(a)??Q(o,s)*13)+c*.5,s],u=gt(l);if(!u)continue;let d=Math.max(26,n*c/u.w),f=e-u.sx,m=t-u.sy,h=f*f+m*m;h>d*d||h>=i||(i=h,r={kind:`entity`,eid:a,distToCam:Math.hypot(o-K[0],l[1]-K[1],s-K[2])})}for(let a of xt){let o=[a.x,Q(a.x,a.y)*13+2.2,a.y],s=gt(o);if(!s)continue;let c=Math.max(26,n*3/s.w),l=e-s.sx,u=t-s.sy,d=l*l+u*u;d>c*c||d>=i||(i=d,r={kind:`march`,march:a,distToCam:Math.hypot(a.x-K[0],o[1]-K[1],a.y-K[2])})}let{origin:a,dir:o}=ft(e,t),s=pt(a,o);return r&&!(s!==null&&s.t+5<r.distToCam)?r.kind===`entity`?{kind:`entity`,eid:r.eid,t:r.distToCam}:{kind:`march`,march:r.march,t:r.distToCam}:s===null?null:{kind:`ground`,x:s.x,z:s.z,t:s.t}}V.onTap((e,t)=>{let n=T.getBoundingClientRect(),r=_t((e-n.left)*(T.width/n.width),(t-n.top)*(T.height/n.height));if(r?.kind===`entity`){ut(r.eid);let e=x.get(r.eid);e&&mt(e.x,e.y);return}if(r?.kind===`march`){dt(),ct=r.march.id,window.__selectedMarchId=r.march.id,ht(r.march.id);return}dt(),ct=null,r?.kind===`ground`&&mt(Math.floor(r.x),Math.floor(r.z))});let vt=!1,yt=0;async function bt(){let e=On(B.target[0],B.target[2],192);if(!e)return;let t=new Set,n=[],r=new Set;for(let i of e){t.add(i.key);let e=S.get(i.key);if(e!==void 0){if(v.set(e,i.nm),y.set(e,i.lv),b.set(e,!!i.own),st===e&&ut(e),h.get(e)!==i.model){h.set(e,i.model),g.set(e,i.scale);let t=p.x[e],r=p.y[e],a=Q(t,r)*13;_.set(e,a);let o=Ue(t,a,r,0,i.scale);n.push(L(i.model).then(t=>{F.destroyInstance(R.get(e)),R.set(e,F.createInstance(t,o))}).catch(()=>{}))}continue}let a=ee(i),o=Q(i.x,i.y)*13;_.set(a,o);let s=Ue(i.x,o,i.y,0,i.scale);n.push(L(i.model).then(e=>{F.destroyInstance(R.get(a)),R.set(a,F.createInstance(e,s))}).catch(()=>{})),r.add(ue(Math.floor(i.x/16),Math.floor(i.y/16))),we(Math.floor(i.x/16),Math.floor(i.y/16))}for(let[e,n]of Array.from(S))t.has(e)||(r.add(ue(Math.floor(p.x[n]/16),Math.floor(p.y[n]/16))),Ie(f,n),F.destroyInstance(R.get(n)),R.delete(n),h.delete(n),g.delete(n),_.delete(n),v.delete(n),y.delete(n),b.delete(n),x.delete(n),S.delete(e),st===n&&dt());await Promise.allSettled(n),C=Array.from(Ee(f,[p,m]));let i=!1;for(let e of r){if(!k.has(e))continue;let[t,n]=e.split(`,`).map(Number);fe.set(e,O(t,n)),i=!0}i&&ge(),yt++,window.__ecsFound=C.length,window.__syncCount=yt}l&&setInterval(()=>{le()||vt||(vt=!0,bt().catch(e=>console.error(`live sync:`,e)).finally(()=>{vt=!1}))},3e3);let xt=[];function St(){if(!l)return xt=[],[];let e=Mn();return e?(xt=e,window.__marchPositions=e,e.map(e=>({x:e.x,y:Q(e.x,e.y)*13+2.2,z:e.y,color:e.own?at:ot}))):(xt=[],[])}let Ct=document.getElementById(`labels`),wt=new Map,Tt=We(),Et=1024;function Dt(){let e=new Set,t=T.clientWidth,n=T.clientHeight;for(let r of C){let i=p.x[r],a=p.y[r],o=i-B.target[0],s=a-B.target[2];if(o*o+s*s>Et)continue;let c=(_.get(r)??Q(i,a)*13)+(g.get(r)??5)*.6+1.1,l=Ge(nt,i,c,a,Tt);if(l.w<=.001)continue;let u=(l.x/l.w*.5+.5)*t,d=(1-(l.y/l.w*.5+.5))*n;if(u<-40||u>t+40||d<-40||d>n+40)continue;e.add(r);let f=wt.get(r);if(!f){let e=document.createElement(`div`);e.className=`wlabel`;let t=document.createElement(`div`);t.className=`nm`;let n=document.createElement(`div`);n.className=`lv`,e.appendChild(t),e.appendChild(n),Ct.appendChild(e),f={root:e,nm:t,lv:n,lastNm:``,lastLv:``,lastMine:!1},wt.set(r,f)}let m=v.get(r)??`?`;f.lastNm!==m&&(f.nm.textContent=m,f.lastNm=m);let h=!!b.get(r);f.lastMine!==h&&(f.nm.classList.toggle(`mine`,h),f.lastMine=h);let x=y.get(r)??``;f.lastLv!==x&&(f.lv.textContent=x,f.lastLv=x),f.root.style.transform=`translate(${u.toFixed(1)}px,${d.toFixed(1)}px) translate(-50%,-100%)`}for(let[t,n]of wt)e.has(t)||(n.root.remove(),wt.delete(t))}let Ot=new Map;function kt(e,t,n,r){if(!r||!n||r<=n)return t;let i=Math.max(0,Math.min(1,(Date.now()-n)/(r-n)));return e+(t-e)*i}function At(){let e=new Set,t=T.clientWidth,n=T.clientHeight;for(let r of xt){let i=r.battle;if(!i)continue;let a=r.x-B.target[0],o=r.y-B.target[2];if(a*a+o*o>Et)continue;let s=Q(r.x,r.y)*13+2.2+1.6,c=Ke(nt,[r.x,s,r.y]);if(c.w<=.001)continue;let l=(c.x/c.w*.5+.5)*t,u=(1-(c.y/c.w*.5+.5))*n;if(l<-60||l>t+60||u<-60||u>n+60)continue;e.add(r.id);let d=Ot.get(r.id);if(!d){let e=document.createElement(`div`);e.className=`blabel`;let t=document.createElement(`div`);t.className=`btitle`;let n=document.createElement(`div`);n.className=`bbar atk`;let i=document.createElement(`i`);n.appendChild(i);let a=document.createElement(`div`);a.className=`bbar def`;let o=document.createElement(`i`);a.appendChild(o),e.appendChild(t),e.appendChild(n),e.appendChild(a),Ct.appendChild(e),d={root:e,title:t,atkFill:i,defFill:o},Ot.set(r.id,d)}let f=i.retreating,p=!f&&i.revealFromRound===0;d.root.className=`blabel`+(f?` retreat`:p?` deploy`:``),d.title.textContent=f?`Отступление`:p?`Развёртывание`:`Бой — раунд `+i.round;let m=Math.max(0,Math.min(100,kt(i.revealFromAttHp,i.attHpLeft,i.revealStart,i.revealAt)/Math.max(1,i.attStartHp)*100)),h=Math.max(0,Math.min(100,kt(i.revealFromDefHp,i.defHpLeft,i.revealStart,i.revealAt)/Math.max(1,i.defStartHp)*100));d.atkFill.style.width=m.toFixed(1)+`%`,d.defFill.style.width=h.toFixed(1)+`%`,d.root.style.transform=`translate(${l.toFixed(1)}px,${u.toFixed(1)}px) translate(-50%,-100%)`}for(let[t,n]of Ot)e.has(t)||(n.root.remove(),Ot.delete(t))}let Mt=We();function Nt(e,t,n,r,i){let a=p.x[e],o=p.y[e],s=g.get(e)??5,c=(_.get(e)??0)+s*.6,l=a-K[0],u=c-K[1],d=o-K[2],f=l*l+u*u+d*d;if(f<3600)return!0;if(f>16900)return!1;let m=Ge(t,a,c,o,Mt);if(m.w<=.001)return!1;let h=(m.x/m.w*.5+.5)*n,v=(1-(m.y/m.w*.5+.5))*r,y=i*s/m.w+24;return h>-y&&h<n+y&&v>-y&&v<r+y}let X={frame:0,chunks:0,render:0,labels:0,maxFrame:0,maxChunks:0,maxRender:0,maxLabels:0,n:0,worstFrame:0,worstChunks:0,worstRender:0,worstLabels:0};function Ft(){X.maxFrame=Math.max(X.maxFrame,X.frame),X.maxChunks=Math.max(X.maxChunks,X.chunks),X.maxRender=Math.max(X.maxRender,X.render),X.maxLabels=Math.max(X.maxLabels,X.labels),++X.n>=60&&(X.worstFrame=X.maxFrame,X.worstChunks=X.maxChunks,X.worstRender=X.maxRender,X.worstLabels=X.maxLabels,X.maxFrame=X.maxChunks=X.maxRender=X.maxLabels=0,X.n=0,Pn([`кадр (худший из 60): ${X.worstFrame.toFixed(1)} мс`,`  стройка чанков: ${X.worstChunks.toFixed(1)} мс`,`  отрисовка:      ${X.worstRender.toFixed(1)} мс`,`  подписи:        ${X.worstLabels.toFixed(1)} мс`,`чанков ${window.__terrainChunkCount??0} · моделей в кадре ${window.__modelDrawCount??0} · сущностей ${window.__ecsFound??C.length} · декора ${window.__decorCount??0}`,`в очереди на стройку: ${A.length} ближних`])),window.__perf=X}let Lt=!1;function Rt(e){let t=$?performance.now():0;try{zt(e)}catch(e){console.error(`draw:`,e),Lt||(Lt=!0,ne(`Сбой в кадре: ${e instanceof Error?e.message:String(e)}`))}$&&(X.frame=performance.now()-t,Ft()),requestAnimationFrame(Rt)}function zt(e){if(le())return;V.isAutoOrbiting()&&(B.yaw=e*15e-5),V.update(e);let t=St();if(lt!==null){let e=xt.find(e=>e.id===lt);e?(B.target[0]=e.x,B.target[2]=e.y,B.target[1]=Q(e.x,e.y)*13+1):lt=null}G||(U.value=B.target[0].toFixed(1),W.value=B.target[2].toFixed(1)),j(B.target[0],B.target[2]),ke(B.target[0],B.target[2]);let n=performance.now(),r=n+3;Ae(r,Ce(r)===0),$&&(X.chunks=performance.now()-n);let o=[B.target[0]+Math.sin(B.yaw)*Math.cos(B.pitch)*B.dist,B.target[1]+Math.sin(B.pitch)*B.dist,B.target[2]+Math.cos(B.yaw)*Math.cos(B.pitch)*B.dist],s=Q(o[0],o[2])*13+2;o[1]<s&&(o[1]=s);let c=T.width/Math.max(1,T.height),l=Be(Ve(J,c,.5,392),qe(o,B.target,[0,1,0]));nt=l,K=o,E.setVP(l),E.setFog(o,i,a,e/1e3),E.setSunTarget(B.target[0],B.target[2]);{let t=H(Re(o,B.target)),n=H(ze([0,1,0],t)),r=ze(t,n);E.setSkyCamera(n,r,t,Math.tan(J/2),c,e/1e3)}if(F.setFog(o,i,a),F.setVP(l),ct!==null){let e=xt.find(e=>e.id===ct);e?q={x:e.x,y:Q(e.x,e.y)*13+3.2,z:e.y,color:it}:(ct=null,q=null)}q&&t.push(q),E.setMarkers(t),window.__marchCount=t.length-+!!q;let u=T.clientWidth,d=T.clientHeight,f=.5*d/Math.tan(J/2),p=0,m=$?performance.now():0;E.frame({r:i[0],g:i[1],b:i[2],a:1},e=>{F.beginModels(e);for(let t of C){if(!Nt(t,l,u,d,f))continue;let n=R.get(t);n&&(F.draw(e,n),p++)}}),window.__modelDrawCount=p,$&&(X.render=performance.now()-m);let h=$?performance.now():0;Dt(),At(),$&&(X.labels=performance.now()-h)}requestAnimationFrame(Rt),window.__engineReady=!0}In().catch(e=>{Fn([`Ошибка: ${e instanceof Error?e.message:String(e)}`]),console.error(e)});