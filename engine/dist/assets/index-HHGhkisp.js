...
`,Ct=.5,wt=1.4,Tt=new Float32Array([0,wt,0,Ct,0,0,0,0,Ct,0,wt,0,0,0,Ct,-.5,0,0,0,wt,0,-.5,0,0,0,0,-.5,0,wt,0,0,0,-.5,Ct,0,0]),Et=Tt.length/3,Dt=7;async function Ot(e,t,n){let r=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),i=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),a=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),o=e.createTexture({size:[J,J],format:`depth32float`,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}).createView(),s=e.createSampler({compare:`less`,magFilter:`linear`,minFilter:`linear`}),c=He(-1,1,-1,1,.1,1),l=0,u=0;function d(t,n){l=t,u=n;let r=Ge([t+ft[0]*mt,ft[1]*mt,n+ft[2]*mt],[t,0,n],[0,1,0]);c=Be(He(-60,pt,-60,pt,ht,gt),r),e.queue.writeBuffer(a,0,c)}let[f,p,m,h,g,_,v,y,b,x,S]=await Promise.all([q(e,`/textures/ground/sand.png`),q(e,`/textures/ground/grass.png`),q(e,`/textures/ground/dry_meadow.png`),q(e,`/textures/ground/scree.png`),q(e,`/textures/ground/rock.png`),q(e,`/textures/ground/snow.png`),q(e,`/textures/ground/forest_floor.png`),q(e,`/textures/ground/desert.png`),q(e,`/textures/ground/marsh.png`),q(e,`/textures/ground/tundra_moss.png`),q(e,`/textures/water/detail.png`)]),ee=e.createSampler({addressModeU:`repeat`,addressModeV:`repeat`,magFilter:`linear`,minFilter:`linear`}),te=e.createShaderModule({code:_t}),C=e.createRenderPipeline({layout:`auto`,vertex:{module:te,entryPoint:`vs`,buffers:[{arrayStride:52,attributes:[{shaderLocation:0,offset:0,format:`float32x3`},{shaderLocation:1,offset:12,format:`float32x3`},{shaderLocation:2,offset:24,format:`float32x3`},{shaderLocation:3,offset:36,format:`float32x2`},{shaderLocation:4,offset:44,format:`float32`},{shaderLocation:5,offset:48,format:`float32`}]}]},fragment:{module:te,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`,cullMode:`back`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),ne=e.createBindGroup({layout:C.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}},{binding:2,resource:ee},{binding:3,resource:f.createView()},{binding:4,resource:p.createView()},{binding:5,resource:m.createView()},{binding:6,resource:h.createView()},{binding:7,resource:g.createView()},{binding:8,resource:{buffer:a}},{binding:9,resource:s},{binding:10,resource:o},{binding:11,resource:_.createView()},{binding:12,resource:v.createView()},{binding:13,resource:y.createView()},{binding:14,resource:b.createView()},{binding:15,resource:x.createView()},{binding:16,resource:S.createView()}]}),[re,ie]=await Promise.all([q(e,`/textures/sky/sky.png`),q(e,`/textures/sky/clouds.png`)]),w=e.createSampler({addressModeU:`repeat`,addressModeV:`clamp-to-edge`,magFilter:`linear`,minFilter:`linear`}),ae=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),T=e.createShaderModule({code:St}),oe=e.createRenderPipeline({layout:`auto`,vertex:{module:T,entryPoint:`vs`},fragment:{module:T,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`,cullMode:`none`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!1,depthCompare:`always`}}),se=e.createBindGroup({layout:oe.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:ae}},{binding:1,resource:w},{binding:2,resource:re.createView()},{binding:3,resource:ie.createView()}]});function E(t,n,r,i,a,o){let s=new Float32Array([t[0],t[1],t[2],0,n[0],n[1],n[2],0,r[0],r[1],r[2],0,i,a,o,0]);e.queue.writeBuffer(ae,0,s)}let ce=e.createShaderModule({code:bt}),le=e.createRenderPipeline({layout:`auto`,vertex:{module:ce,entryPoint:`vs`,buffers:[{arrayStride:52,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]}]},primitive:{topology:`triangle-list`,cullMode:`back`},depthStencil:{format:`depth32float`,depthWriteEnabled:!0,depthCompare:`less`}}),ue=e.createBindGroup({layout:le.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:a}}]}),D=new Map,de=e.createShaderModule({code:vt}),fe=e.createBuffer({size:Tt.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(fe,0,Tt);let pe=e.createRenderPipeline({layout:`auto`,vertex:{module:de,entryPoint:`vs`,buffers:[{arrayStride:12,stepMode:`vertex`,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]},{arrayStride:28,stepMode:`instance`,attributes:[{shaderLocation:1,offset:0,format:`float32x3`},{shaderLocation:2,offset:12,format:`float32`},{shaderLocation:3,offset:16,format:`float32x3`}]}]},fragment:{module:de,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),me=e.createBindGroup({layout:pe.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}}]}),O=null,k=0,A=0,j=e.createShaderModule({code:yt});function he(t){let n=e.createBuffer({size:Math.max(t.vertexCount*10*4,4),usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),r=new Float32Array(t.vertexCount*10);for(let e=0;e<t.vertexCount;e++)r.set(t.positions.subarray(e*3,e*3+3),e*10),r.set(t.normals.subarray(e*3,e*3+3),e*10+3),r[e*10+6]=t.materialIds[e],r[e*10+7]=t.shades[e],r.set(t.uvs.subarray(e*2,e*2+2),e*10+8);return e.queue.writeBuffer(n,0,r),n}let ge=await Promise.all(Object.entries({bark:`/textures/decor/bark.png`,birchBark:`/textures/decor/birch_bark.png`,conifer:`/textures/decor/conifer_a.png`,conifer2:`/textures/decor/conifer_b.png`,broadleaf:`/textures/decor/broadleaf.png`,autumn:`/textures/decor/autumn.png`,birchLeaf:`/textures/decor/birch_leaf.png`,bush:`/textures/decor/bush.png`,grassTuft:`/textures/decor/grass_tuft.png`}).map(async([t,n])=>[t,await q(e,n)])),_e={...Object.fromEntries(ge),rock:g},ve=e.createSampler({magFilter:`linear`,minFilter:`linear`}),ye={spruce:{trunk:`bark`,canopy:`conifer`},pine:{trunk:`bark`,canopy:`conifer2`},broadleaf:{trunk:`bark`,canopy:`broadleaf`},autumn:{trunk:`bark`,canopy:`autumn`},birch:{trunk:`birchBark`,canopy:`birchLeaf`},dead:{trunk:`bark`,canopy:`bark`},bush:{trunk:`bark`,canopy:`bush`},grass:{trunk:`bark`,canopy:`grassTuft`},rock:{trunk:`bark`,canopy:`rock`}},be={spruce:Qe,pine:$e,broadleaf:et,autumn:et,birch:tt,dead:nt,bush:rt,grass:it,rock:dt},M=[{arrayStride:40,stepMode:`vertex`,attributes:[{shaderLocation:0,offset:0,format:`float32x3`},{shaderLocation:1,offset:12,format:`float32x3`},{shaderLocation:2,offset:24,format:`float32`},{shaderLocation:3,offset:28,format:`float32`},{shaderLocation:4,offset:32,format:`float32x2`}]},{arrayStride:40,stepMode:`instance`,attributes:[{shaderLocation:5,offset:0,format:`float32x3`},{shaderLocation:6,offset:12,format:`float32x3`},{shaderLocation:7,offset:24,format:`float32`},{shaderLocation:8,offset:28,format:`float32x3`}]}],N=e.createRenderPipeline({layout:`auto`,vertex:{module:j,entryPoint:`vs`,buffers:M},fragment:{module:j,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),P=e.createShaderModule({code:xt}),F=e.createRenderPipeline({layout:`auto`,vertex:{module:P,entryPoint:`vs`,buffers:M},fragment:{module:P,entryPoint:`fs`,targets:[]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth32float`,depthWriteEnabled:!0,depthCompare:`less`}}),I=new Map;for(let t of Object.keys(ye)){let n=be[t](),c=ye[t],l=e.createBindGroup({layout:N.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}},{binding:2,resource:ve},{binding:3,resource:_e[c.trunk].createView()},{binding:4,resource:_e[c.canopy].createView()},{binding:5,resource:{buffer:a}},{binding:6,resource:s},{binding:7,resource:o}]}),u=e.createBindGroup({layout:F.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:a}},{binding:1,resource:ve},{binding:2,resource:_e[c.canopy].createView()}]});I.set(t,{mesh:n,localBuf:he(n),instBuf:null,instCapacity:0,instanceCount:0,bindGroup:l,shadowBindGroup:u})}let L=null,xe=null;function Se(){let n=t.canvas.width,r=t.canvas.height;L&&L.width===n&&L.height===r||(L?.destroy(),L=e.createTexture({size:[n,r],format:`depth24plus`,usage:GPUTextureUsage.RENDER_ATTACHMENT}),xe=L.createView())}function Ce(t,n){D.get(t)?.buf.destroy();let r=e.createBuffer({size:Math.max(n.vertexCount*13*4,4),usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),i=new Float32Array(n.vertexCount*13),a=1/0,o=-1/0,s=1/0,c=-1/0;for(let e=0;e<n.vertexCount;e++){let t=n.positions[e*3],r=n.positions[e*3+2];t<a&&(a=t),t>o&&(o=t),r<s&&(s=r),r>c&&(c=r),i.set(n.positions.subarray(e*3,e*3+3),e*13),i.set(n.colors.subarray(e*3,e*3+3),e*13+3),i.set(n.normals.subarray(e*3,e*3+3),e*13+6),i.set(n.uvs.subarray(e*2,e*2+2),e*13+9),i[e*13+11]=n.elevations[e],i[e*13+12]=n.waterFlags[e]}e.queue.writeBuffer(r,0,i),D.set(t,{buf:r,vertexCount:n.vertexCount,minX:a,maxX:o,minZ:s,maxZ:c})}function we(e){let t=D.get(e);t&&(t.buf.destroy(),D.delete(e))}function Te(t){A=t.length;let n=new Float32Array(A*Dt);t.forEach((e,t)=>{let r=t*Dt;n[r]=e.x,n[r+1]=e.y,n[r+2]=e.z,n[r+3]=1,n[r+4]=e.color[0],n[r+5]=e.color[1],n[r+6]=e.color[2]}),A>k&&(O?.destroy(),k=Math.max(A,8),O=e.createBuffer({size:k*Dt*4,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST})),O&&n.byteLength>0&&e.queue.writeBuffer(O,0,n)}function Ee(t,n){let r=t.length,i=new Float32Array(r*10);t.forEach((e,t)=>{let n=t*10;i[n]=e.x,i[n+1]=e.y,i[n+2]=e.z,i[n+3]=e.scale[0],i[n+4]=e.scale[1],i[n+5]=e.scale[2],i[n+6]=e.yaw,i[n+7]=e.color[0],i[n+8]=e.color[1],i[n+9]=e.color[2]}),n.instanceCount=r,r>n.instCapacity&&(n.instBuf?.destroy(),n.instCapacity=Math.max(r,8),n.instBuf=e.createBuffer({size:n.instCapacity*10*4,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST})),n.instBuf&&i.byteLength>0&&e.queue.writeBuffer(n.instBuf,0,i)}function De(e){for(let[t,n]of I)Ee(e.filter(e=>e.kind===t),n)}function Oe(t){e.queue.writeBuffer(r,0,t)}function ke(t,n,r,a){let o=new Float32Array([t[0],t[1],t[2],a,n[0],n[1],n[2],r]);e.queue.writeBuffer(i,0,o)}function R(n,r){Se();let i=e.createCommandEncoder();{let e=i.beginRenderPass({colorAttachments:[],depthStencilAttachment:{view:o,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}}),t=l-pt,n=l+pt,r=u-pt,a=u+pt;if(D.size>0){e.setPipeline(le),e.setBindGroup(0,ue);for(let i of D.values())i.vertexCount!==0&&(i.maxX<t||i.minX>n||i.maxZ<r||i.minZ>a||(e.setVertexBuffer(0,i.buf),e.draw(i.vertexCount)))}let s=!1;for(let e of I.values())if(e.instanceCount>0){s=!0;break}if(s){e.setPipeline(F);for(let t of I.values())t.instanceCount===0||!t.instBuf||(e.setBindGroup(0,t.shadowBindGroup),e.setVertexBuffer(0,t.localBuf),e.setVertexBuffer(1,t.instBuf),e.draw(t.mesh.vertexCount,t.instanceCount))}e.end()}let a=t.getCurrentTexture().createView(),s=i.beginRenderPass({colorAttachments:[{view:a,clearValue:n,loadOp:`clear`,storeOp:`store`}],depthStencilAttachment:{view:xe,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}});if(s.setPipeline(oe),s.setBindGroup(0,se),s.draw(3),D.size>0){s.setPipeline(C),s.setBindGroup(0,ne);for(let e of D.values())e.vertexCount!==0&&(s.setVertexBuffer(0,e.buf),s.draw(e.vertexCount))}A>0&&O&&(s.setPipeline(pe),s.setBindGroup(0,me),s.setVertexBuffer(0,fe),s.setVertexBuffer(1,O),s.draw(Et,A));let c=!1;for(let e of I.values())if(e.instanceCount>0){c=!0;break}if(c){s.setPipeline(N);for(let e of I.values())e.instanceCount===0||!e.instBuf||(s.setBindGroup(0,e.bindGroup),s.setVertexBuffer(0,e.localBuf),s.setVertexBuffer(1,e.instBuf),s.draw(e.mesh.vertexCount,e.instanceCount))}r?.(s),s.end(),e.queue.submit([i.finish()])}function Ae(){return{lightBuf:a,shadowView:o,shadowSampler:s}}return{setTerrainChunk:Ce,removeTerrainChunk:we,setMarkers:Te,setDecor:De,setVP:Oe,setFog:ke,setSunTarget:d,setSkyCamera:E,getShadowResources:Ae,frame:R}}var Y=12345,kt=.235;function X(e,t,n){let r=e*374761393+t*668265263+n*1274126177;return r=Math.imul(r^r>>>13,1274126177),((r^r>>>16)>>>0)/4294967296}function Z(e,t,n){let r=Math.floor(e),i=Math.floor(t),a=e-r,o=t-i,s=a*a*(3-2*a),c=o*o*(3-2*o),l=X(r,i,n),u=X(r+1,i,n),d=X(r,i+1,n),f=X(r+1,i+1,n);return(l*(1-s)+u*s)*(1-c)+(d*(1-s)+f*s)*c}var At=(e,t,n)=>1-Math.abs(2*Z(e,t,n)-1),Q=(e,t,n)=>{let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)};function jt(e,t){return{mount:Q(.4,.72,Z(e/40,t/40,12400)),plat:Q(.7,.9,Z(e/34,t/34,12433)),rough:Z(e/26,t/26,12468)}}var Mt=.85,Nt=1.55,Pt=6;function Ft(e){if(e<=Mt)return e;let t=e-Mt;return Mt+Nt*(1-Math.exp(-t/Nt))}var It=3.5,Lt=.06;function Rt(e,t){return It*(.85+.3*At(e/20,t/20,13122))}function zt(e,t){return Q(.6,.72,Z(e/240,t/240,13285))}function Bt(e,t){return Q(.93,.985,At(e/42,t/42,13295))}function Vt(e,t,n){let r=1-Q(.38,.58,n);return r<=0?0:zt(e,t)*Bt(e,t)*r*.17}function Ht(e,t){let n=Math.max(Math.abs(e),Math.abs(t));if(n>=524){if(n<550)return Math.max(.02,Rt(e,t));if(n<574){let r=Q(550,574,n);return Math.max(.02,Rt(e,t)*(1-r)+Lt*r)}return Lt}let r=(Z(e/34,t/34,12446)*2-1)*13,i=(Z(e/34,t/34,12447)*2-1)*13,a=e+r,o=t+i,s=jt(e,t),c=.65+.7*Z(a/190,o/190,13275),l=.16+Z(a/62,o/62,12546)*.5,u=.2+.84*s.mount*c*Pt+.35*s.rough;if(l+=(Z(a/27,o/27,Y)*.2+Z(a/13,o/13,12354)*.1+Z(a/6,o/6,12366)*.045)*u,l+=At(a/17,o/17,12382)*.33*s.mount*c*Pt,l+=s.mount*c*Pt*.1-(1-s.mount)*.05,s.plat>.02){let e=Math.round(l*6)/6;l=l*(1-s.plat*.6)+e*(s.plat*.6)}if(l>=.42){let n=Q(.42,.68,l);l+=(Z(e/2.4,t/2.4,12525)-.5)*.075*n+(Z(e/5.5,t/5.5,12526)-.5)*.055*n}if(l-=Vt(e,t,l),n<500)return Math.max(.02,Ft(l));let d=Q(500,524,n);return Math.max(.02,Ft(l)*(1-d)+Rt(e,t)*d)}function Ut(e,t){let n=Ht(e,t),r=(Ht(e+.7,t)+Ht(e-.7,t)+Ht(e,t+.7)+Ht(e,t-.7))*.25;return n*.55+r*.45}var Wt=32,Gt=new Map;function Kt(e,t){return Math.floor(e/Wt)+`,`+Math.floor(t/Wt)}function qt(e,t,n){let r={x:e,z:t,targetH:Ut(e,t),radius:n},i=Kt(e,t),a=Gt.get(i);a?a.push(r):Gt.set(i,[r])}function $(e,t){let n=Ut(e,t);if(Gt.size===0)return n;let r=Math.floor(e/Wt),i=Math.floor(t/Wt),a=null,o=0;for(let n=-1;n<=1;n++)for(let s=-1;s<=1;s++){let c=Gt.get(r+s+`,`+(i+n));if(c)for(let n of c){let r=Math.hypot(e-n.x,t-n.z);if(r>=n.radius)continue;let i=n.radius*.55,s=r<=i?1:1-((r-i)/(n.radius-i))**2*(3-2*((r-i)/(n.radius-i)));s>o&&(o=s,a=n)}}return a?n*(1-o)+a.targetH*o:n}function Jt(e,t){return $(e,t)<kt}function Yt(e,t){return Q(.4,.62,Z(e/150,t/150,13256)*.65+Z(e/60,t/60,13257)*.35)*(1-Q(.55,.82,$(e,t)))}var Xt=(e,t,n)=>[e[0]+(t[0]-e[0])*n,e[1]+(t[1]-e[1])*n,e[2]+(t[2]-e[2])*n],Zt=[.14,.24,.28],Qt=[.05,.11,.19];function $t(e){return Xt(Zt,Qt,Math.min(1,e))}var en=[0,1,0],tn=6;function nn(e,t){let n=.5,r=$(e-n,t)*13,i=$(e+n,t)*13,a=$(e,t-n)*13,o=$(e,t+n)*13;return H([-(i-r)/(2*n),1,-(o-a)/(2*n)])}function rn(e,t,n,r,i=1,a=0){let o=Math.round((n-e)/i),s=Math.round((r-t)/i),c=i===1,l=[],u=[],d=[],f=[],p=[],m=[];function h(e,t){let n=$(e,t),r=n<kt;return{p:r?[e,kt*13-a,t]:[e,n*13-a,t],c:r?$t((kt-n)*3):[0,0,0],n:r?en:c?nn(e,t):en,uv:[e/tn,t/tn],e:n,water:+!!r}}let g=[];for(let n=0;n<=s;n++){let r=[];for(let a=0;a<=o;a++)r.push(h(e+a*i,t+n*i));g.push(r)}function _(e,t,n){let r=c?null:H(ze(Le(t.p,e.p),Le(n.p,e.p)));for(let i of[e,t,n]){l.push(i.p[0],i.p[1],i.p[2]),u.push(i.c[0],i.c[1],i.c[2]);let e=r??i.n;d.push(e[0],e[1],e[2]),f.push(i.uv[0],i.uv[1]),p.push(i.e),m.push(i.water)}}for(let e=0;e<s;e++)for(let t=0;t<o;t++){let n=g[e][t],r=g[e][t+1],i=g[e+1][t],a=g[e+1][t+1];_(n,a,r),_(n,i,a)}return{positions:new Float32Array(l),colors:new Float32Array(u),normals:new Float32Array(d),uvs:new Float32Array(f),elevations:new Float32Array(p),waterFlags:new Float32Array(m),vertexCount:l.length/3}}var an=9,on=100,sn=10,cn=380,ln={d:[1,0],arrowright:[1,0],a:[-1,0],arrowleft:[-1,0],w:[0,1],arrowup:[0,1],s:[0,-1],arrowdown:[0,-1]},un=700;function dn(e,t){let n=!0,r=new Map,i=null,a=null,o=null,s=null,c=null;function l(){n=!1,c?.()}function u(){let e=[...r.values()];return{x:(e[0].x+e[1].x)/2,y:(e[0].y+e[1].y)/2,d:Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y)}}function d(){let e=[...r.values()];return Math.atan2(e[1].y-e[0].y,e[1].x-e[0].x)}function f(e,n){let r=t.dist*.0022,i=e*r,a=n*r,o=Math.cos(t.yaw),s=Math.sin(t.yaw);t.target[0]=Math.max(-500,Math.min(500,t.target[0]-(i*o-a*s))),t.target[2]=Math.max(-500,Math.min(500,t.target[2]+(i*s+a*o))),t.target[1]=$(t.target[0],t.target[2])*13+1}e.addEventListener(`pointerdown`,n=>{n.preventDefault(),l(),r.set(n.pointerId,{x:n.clientX,y:n.clientY});try{e.setPointerCapture(n.pointerId)}catch{}if(r.size===1)i={x:n.clientX,y:n.clientY,tx:t.target[0],tz:t.target[2]},o={x:n.clientX,y:n.clientY,t:performance.now()};else if(r.size===2){i=null,o=null;let e=u();a={d:e.d,y:e.y,dist:t.dist,yaw:t.yaw,pitch:t.pitch,angle:d()}}}),e.addEventListener(`pointermove`,e=>{if(r.has(e.pointerId)){if(e.preventDefault(),r.set(e.pointerId,{x:e.clientX,y:e.clientY}),o&&Math.hypot(e.clientX-o.x,e.clientY-o.y)>sn&&(o=null),r.size>=2&&a){let e=u();t.dist=Math.max(an,Math.min(on,a.dist*(a.d/Math.max(12,e.d)))),t.yaw=a.yaw+(d()-a.angle),t.pitch=Math.max(.08,Math.min(1.42,a.pitch+(e.y-a.y)*.005));return}i&&(t.target[0]=i.tx,t.target[2]=i.tz,f(e.clientX-i.x,i.y-e.clientY))}});function p(e){if(o&&r.size===1&&performance.now()-o.t<cn&&s?.(o.x,o.y),o=null,r.delete(e.pointerId),r.size<2&&(a=null),r.size===0)i=null;else if(r.size===1){let e=[...r.values()][0];i={x:e.x,y:e.y,tx:t.target[0],tz:t.target[2]}}}e.addEventListener(`pointerup`,p),e.addEventListener(`pointercancel`,p),e.addEventListener(`wheel`,e=>{e.preventDefault(),l(),t.dist=Math.max(an,Math.min(on,t.dist*(e.deltaY<0?.9:1.11)))},{passive:!1});let m=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();t in ln&&(m.add(t),l())}),window.addEventListener(`keyup`,e=>{m.delete(e.key.toLowerCase())});let h=null;function g(e){if(h===null){h=e;return}let t=Math.min(.1,(e-h)/1e3);if(h=e,m.size===0||i)return;let n=0,r=0;for(let e of m){let[t,i]=ln[e];n+=t,r+=i}(n!==0||r!==0)&&f(n*un*t,r*un*t)}return{isAutoOrbiting:()=>n,stopAuto:l,update:g,onTap(e){s=e},onInteract(e){c=e}}}var fn={5121:Uint8Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},pn={SCALAR:1,VEC2:2,VEC3:3,VEC4:4};async function mn(e){let t=await(await fetch(e)).arrayBuffer(),n=new DataView(t);if(n.getUint32(0,!0)!==1179937895)throw Error(`не glTF-контейнер: `+e);let r=n.getUint32(8,!0),i=12,a=null,o=null;for(;i<r;){let e=n.getUint32(i,!0),r=n.getUint32(i+4,!0),s=t.slice(i+8,i+8+e);r===1313821514?a=JSON.parse(new TextDecoder().decode(s)):r===5130562&&(o=s),i+=8+e}if(!a||!o)throw Error(`GLB без JSON/BIN чанка: `+e);let s=e=>a.accessors[e],c=e=>a.bufferViews[e];function l(e){let t=s(e),n=c(t.bufferView),r=fn[t.componentType],i=(n.byteOffset||0)+(t.byteOffset||0);return new r(o,i,t.count*pn[t.type])}let u=a.meshes[0].primitives[0],d=l(u.attributes.POSITION),f=l(u.attributes.NORMAL),p=l(u.attributes.TEXCOORD_0),m=l(u.indices),h=a.materials[u.material].pbrMetallicRoughness.baseColorTexture.index,g=a.images[a.textures[h].source],_=c(g.bufferView);return{positions:d,normals:f,uvs:p,indices:m,imageBytes:o.slice(_.byteOffset||0,(_.byteOffset||0)+_.byteLength),imageMimeType:g.mimeType}}var hn=`
...
`)}async function Nn(){let e=[],t={x:42,y:22},n=[.6,.52,.4],r=.0042,i=Sn(),a=i??t,o=wn(a.x,a.y,384),s=o!==null;window.parent!==window&&(kn.style.display=`none`);let c=o??[{key:`demo-0`,x:43,y:14,gx:43,gy:14,kind:0,model:`/models/castles/human-1.glb`,scale:10,nm:`Замок`,lv:`демо`},{key:`demo-1`,x:50,y:20,gx:50,gy:20,kind:1,model:`/models/camps/barbarians.glb`,scale:5,nm:`Лагерь`,lv:`демо`},{key:`demo-2`,x:55,y:12,gx:55,gy:12,kind:2,model:`/models/resources/farm.glb`,scale:5,nm:`Пашня`,lv:`демо`},{key:`demo-3`,x:30,y:30,gx:30,gy:30,kind:2,model:`/models/resources/quarry.glb`,scale:5,nm:`Каменоломня`,lv:`демо`}];e.push(s?`данные: настоящая партия, сущностей — ${c.length}`:`данные: демо (window.parent.W недоступен)`);let l=u(),d={x:[],y:[]},f={value:[]},p=new Map,m=new Map,h=new Map,g=new Map,_=new Map,v=new Map,y=new Map;function b(e){let t=Ne(l);return je(l,t,d),je(l,t,f),d.x[t]=e.x,d.y[t]=e.y,f.value[t]=e.kind,p.set(t,e.model),m.set(t,e.scale),h.set(t,e.nm),g.set(t,e.lv),_.set(t,!!e.own),v.set(t,{x:e.gx,y:e.gy}),y.set(e.key,t),qt(e.x,e.y,e.scale*1.4),t}for(let e of c)b(e);let x=Array.from(Ce(l,[d,f]));e.push(`bitECS: сущностей — ${x.length}`);function S(t){Mn([...e,t]);try{window.parent&&window.parent!==window&&typeof window.parent.forceCityView==`function`&&window.parent.forceCityView()}catch{}}if(!(`gpu`in navigator)){S(`WebGPU: navigator.gpu отсутствует.`);return}let ee=await navigator.gpu.requestAdapter();if(!ee){S(`WebGPU: адаптер не найден.`);return}let te=await ee.requestDevice();function C(e){let t=document.getElementById(`gpu-error-banner`);t||(t=document.createElement(`div`),t.id=`gpu-error-banner`,t.style.cssText=`position:fixed;left:0;right:0;bottom:0;z-index:99999;background:#4a0f0f;color:#fff;font:11px/1.4 monospace;padding:6px 8px;max-height:40vh;overflow:auto;white-space:pre-wrap;`,document.body.appendChild(t)),t.textContent+=(t.textContent?`
---
`:``)+e}te.addEventListener(`uncapturederror`,e=>{let t=e.error.message;console.error(`WebGPU error:`,t),C(t)});let ne=`fb-gpu-reload-at`,re=Number(sessionStorage.getItem(ne)||0),ie=re&&Date.now()-re<6e4;te.lost.then(e=>{if(console.error(`WebGPU device lost:`,e.reason,e.message),e.reason!==`destroyed`){if(ie){C(`WebGPU-устройство теряется повторно (${e.reason}) — похоже, объёмная карта нестабильна на этом устройстве/браузере. Карта города ниже работает независимо от WebGPU.`);try{window.parent&&window.parent!==window&&typeof window.parent.forceCityView==`function`&&window.parent.forceCityView()}catch{}return}C(`WebGPU-устройство потеряно (${e.reason}): ${e.message}\nПерезагрузка через 2с...`),sessionStorage.setItem(ne,String(Date.now())),setTimeout(()=>location.reload(),2e3)}});let w=document.getElementById(`gpu`),ae=w.getContext(`webgpu`);if(!ae){S(`WebGPU: getContext('webgpu') вернул null.`);return}let T=navigator.gpu.getPreferredCanvasFormat();function oe(){let e=w.clientWidth,t=w.clientHeight;if(e<=0||t<=0)return;let n=Math.min(2,window.devicePixelRatio||1),r=Math.max(1,Math.floor(e*n)),i=Math.max(1,Math.floor(t*n));w.width!==r&&(w.width=r),w.height!==i&&(w.height=i)}let se=()=>w.offsetParent===null&&w.clientWidth===0;oe(),new ResizeObserver(oe).observe(w),ae.configure({device:te,format:T,alphaMode:`opaque`}),e.push(`WebGPU: устройство получено, формат — ${T}`);let E=await Ot(te,ae,T);function ce(e,t){return e+`,`+t}function le(e,t){try{let n=window.parent;n&&n!==window&&typeof n.ensureWorldChunk==`function`&&n.ensureWorldChunk(e,t)}catch{}}let ue=new Map;function D(e,t){return[e[0]*t,e[1]*t,e[2]*t]}function de(e,t,n){if(Jt(e,t))return!0;for(let r=0;r<8;r++){let i=r/8*Math.PI*2;if(Jt(e+Math.cos(i)*n,t+Math.sin(i)*n))return!0}return!1}function fe(e,t,n,r){for(let i of x){let a=d.x[i]-e,o=d.y[i]-t,s=(m.get(i)??5)*n+r;if(a*a+o*o<s*s)return!0}return!1}function pe(e,t){return e>.5?t<.62?`spruce`:t<.94?`pine`:`dead`:t<.58?`broadleaf`:t<.8?`birch`:t<.94?`spruce`:`dead`}function me(e,t){let n=[];for(let r=0;r<4;r++)for(let i=0;i<4;i++){let a=e*4+i,o=t*4+r;if(X(a,o,13122)>=.65)continue;let s=.175+X(a,o,Y+778)*.65,c=.175+X(a,o,Y+779)*.65,l=e*16+i*4+s*4,u=t*16+r*4+c*4,d=l+(Z(l/8.5,u/8.5,Y+790)*2-1)*2,f=u+(Z(l/8.5,u/8.5,Y+791)*2-1)*2;if(de(d,f,1.5)||fe(d,f,.54,.68))continue;let p=X(a,o,Y+781)*Math.PI*2,m=.85+X(a,o,Y+782)*.3,h=$(d,f);if(h>2.35)continue;let g=h*13,_=.05+.85*Yt(d,f),v=X(a,o,Y+780)<_,y=1+X(a,o,Y+785)*1.3,b=.8+X(a,o,Y+786)*.5;if(v){let e=pe(h,X(a,o,Y+780));e===`broadleaf`&&X(a,o,13132)<.35&&(e=`autumn`);let t=e===`spruce`||e===`pine`?Ke:qe,r=t[Math.floor(X(a,o,Y+784)*t.length)];n.push({x:d,y:g,z:f,scale:[b,y,b],yaw:p,color:D(r,m),kind:e})}else{let e=.1+.30000000000000004*Math.min(1,h/.65);if(X(a,o,13140)>=e)continue;let t=Xe[Math.floor(X(a,o,Y+784)*Xe.length)],r=.6+X(a,o,Y+785)*.9,i=.6+X(a,o,Y+786)*.9;n.push({x:d,y:g,z:f,scale:[i,r,i],yaw:p,color:D(t,m),kind:`rock`})}}for(let r=0;r<8;r++)for(let i=0;i<8;i++){let a=e*8+i,o=t*8+r;if(X(a,o,13232)>=.7)continue;let s=X(a,o,Y+888),c=X(a,o,Y+889),l=e*16+i*2+s*2,u=t*16+r*2+c*2;if(de(l,u,.4)||fe(l,u,.36,.17))continue;let d=$(l,u);if(d>.75)continue;let f=d*13,p=X(a,o,Y+890)*Math.PI*2,m=.8+X(a,o,Y+891)*.4,h=Je[Math.floor(X(a,o,Y+892)*Je.length)],g=.8+X(a,o,Y+893)*.6;n.push({x:l,y:f,z:u,scale:[g,g,g],yaw:p,color:D(h,m),kind:`grass`})}let r=16/3;for(let i=0;i<r;i++)for(let a=0;a<r;a++){let o=e*r+a,s=t*r+i;if(X(o,s,13342)>=.35)continue;let c=X(o,s,Y+998),l=X(o,s,Y+999),u=e*16+a*3+c*3,d=t*16+i*3+l*3;if(de(u,d,.9)||fe(u,d,.44,.34))continue;let f=$(u,d);if(f>.75)continue;let p=f*13,m=X(o,s,Y+1e3)*Math.PI*2,h=.85+X(o,s,Y+1001)*.3,g=Ye[Math.floor(X(o,s,Y+1002)*Ye.length)],_=.9+X(o,s,Y+1003)*.7;n.push({x:u,y:p,z:d,scale:[_,_,_],yaw:m,color:D(g,h),kind:`bush`})}return n}function O(){let e=[];for(let t of ue.values())e.push(...t);E.setDecor(e),window.__decorCount=e.length,window.__decorList=e}let k=new Set,A=new Set,j=[],he=null,ge=null;function _e(e,t,n=!1){let r=Math.floor(e/16),i=Math.floor(t/16);if(!n&&r===he&&i===ge)return;he=r,ge=i;let a=!1;for(let e=-3;e<=3;e++)for(let t=-3;t<=3;t++){let n=r+t,o=i+e,s=ce(n,o);k.has(s)||A.has(s)||(A.add(s),j.push({cx:n,cz:o,key:s}),a=!0)}let o=!1;for(let e of Array.from(k)){let[t,n]=e.split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>5&&(E.removeTerrainChunk(e),k.delete(e),ue.delete(e),o=!0)}for(let e of Array.from(A)){let[t,n]=e.split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>5&&(A.delete(e),a=!0)}a&&(j=j.filter(e=>A.has(e.key)),j.sort((e,t)=>(e.cx-r)**2+(e.cz-i)**2-((t.cx-r)**2+(t.cz-i)**2))),window.__terrainChunkCount=k.size,o&&O()}function ve(e){let t=!1;for(;j.length&&performance.now()<e;){let{cx:e,cz:n,key:r}=j.shift();if(!A.has(r))continue;A.delete(r);let i=e*16,a=n*16,o=rn(i,a,i+16,a+16,1);E.setTerrainChunk(r,o),k.add(r),le(e,n),ue.set(r,me(e,n)),t=!0}t&&(window.__terrainChunkCount=k.size,O())}function ye(e,t){let n=ce(e,t);if(!k.has(n))return;let r=e*16,i=t*16;E.setTerrainChunk(n,rn(r,i,r+16,i+16,1))}function be(e,t,n,r){let i=Math.floor(n/16),a=Math.floor(r/16),o=(i-3)*16,s=(i+3+1)*16,c=(a-3)*16,l=(a+3+1)*16,u=e*64,d=t*64;return u>=o&&u+64<=s&&d>=c&&d+64<=l}let M=new Set,N=new Set,P=[],F=null,I=null;function L(e,t,n=!1){let r=Math.floor(e/64),i=Math.floor(t/64);if(!n&&r===F&&i===I)return;F=r,I=i;let a=!1;for(let n=-4;n<=4;n++)for(let o=-4;o<=4;o++){let s=r+o,c=i+n,l=`far:`+s+`,`+c;M.has(l)||N.has(l)||be(s,c,e,t)||(N.add(l),P.push({cx:s,cz:c,rkey:l}),a=!0)}for(let n of Array.from(M)){let[a,o]=n.slice(4).split(`,`).map(Number),s=Math.max(Math.abs(a-r),Math.abs(o-i))>6,c=be(a,o,e,t);(s||c)&&(E.removeTerrainChunk(n),M.delete(n))}for(let e of Array.from(N)){let[t,n]=e.slice(4).split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>6&&(N.delete(e),a=!0)}a&&(P=P.filter(e=>N.has(e.rkey)),P.sort((e,t)=>(e.cx-r)**2+(e.cz-i)**2-((t.cx-r)**2+(t.cz-i)**2))),window.__farChunkCount=M.size}function xe(e){for(;P.length&&performance.now()<e;){let{cx:e,cz:t,rkey:n}=P.shift();if(!N.has(n))continue;N.delete(n);let r=e*64,i=t*64,a=rn(r,i,r+64,i+64,4,.35);E.setTerrainChunk(n,a),M.add(n)}window.__farChunkCount=M.size}let Se=_n(te,T,E.getShadowResources()),we=new Map;function Te(e){let t=we.get(e);return t||(t=mn(e).then(e=>gn(te,e)),we.set(e,t)),t}let Ee=new Set(Array.from(x,e=>p.get(e)));await Promise.allSettled(Array.from(Ee,e=>Te(e)));let De=new Map,Oe=0,ke=0;for(let t of x){let n=d.x[t],r=d.y[t],i=Ue(n,$(n,r)*13,r,0,m.get(t)??5),a=p.get(t);try{let e=await Te(a);De.set(t,Se.createInstance(e,i)),Oe++}catch(t){ke++,e.push(`модель: ошибка на ${a} — ${t instanceof Error?t.message:String(t)}`)}}e.push(`модели: загружено ${Oe}/${x.length}${ke?`, ошибок: `+ke:``}`),jn(e),window.__ecsFound=x.length,window.__foundPositions=()=>x.map(e=>({x:d.x[e],z:d.y[e],scale:m.get(e)??5}));let R=i?i.x:t.x,Ae=i?i.y:t.y,z={yaw:0,pitch:.55,dist:42,target:[R,$(R,Ae)*13+2,Ae]},B=dn(w,z);_e(z.target[0],z.target[2],!0),L(z.target[0],z.target[2],!0);let V=performance.now()+40;ve(V),xe(V),e.push(`рельеф: чанков ${k.size} (16×16) + дальних ${M.size} (64×64, шаг 4), в очереди ещё ${j.length+P.length}`),jn(e),window.__coverageCheck=(e,t)=>{for(let n of k){let[r,i]=n.split(`,`).map(Number),a=r*16,o=i*16;if(e>=a&&e<a+16&&t>=o&&t<o+16)return`near`}for(let n of M){let[r,i]=n.slice(4).split(`,`).map(Number),a=r*64,o=i*64;if(e>=a&&e<a+64&&t>=o&&t<o+64)return`far`}return null},Object.defineProperty(window,"cam",{value:{get tx(){return z.target[0]},set tx(e){z.target[0]=e,B.stopAuto()},get ty(){return z.target[1]},set ty(e){z.target[1]=e,B.stopAuto()},get tz(){return z.target[2]},set tz(e){z.target[2]=e,B.stopAuto()},get dist(){return z.dist},set dist(e){z.dist=e,B.stopAuto()},get pitch(){return z.pitch},set pitch(e){z.pitch=e,B.stopAuto()}}}),window.H=(e,t)=>$(e,t)*13,window.__camState=()=>({yaw:z.yaw,pitch:z.pitch,dist:z.dist,target:[...z.target]}),window.__isAutoOrbiting=()=>B.isAutoOrbiting();let Me=document.getElementById(`coordX`),Fe=document.getElementById(`coordY`),Ie=document.getElementById(`coordGo`),Re=!1;for(let e of[Me,Fe])e.addEventListener(`input`,()=>{Re=!0});function He(){let e=parseFloat(Me.value),t=parseFloat(Fe.value);!isFinite(e)||!isFinite(t)||(z.target[0]=Math.max(-500,Math.min(500,e)),z.target[2]=Math.max(-500,Math.min(500,t)),z.target[1]=$(z.target[0],z.target[2])*13+2,B.stopAuto(),Re=!1)}Ie.addEventListener(`click`,He);for(let e of[Me,Fe])e.addEventListener(`keydown`,t=>{t.key===`Enter`&&(t.preventDefault(),He(),e.blur())});let U=new Float32Array(16),Ze=[0,0,0],W=document.getElementById(`selected`),G=[.95,.78,.35],K=[.42,.78,.46],Qe=[.82,.24,.26],$e=null,et=null,tt=null,nt=null;window.startFollowMarch=e=>{B.stopAuto(),nt=e},B.onInteract(()=>{nt=null});function rt(e){tt=null,et=e;let t=(h.get(e)??`?`)+` · `+(g.get(e)??`?`),n=d.x[e],r=d.y[e];$e={x:n,y:$(n,r)*13+(m.get(e)??5)*.9+2,z:r,color:G},window.__markerActive=!0,window.__selectedLabel=t,W.textContent=t,W.style.display=`block`}function it(){et=null,$e=null,window.__markerActive=!1,window.__selectedLabel=null,W.style.display=`none`}function at(e,t){let n=w.width/Math.max(1,w.height),r=Math.tan(st/2),i=e/w.width*2-1,a=1-t/w.height*2,o=H(Le(Ze,z.target)),s=H(ze([0,1,0],o)),c=ze(o,s),l=H([i*n*r*s[0]+a*r*c[0]-o[0],i*n*r*s[1]+a*r*c[1]-o[1],i*n*r*s[2]+a*r*c[2]-o[2]]);return{origin:Ze,dir:l}}function ot(e,t,n,r){let i=e[0]-n[0],a=e[1]-n[1],o=e[2]-n[2],s=i*t[0]+a*t[1]+o*t[2],c=i*i+a*a+o*o-r*r,l=s*s-c;if(l<0)return null;let u=Math.sqrt(l),d=-s-u;return d<0&&(d=-s+u),d<0?null:d}let st=.72;function ct(e,t){let n=0;for(let r=2;r<=400;r+=2){let i=e[0]+t[0]*r;if(e[1]+t[1]*r-$(i,e[2]+t[2]*r)*13<=0){let i=n,a=r;for(let n=0;n<12;n++){let n=(i+a)/2,r=e[0]+t[0]*n,o=e[2]+t[2]*n;e[1]+t[1]*n-$(r,o)*13>0?i=n:a=n}return{t:a,x:e[0]+t[0]*a,z:e[2]+t[2]*a}}n=r}return null}function lt(e,t){try{let n=window.parent;n&&n!==window&&typeof n.renderCartoucheFor==`function`&&n.renderCartoucheFor(e,t)}catch{}}function ut(e){try{let t=window.parent;t&&t!==window&&typeof t.renderMarchCartoucheFor==`function`&&t.renderMarchCartoucheFor(e)}catch{}}function dt(e,t){let{origin:n,dir:r}=at(e,t),i=w.height/(2*Math.tan(st/2)),a=null,o=1/0;for(let e of x){let t=d.x[e],s=d.y[e],c=m.get(e)??5,l=[t,$(t,s)*13+c*.5,s],u=Math.hypot(l[0]-n[0],l[1]-n[1],l[2]-n[2]),f=ot(n,r,l,Math.max(c*1.15,46*u/i));f!==null&&f<o&&(o=f,a={kind:`entity`,eid:e,t:f})}for(let e of J){let t=[e.x,$(e.x,e.y)*13+2.2,e.y],s=Math.hypot(t[0]-n[0],t[1]-n[1],t[2]-n[2]),c=ot(n,r,t,Math.max(3,40*s/i));c!==null&&c<o&&(o=c,a={kind:`march`,march:e,t:c})}let s=ct(n,r);return s!==null&&s.t<o&&(a={kind:`ground`,x:s.x,z:s.z,t:s.t},o=s.t),a}B.onTap((e,t)=>{let n=w.getBoundingClientRect(),r=dt((e-n.left)*(w.width/n.width),(t-n.top)*(w.height/n.height));if(r?.kind===`entity`){rt(r.eid);let e=v.get(r.eid);e&&lt(e.x,e.y);return}if(r?.kind===`march`){it(),tt=r.march.id,window.__selectedMarchId=r.march.id,ut(r.march.id);return}it(),tt=null,r?.kind===`ground`&&lt(Math.floor(r.x),Math.floor(r.z))});let q=0;async function ft(){let e=wn(z.target[0],z.target[2],384);if(!e)return;let t=new Set,n=[],r=new Set;for(let i of e){t.add(i.key);let e=y.get(i.key);if(e!==void 0){if(h.set(e,i.nm),g.set(e,i.lv),_.set(e,!!i.own),et===e&&rt(e),p.get(e)!==i.model){p.set(e,i.model),m.set(e,i.scale);let t=d.x[e],r=d.y[e],a=Ue(t,$(t,r)*13,r,0,i.scale);n.push(Te(i.model).then(t=>void De.set(e,Se.createInstance(t,a))).catch(()=>{}))}continue}let a=b(i),o=$(i.x,i.y)*13,s=Ue(i.x,o,i.y,0,i.scale);n.push(Te(i.model).then(e=>void De.set(a,Se.createInstance(e,s))).catch(()=>{})),r.add(ce(Math.floor(i.x/16),Math.floor(i.y/16))),ye(Math.floor(i.x/16),Math.floor(i.y/16))}for(let[e,n]of Array.from(y))t.has(e)||(r.add(ce(Math.floor(d.x[n]/16),Math.floor(d.y[n]/16))),Pe(l,n),De.delete(n),p.delete(n),m.delete(n),h.delete(n),g.delete(n),_.delete(n),v.delete(n),y.delete(e),et===n&&it());await Promise.allSettled(n),x=Array.from(Ce(l,[d,f]));let i=!1;for(let e of r){if(!k.has(e))continue;let[t,n]=e.split(`,`).map(Number);ue.set(e,me(t,n)),i=!0}i&&O(),q++,window.__ecsFound=x.length,window.__syncCount=q}s&&setInterval(()=>{se()||ft().catch(e=>console.error(`live sync:`,e))},3e3);let J=[];function pt(){if(!s)return J=[],[];let e=On();return e?(J=e,window.__marchPositions=e,e.map(e=>({x:e.x,y:$(e.x,e.y)*13+2.2,z:e.y,color:e.own?K:Qe}))):(J=[],[])}let mt=document.getElementById(`labels`),ht=new Map,gt=1024;function _t(){let e=new Set,t=w.clientWidth,n=w.clientHeight;for(let r of x){let i=d.x[r],a=d.y[r],o=i-z.target[0],s=a-z.target[2];if(o*o+s*s>gt)continue;let c=$(i,a)*13+(m.get(r)??5)*.6+1.1,l=We(U,[i,c,a]);if(l.w<=.001)continue;let u=(l.x/l.w*.5+.5)*t,f=(1-(l.y/l.w*.5+.5))*n;if(u<-40||u>t+40||f<-40||f>n+40)continue;e.add(r);let p=ht.get(r);if(!p){let e=document.createElement(`div`);e.className=`wlabel`;let t=document.createElement(`div`);t.className=`nm`;let n=document.createElement(`div`);n.className=`lv`,e.appendChild(t),e.appendChild(n),mt.appendChild(e),p={root:e,nm:t,lv:n},ht.set(r,p)}p.nm.textContent=h.get(r)??`?`,p.nm.classList.toggle(`mine`,!!_.get(r)),p.lv.textContent=g.get(r)??``,p.root.style.transform=`translate(${u.toFixed(1)}px,${f.toFixed(1)}px) translate(-50%,-100%)`}for(let[t,n]of ht)e.has(t)||(n.root.remove(),ht.delete(t))}let vt=new Map;function yt(e,t,n,r){if(!r||!n||r<=n)return t;let i=Math.max(0,Math.min(1,(Date.now()-n)/(r-n)));return e+(t-e)*i}function bt(){let e=new Set,t=w.clientWidth,n=w.clientHeight;for(let r of J){let i=r.battle;if(!i)continue;let a=r.x-z.target[0],o=r.y-z.target[2];if(a*a+o*o>gt)continue;let s=$(r.x,r.y)*13+2.2+1.6,c=We(U,[r.x,s,r.y]);if(c.w<=.001)continue;let l=(c.x/c.w*.5+.5)*t,u=(1-(c.y/c.w*.5+.5))*n;if(l<-60||l>t+60||u<-60||u>n+60)continue;e.add(r.id);let d=vt.get(r.id);if(!d){let e=document.createElement(`div`);e.className=`blabel`;let t=document.createElement(`div`);t.className=`btitle`;let n=document.createElement(`div`);n.className=`bbar atk`;let i=document.createElement(`i`);n.appendChild(i);let a=document.createElement(`div`);a.className=`bbar def`;let o=document.createElement(`i`);a.appendChild(o),e.appendChild(t),e.appendChild(n),e.appendChild(a),mt.appendChild(e),d={root:e,title:t,atkFill:i,defFill:o},vt.set(r.id,d)}let f=i.retreating,p=!f&&i.revealFromRound===0;d.root.className=`blabel`+(f?` retreat`:p?` deploy`:``),d.title.textContent=f?`Отступление`:p?`Развёртывание`:`Бой — раунд `+i.round;let m=Math.max(0,Math.min(100,yt(i.revealFromAttHp,i.attHpLeft,i.revealStart,i.revealAt)/Math.max(1,i.attStartHp)*100)),h=Math.max(0,Math.min(100,yt(i.revealFromDefHp,i.defHpLeft,i.revealStart,i.revealAt)/Math.max(1,i.defStartHp)*100));d.atkFill.style.width=m.toFixed(1)+`%`,d.defFill.style.width=h.toFixed(1)+`%`,d.root.style.transform=`translate(${l.toFixed(1)}px,${u.toFixed(1)}px) translate(-50%,-100%)`}for(let[t,n]of vt)e.has(t)||(n.root.remove(),vt.delete(t))}function xt(e){if(se()){requestAnimationFrame(xt);return}B.isAutoOrbiting()&&(z.yaw=e*15e-5),B.update(e);let t=pt();if(nt!==null){let e=J.find(e=>e.id===nt);e?(z.target[0]=e.x,z.target[2]=e.y,z.target[1]=$(e.x,e.y)*13+1):nt=null}Re||(Me.value=z.target[0].toFixed(1),Fe.value=z.target[2].toFixed(1)),_e(z.target[0],z.target[2]),L(z.target[0],z.target[2]);let i=performance.now()+6;ve(i),xe(i);let a=[z.target[0]+Math.sin(z.yaw)*Math.cos(z.pitch)*z.dist,z.target[1]+Math.sin(z.pitch)*z.dist,z.target[2]+Math.cos(z.yaw)*Math.cos(z.pitch)*z.dist],o=$(a[0],a[2])*13+2;a[1]<o&&(a[1]=o);let s=w.width/Math.max(1,w.height),c=Be(Ve(st,s,.5,300),Ge(a,z.target,[0,1,0]));U=c,Ze=a,E.setVP(c),E.setFog(a,n,r,e/1e3),E.setSunTarget(z.target[0],z.target[2]);{let t=H(Le(a,z.target)),n=H(ze([0,1,0],t)),r=ze(t,n);E.setSkyCamera(n,r,t,Math.tan(st/2),s,e/1e3)}if(Se.setFog(a,n,r),tt!==null){let e=J.find(e=>e.id===tt);e?$e={x:e.x,y:$(e.x,e.y)*13+3.2,z:e.y,color:G}:(tt=null,$e=null)}$e&&t.push($e),E.setMarkers(t),window.__marchCount=t.length-+!!$e,E.frame({r:n[0],g:n[1],b:n[2],a:1},e=>{for(let t of x){let n=De.get(t);n&&Se.draw(e,n,c)}}),_t(),bt(),requestAnimationFrame(xt)}requestAnimationFrame(xt),window.__engineReady=!0}Nn().catch(e=>{Mn([`Ошибка: ${e instanceof Error?e.message:String(e)}`]),console.error(e)});