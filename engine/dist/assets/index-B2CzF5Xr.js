...
`,At=.5,jt=1.4,q=new Float32Array([0,jt,0,At,0,0,0,0,At,0,jt,0,0,0,At,-.5,0,0,0,jt,0,-.5,0,0,0,0,-.5,0,jt,0,0,0,-.5,At,0,0]),Mt=q.length/3,Nt=7;async function Pt(e,t,n){let r=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),i=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),a=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),o=e.createTexture({size:[bt,bt],format:`depth32float`,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}).createView(),s=e.createSampler({compare:`less`,magFilter:`linear`,minFilter:`linear`}),c=Ue(-1,1,-1,1,.1,1),l=!0,u=1/0,d=1/0,f=1.5;function p(t,n){let r=t-u,i=n-d;if(!l&&r*r+i*i<f*f)return;u=t,d=n;let o=Je([t+yt[0]*xt,yt[1]*xt,n+yt[2]*xt],[t,0,n],[0,1,0]);c=Ve(Ue(-60,K,-60,K,St,Ct),o),e.queue.writeBuffer(a,0,c),l=!0}let[m,h,g,_,v,y,b,x,S,ee,C,w]=await Promise.all([G(e,`/textures/ground/sand.jpg`),G(e,`/textures/ground/grass.jpg`),G(e,`/textures/ground/dry_meadow.jpg`),G(e,`/textures/ground/scree.jpg`),G(e,`/textures/ground/rock.jpg`),G(e,`/textures/ground/snow.jpg`),G(e,`/textures/ground/forest_floor.jpg`),G(e,`/textures/ground/desert.jpg`),G(e,`/textures/ground/marsh.jpg`),G(e,`/textures/ground/tundra_moss.jpg`),G(e,`/textures/water/detail.jpg`),G(e,`/textures/world/regions_overlay.png`,2400)]),te=e.createSampler({addressModeU:`repeat`,addressModeV:`repeat`,magFilter:`linear`,minFilter:`linear`}),ne=e.createShaderModule({code:wt}),re=e.createRenderPipeline({layout:`auto`,vertex:{module:ne,entryPoint:`vs`,buffers:[{arrayStride:60,attributes:[{shaderLocation:0,offset:0,format:`float32x3`},{shaderLocation:1,offset:12,format:`float32x3`},{shaderLocation:2,offset:24,format:`float32x3`},{shaderLocation:3,offset:36,format:`float32x2`},{shaderLocation:4,offset:44,format:`float32`},{shaderLocation:5,offset:48,format:`float32`},{shaderLocation:6,offset:52,format:`float32`},{shaderLocation:7,offset:56,format:`float32`}]}]},fragment:{module:ne,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`,cullMode:`back`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),ie=e.createBindGroup({layout:re.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}},{binding:2,resource:te},{binding:3,resource:m.createView()},{binding:4,resource:h.createView()},{binding:5,resource:g.createView()},{binding:6,resource:_.createView()},{binding:7,resource:v.createView()},{binding:8,resource:{buffer:a}},{binding:9,resource:s},{binding:10,resource:o},{binding:11,resource:y.createView()},{binding:12,resource:b.createView()},{binding:13,resource:x.createView()},{binding:14,resource:S.createView()},{binding:15,resource:ee.createView()},{binding:16,resource:C.createView()},{binding:17,resource:w.createView()}]}),[ae,T]=await Promise.all([G(e,`/textures/sky/sky.jpg`),G(e,`/textures/sky/clouds.png`)]),oe=e.createSampler({addressModeU:`repeat`,addressModeV:`clamp-to-edge`,magFilter:`linear`,minFilter:`linear`}),se=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),ce=e.createShaderModule({code:kt}),le=e.createRenderPipeline({layout:`auto`,vertex:{module:ce,entryPoint:`vs`},fragment:{module:ce,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`,cullMode:`none`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!1,depthCompare:`always`}}),E=e.createBindGroup({layout:le.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:se}},{binding:1,resource:oe},{binding:2,resource:ae.createView()},{binding:3,resource:T.createView()}]}),ue=new Float32Array(16);function de(t,n,r,i,a,o){let s=ue;s[0]=t[0],s[1]=t[1],s[2]=t[2],s[3]=0,s[4]=n[0],s[5]=n[1],s[6]=n[2],s[7]=0,s[8]=r[0],s[9]=r[1],s[10]=r[2],s[11]=0,s[12]=i,s[13]=a,s[14]=o,s[15]=0,e.queue.writeBuffer(se,0,s)}let fe=e.createShaderModule({code:Dt}),pe=e.createRenderPipeline({layout:`auto`,vertex:{module:fe,entryPoint:`vs`,buffers:[{arrayStride:60,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]}]},primitive:{topology:`triangle-list`,cullMode:`back`},depthStencil:{format:`depth32float`,depthWriteEnabled:!0,depthCompare:`less`}}),me=e.createBindGroup({layout:pe.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:a}}]}),he=new Set;function ge(e){return e===`world-backdrop`?`backdrop`:e.startsWith(`far:`)?`far`:`near`}let D={near:null,far:null,backdrop:null},_e=t=>new vt({createBuffer(n){D[t]?.destroy(),D[t]=e.createBuffer({size:n,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST})},write(n,r){let i=D[t];i&&e.queue.writeBuffer(i,n,r,0,r.length)}}),ve={near:_e(`near`),far:_e(`far`),backdrop:_e(`backdrop`)},ye=e.createShaderModule({code:Tt}),be=e.createBuffer({size:q.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(be,0,q);let O=e.createRenderPipeline({layout:`auto`,vertex:{module:ye,entryPoint:`vs`,buffers:[{arrayStride:12,stepMode:`vertex`,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]},{arrayStride:28,stepMode:`instance`,attributes:[{shaderLocation:1,offset:0,format:`float32x3`},{shaderLocation:2,offset:12,format:`float32`},{shaderLocation:3,offset:16,format:`float32x3`}]}]},fragment:{module:ye,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),xe=e.createBindGroup({layout:O.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}}]}),k=null,Se=null,Ce=0,A=0,we=e.createShaderModule({code:Et});function Te(t){let n=e.createBuffer({size:Math.max(t.vertexCount*10*4,4),usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),r=new Float32Array(t.vertexCount*10);for(let e=0;e<t.vertexCount;e++)r.set(t.positions.subarray(e*3,e*3+3),e*10),r.set(t.normals.subarray(e*3,e*3+3),e*10+3),r[e*10+6]=t.materialIds[e],r[e*10+7]=t.shades[e],r.set(t.uvs.subarray(e*2,e*2+2),e*10+8);return e.queue.writeBuffer(n,0,r),n}let Ee=await Promise.all(Object.entries({bark:`/textures/decor/bark.jpg`,birchBark:`/textures/decor/birch_bark.jpg`,conifer:`/textures/decor/conifer_a.png`,conifer2:`/textures/decor/conifer_b.png`,broadleaf:`/textures/decor/broadleaf.png`,autumn:`/textures/decor/autumn.png`,birchLeaf:`/textures/decor/birch_leaf.png`,bush:`/textures/decor/bush.png`,grassTuft:`/textures/decor/grass_tuft.png`}).map(async([t,n])=>[t,await G(e,n)])),j={...Object.fromEntries(Ee),rock:v},M=e.createSampler({magFilter:`linear`,minFilter:`linear`}),N={spruce:{trunk:`bark`,canopy:`conifer`},pine:{trunk:`bark`,canopy:`conifer2`},broadleaf:{trunk:`bark`,canopy:`broadleaf`},autumn:{trunk:`bark`,canopy:`autumn`},birch:{trunk:`birchBark`,canopy:`birchLeaf`},dead:{trunk:`bark`,canopy:`bark`},bush:{trunk:`bark`,canopy:`bush`},grass:{trunk:`bark`,canopy:`grassTuft`},rock:{trunk:`bark`,canopy:`rock`}},De={spruce:rt,pine:it,broadleaf:W,autumn:W,birch:at,dead:ot,bush:ct,grass:ut,rock:_t},Oe=[{arrayStride:40,stepMode:`vertex`,attributes:[{shaderLocation:0,offset:0,format:`float32x3`},{shaderLocation:1,offset:12,format:`float32x3`},{shaderLocation:2,offset:24,format:`float32`},{shaderLocation:3,offset:28,format:`float32`},{shaderLocation:4,offset:32,format:`float32x2`}]},{arrayStride:40,stepMode:`instance`,attributes:[{shaderLocation:5,offset:0,format:`float32x3`},{shaderLocation:6,offset:12,format:`float32x3`},{shaderLocation:7,offset:24,format:`float32`},{shaderLocation:8,offset:28,format:`float32x3`}]}],ke=e.createRenderPipeline({layout:`auto`,vertex:{module:we,entryPoint:`vs`,buffers:Oe},fragment:{module:we,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),Ae=e.createShaderModule({code:Ot}),je=e.createRenderPipeline({layout:`auto`,vertex:{module:Ae,entryPoint:`vs`,buffers:Oe},fragment:{module:Ae,entryPoint:`fs`,targets:[]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth32float`,depthWriteEnabled:!0,depthCompare:`less`}}),P=new Map;for(let t of Object.keys(N)){let n=De[t](),c=N[t],l=e.createBindGroup({layout:ke.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}},{binding:2,resource:M},{binding:3,resource:j[c.trunk].createView()},{binding:4,resource:j[c.canopy].createView()},{binding:5,resource:{buffer:a}},{binding:6,resource:s},{binding:7,resource:o}]}),u=e.createBindGroup({layout:je.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:a}},{binding:1,resource:M},{binding:2,resource:j[c.canopy].createView()}]});P.set(t,{mesh:n,localBuf:Te(n),instBuf:null,instCapacity:0,instanceCount:0,bindGroup:l,shadowBindGroup:u,scratch:null,shadowInstBuf:null,shadowInstCapacity:0,shadowInstanceCount:0,shadowScratch:null})}let F=null,I=null;function Me(){let n=t.canvas.width,r=t.canvas.height;F&&F.width===n&&F.height===r||(F?.destroy(),F=e.createTexture({size:[n,r],format:`depth24plus`,usage:GPUTextureUsage.RENDER_ATTACHMENT}),I=F.createView())}function L(e,t){let n=new Float32Array(t.vertexCount*15);for(let e=0;e<t.vertexCount;e++)n.set(t.positions.subarray(e*3,e*3+3),e*15),n.set(t.colors.subarray(e*3,e*3+3),e*15+3),n.set(t.normals.subarray(e*3,e*3+3),e*15+6),n.set(t.uvs.subarray(e*2,e*2+2),e*15+9),n[e*15+11]=t.elevations[e],n[e*15+12]=t.waterFlags[e],n[e*15+13]=t.forestFracs[e],n[e*15+14]=t.moistureFracs[e];he.add(e);let r=ge(e);ve[r].put(e,n,t.vertexCount),r===`near`&&(l=!0)}function Ne(e){if(!he.has(e))return;he.delete(e);let t=ge(e);ve[t].remove(e),t===`near`&&(l=!0)}function Pe(t){if(A=t.length,A>Ce&&(k?.destroy(),Ce=Math.max(A,8),k=e.createBuffer({size:Ce*Nt*4,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),Se=new Float32Array(Ce*Nt)),A===0||!k)return;let n=Se;t.forEach((e,t)=>{let r=t*Nt;n[r]=e.x,n[r+1]=e.y,n[r+2]=e.z,n[r+3]=1,n[r+4]=e.color[0],n[r+5]=e.color[1],n[r+6]=e.color[2]}),e.queue.writeBuffer(k,0,n,0,A*Nt)}function R(t,n,r){let i=t.scratch;if(!i||t.instanceCount===0){t.shadowInstanceCount=0;return}let a=n-K,o=n+K,s=r-K,c=r+K;t.instanceCount>t.shadowInstCapacity&&(t.shadowInstBuf?.destroy(),t.shadowInstCapacity=Math.max(t.instanceCount,8),t.shadowInstBuf=e.createBuffer({size:t.shadowInstCapacity*10*4,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),t.shadowScratch=new Float32Array(t.shadowInstCapacity*10));let l=t.shadowScratch,u=0;for(let e=0;e<t.instanceCount;e++){let t=e*10,n=i[t],r=i[t+2];n<a||n>o||r<s||r>c||(l.set(i.subarray(t,t+10),u*10),u++)}t.shadowInstanceCount=u,u>0&&t.shadowInstBuf&&e.queue.writeBuffer(t.shadowInstBuf,0,l,0,u*10)}function Fe(t,n){let r=t.length;if(r>n.instCapacity&&(n.instBuf?.destroy(),n.instCapacity=Math.max(r,8),n.instBuf=e.createBuffer({size:n.instCapacity*10*4,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),n.scratch=new Float32Array(n.instCapacity*10)),n.instanceCount=r,r===0||!n.instBuf)return;let i=n.scratch;t.forEach((e,t)=>{let n=t*10;i[n]=e.x,i[n+1]=e.y,i[n+2]=e.z,i[n+3]=e.scale[0],i[n+4]=e.scale[1],i[n+5]=e.scale[2],i[n+6]=e.yaw,i[n+7]=e.color[0],i[n+8]=e.color[1],i[n+9]=e.color[2]}),e.queue.writeBuffer(n.instBuf,0,i,0,r*10)}function Ie(e){let t=new Map;for(let n of e){let e=t.get(n.kind);e||(e=[],t.set(n.kind,e)),e.push(n)}for(let[e,n]of P)Fe(t.get(e)??[],n);l=!0}function Le(t){e.queue.writeBuffer(r,0,t)}let Re=new Float32Array(8);function z(t,n,r,a){let o=Re;o[0]=t[0],o[1]=t[1],o[2]=t[2],o[3]=a,o[4]=n[0],o[5]=n[1],o[6]=n[2],o[7]=r,e.queue.writeBuffer(i,0,o)}function ze(n,r){Me();let i=e.createCommandEncoder();if(l){let e=i.beginRenderPass({colorAttachments:[],depthStencilAttachment:{view:o,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}});ve.near.vertexCount>0&&D.near&&(e.setPipeline(pe),e.setBindGroup(0,me),e.setVertexBuffer(0,D.near),e.draw(ve.near.vertexCount));let t=!1;for(let e of P.values()){if(e.instanceCount===0){e.shadowInstanceCount=0;continue}R(e,u,d),e.shadowInstanceCount>0&&(t=!0)}if(t){e.setPipeline(je);for(let t of P.values())t.shadowInstanceCount===0||!t.shadowInstBuf||(e.setBindGroup(0,t.shadowBindGroup),e.setVertexBuffer(0,t.localBuf),e.setVertexBuffer(1,t.shadowInstBuf),e.draw(t.mesh.vertexCount,t.shadowInstanceCount))}e.end(),l=!1}let a=t.getCurrentTexture().createView(),s=i.beginRenderPass({colorAttachments:[{view:a,clearValue:n,loadOp:`clear`,storeOp:`store`}],depthStencilAttachment:{view:I,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}});if(s.setPipeline(le),s.setBindGroup(0,E),s.draw(3),he.size>0){s.setPipeline(re),s.setBindGroup(0,ie);for(let e of[`near`,`far`,`backdrop`]){let t=ve[e],n=D[e];t.vertexCount===0||!n||(s.setVertexBuffer(0,n),s.draw(t.vertexCount))}}A>0&&k&&(s.setPipeline(O),s.setBindGroup(0,xe),s.setVertexBuffer(0,be),s.setVertexBuffer(1,k),s.draw(Mt,A));let c=!1;for(let e of P.values())if(e.instanceCount>0){c=!0;break}if(c){s.setPipeline(ke);for(let e of P.values())e.instanceCount===0||!e.instBuf||(s.setBindGroup(0,e.bindGroup),s.setVertexBuffer(0,e.localBuf),s.setVertexBuffer(1,e.instBuf),s.draw(e.mesh.vertexCount,e.instanceCount))}r?.(s),s.end(),e.queue.submit([i.finish()])}function B(){return{lightBuf:a,shadowView:o,shadowSampler:s}}return{setTerrainChunk:L,removeTerrainChunk:Ne,setMarkers:Pe,setDecor:Ie,setVP:Le,setFog:z,setSunTarget:p,setSkyCamera:de,getShadowResources:B,frame:ze}}var J=12345,Ft=.235,It=2400,Lt=1200,Rt=It/2;Lt/2;var Y=2.5;function X(e,t,n){let r=e*374761393+t*668265263+n*1274126177;return r=Math.imul(r^r>>>13,1274126177),((r^r>>>16)>>>0)/4294967296}function zt(e,t,n){let r=Math.floor(e),i=Math.floor(t),a=e-r,o=t-i,s=a*a*(3-2*a),c=o*o*(3-2*o),l=X(r,i,n),u=X(r+1,i,n),d=X(r,i+1,n),f=X(r+1,i+1,n);return(l*(1-s)+u*s)*(1-c)+(d*(1-s)+f*s)*c}var Bt=null,Vt=null,Ht=null;async function Ut(e,t){let n=await fetch(e);if(!n.ok)throw Error(`${e}: HTTP ${n.status}`);let r=await n.arrayBuffer();if(r.byteLength!==t)throw Error(`${e}: неверный размер (${r.byteLength} байт, ожидалось ${t})`);return r}async function Wt(){let e=It*Lt,[t,n,r]=await Promise.all([Ut(`/heightmap/elevation-v6.bin`,e*2),Ut(`/heightmap/forest.bin`,e),Ut(`/heightmap/moisture.bin`,e)]);Bt=new Uint16Array(t),Vt=new Uint8Array(n),Ht=new Uint8Array(r)}function Gt(e,t,n,r){let i=Math.floor(t),a=Math.floor(n),o=Math.min(i+1,2399),s=Math.min(a+1,1199),c=t-i,l=n-a,u=a*It+i,d=a*It+o,f=s*It+i,p=s*It+o,m=e[u]+(e[d]-e[u])*c;return(m+(e[f]+(e[p]-e[f])*c-m)*l)*r}function Kt(e,t){return[Math.max(0,Math.min(2399,e+Rt)),Math.max(0,Math.min(1199,t+600))]}function Z(e,t){if(!Bt)return .285;let[n,r]=Kt(e,t);return Gt(Bt,n,r,Y/65535)}function qt(e,t){let n=Z(e,t),r=(Z(e+.7,t)+Z(e-.7,t)+Z(e,t+.7)+Z(e,t-.7))*.25;return n*.55+r*.45}var Jt=32,Yt=new Map;function Xt(e,t){return Math.floor(e/Jt)+`,`+Math.floor(t/Jt)}function Zt(e,t,n){let r={x:e,z:t,targetH:Math.max(qt(e,t),.245),radius:n},i=Xt(e,t),a=Yt.get(i);a?a.push(r):Yt.set(i,[r])}function Q(e,t){let n=Z(e,t);if(n<.235||Yt.size===0)return n;let r=Math.floor(e/Jt),i=Math.floor(t/Jt),a=0,o=0;for(let n=-1;n<=1;n++)for(let s=-1;s<=1;s++){let c=Yt.get(r+s+`,`+(i+n));if(c)for(let n of c){let r=Math.hypot(e-n.x,t-n.z);if(r>=n.radius)continue;let i=n.radius*.55,s=r<=i?1:1-((r-i)/(n.radius-i))**2*(3-2*((r-i)/(n.radius-i)));a+=s,o+=s*n.targetH}}return a<=0?n:a>=1?o/a:n*(1-a)+o}function Qt(e,t){return Q(e,t)<Ft}function $(e,t){if(!Ht)return .5;let[n,r]=Kt(e,t);return Gt(Ht,n,r,1/255)}function $t(e,t){if(!Vt)return 0;let[n,r]=Kt(e,t);return Gt(Vt,n,r,1/255)}var en=(e,t,n)=>[e[0]+(t[0]-e[0])*n,e[1]+(t[1]-e[1])*n,e[2]+(t[2]-e[2])*n],tn=[.14,.24,.28],nn=[.05,.11,.19];function rn(e){return en(tn,nn,Math.min(1,e))}var an=[0,1,0],on=6;function sn(e,t){let n=.5,r=Q(e-n,t)*13,i=Q(e+n,t)*13,a=Q(e,t-n)*13,o=Q(e,t+n)*13;return V([-(i-r)/(2*n),1,-(o-a)/(2*n)])}var cn=6;function ln(e,t,n){let r=n/2,i=1/0;for(let a=0;a<=cn;a++){let o=-r+a/cn*n;for(let a=0;a<=cn;a++){let s=Q(e+(-r+a/cn*n),t+o);s<i&&(i=s)}}return i}function un(e,t,n,r,i=1,a=0){let o=Math.round((n-e)/i),s=Math.round((r-t)/i),c=i===1,l=[],u=[],d=[],f=[],p=[],m=[],h=[],g=[];function _(e,t){let n=c?Q(e,t):ln(e,t,i),r=n<Ft,o=r?[e,Ft*13-a,t]:[e,n*13-a,t],s=r?rn((Ft-n)*3):[0,0,0],l=r?an:c?sn(e,t):an,u=r?0:$t(e,t),d=r?0:$(e,t);return{p:o,c:s,n:l,uv:[e/on,t/on],e:n,water:+!!r,forest:u,moisture:d}}let v=[];for(let n=0;n<=s;n++){let r=[];for(let a=0;a<=o;a++)r.push(_(e+a*i,t+n*i));v.push(r)}function y(e,t,n){let r=c?null:V(Be(ze(t.p,e.p),ze(n.p,e.p)));for(let i of[e,t,n]){l.push(i.p[0],i.p[1],i.p[2]),u.push(i.c[0],i.c[1],i.c[2]);let e=r??i.n;d.push(e[0],e[1],e[2]),f.push(i.uv[0],i.uv[1]),p.push(i.e),m.push(i.water),h.push(i.forest),g.push(i.moisture)}}for(let e=0;e<s;e++)for(let t=0;t<o;t++){let n=v[e][t],r=v[e][t+1],i=v[e+1][t],a=v[e+1][t+1];y(n,a,r),y(n,i,a)}return{positions:new Float32Array(l),colors:new Float32Array(u),normals:new Float32Array(d),uvs:new Float32Array(f),elevations:new Float32Array(p),waterFlags:new Float32Array(m),forestFracs:new Float32Array(h),moistureFracs:new Float32Array(g),vertexCount:l.length/3}}var dn=9,fn=10,pn=380,mn={d:[1,0],arrowright:[1,0],a:[-1,0],arrowleft:[-1,0],w:[0,1],arrowup:[0,1],s:[0,-1],arrowdown:[0,-1]},hn=700;function gn(e,t){let n=!0,r=new Map,i=null,a=null,o=null,s=null,c=null,l=null,u=null,d=!1,f=null;function p(){n=!1,f?.()}function m(){let e=[...r.values()];return{x:(e[0].x+e[1].x)/2,y:(e[0].y+e[1].y)/2,d:Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y)}}function h(){let e=[...r.values()];return Math.atan2(e[1].y-e[0].y,e[1].x-e[0].x)}function g(e,n){let r=t.dist*.0022,i=e*r,a=n*r,o=Math.cos(t.yaw),s=Math.sin(t.yaw);t.target[0]=Math.max(-Rt,Math.min(Rt,t.target[0]-(i*o-a*s))),t.target[2]=Math.max(-600,Math.min(600,t.target[2]+(i*s+a*o))),t.target[1]=Q(t.target[0],t.target[2])*13+1}e.addEventListener(`pointerdown`,n=>{n.preventDefault(),p(),r.set(n.pointerId,{x:n.clientX,y:n.clientY});try{e.setPointerCapture(n.pointerId)}catch{}if(r.size===1)d=!!c?.(n.clientX,n.clientY),d?(i=null,o={x:n.clientX,y:n.clientY,t:performance.now()}):(i={x:n.clientX,y:n.clientY,tx:t.target[0],tz:t.target[2]},o={x:n.clientX,y:n.clientY,t:performance.now()});else if(r.size===2){d&&(d=!1,u?.(NaN,NaN)),i=null,o=null;let e=m();a={d:e.d,y:e.y,dist:t.dist,yaw:t.yaw,pitch:t.pitch,angle:h()}}}),e.addEventListener(`pointermove`,e=>{if(r.has(e.pointerId)){if(e.preventDefault(),r.set(e.pointerId,{x:e.clientX,y:e.clientY}),o&&Math.hypot(e.clientX-o.x,e.clientY-o.y)>fn&&(o=null),d){l?.(e.clientX,e.clientY);return}if(r.size>=2&&a){let e=m();t.dist=Math.max(dn,Math.min(140,a.dist*(a.d/Math.max(12,e.d)))),t.yaw=a.yaw+(h()-a.angle),t.pitch=Math.max(.08,Math.min(1.42,a.pitch+(e.y-a.y)*.005));return}i&&(t.target[0]=i.tx,t.target[2]=i.tz,g(e.clientX-i.x,i.y-e.clientY))}});function _(e){let n=!!(o&&r.size===1&&performance.now()-o.t<pn);if(d&&(d=!1,u?.(n?NaN:e.clientX,n?NaN:e.clientY)),n&&s?.(o.x,o.y),o=null,r.delete(e.pointerId),r.size<2&&(a=null),r.size===0)i=null;else if(r.size===1){let e=[...r.values()][0];i={x:e.x,y:e.y,tx:t.target[0],tz:t.target[2]}}}e.addEventListener(`pointerup`,_),e.addEventListener(`pointercancel`,_),e.addEventListener(`wheel`,e=>{e.preventDefault(),p(),t.dist=Math.max(dn,Math.min(140,t.dist*(e.deltaY<0?.9:1.11)))},{passive:!1});let v=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();t in mn&&(v.add(t),p())}),window.addEventListener(`keyup`,e=>{v.delete(e.key.toLowerCase())});let y=null;function b(e){if(y===null){y=e;return}let t=Math.min(.1,(e-y)/1e3);if(y=e,v.size===0||i)return;let n=0,r=0;for(let e of v){let[t,i]=mn[e];n+=t,r+=i}(n!==0||r!==0)&&g(n*hn*t,r*hn*t)}return{isAutoOrbiting:()=>n,stopAuto:p,update:b,onGrab(e,t,n){c=e,l=t,u=n},onTap(e){s=e},onInteract(e){f=e}}}var _n={5121:Uint8Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},vn={SCALAR:1,VEC2:2,VEC3:3,VEC4:4};async function yn(e){let t=await(await fetch(e)).arrayBuffer(),n=new DataView(t);if(n.getUint32(0,!0)!==1179937895)throw Error(`не glTF-контейнер: `+e);let r=n.getUint32(8,!0),i=12,a=null,o=null;for(;i<r;){let e=n.getUint32(i,!0),r=n.getUint32(i+4,!0),s=t.slice(i+8,i+8+e);r===1313821514?a=JSON.parse(new TextDecoder().decode(s)):r===5130562&&(o=s),i+=8+e}if(!a||!o)throw Error(`GLB без JSON/BIN чанка: `+e);let s=e=>a.accessors[e],c=e=>a.bufferViews[e];function l(e){let t=s(e),n=c(t.bufferView),r=_n[t.componentType],i=(n.byteOffset||0)+(t.byteOffset||0),a=vn[t.type],l=a*r.BYTES_PER_ELEMENT,u=n.byteStride||0;if(!u||u===l)return new r(o,i,t.count*a);let d=new r(t.count*a);for(let e=0;e<t.count;e++)d.set(new r(o,i+e*u,a),e*a);return d}let u=a.meshes[0].primitives[0],d=l(u.attributes.POSITION),f=l(u.attributes.NORMAL),p=l(u.attributes.TEXCOORD_0),m=l(u.indices),h=a.materials[u.material].pbrMetallicRoughness.baseColorTexture.index,g=a.images[a.textures[h].source],_=c(g.bufferView);return{positions:d,normals:f,uvs:p,indices:m,imageBytes:o.slice(_.byteOffset||0,(_.byteOffset||0)+_.byteLength),imageMimeType:g.mimeType}}var bn=`
...
`;async function xn(e,t){let n=e.createBuffer({size:t.positions.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(n,0,t.positions);let r=e.createBuffer({size:t.normals.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(r,0,t.normals);let i=e.createBuffer({size:t.uvs.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(i,0,t.uvs);let a=t.indices.byteLength,o=Math.ceil(a/4)*4,s=e.createBuffer({size:o,usage:GPUBufferUsage.INDEX|GPUBufferUsage.COPY_DST});if(o===a)e.queue.writeBuffer(s,0,t.indices);else{let n=new Uint8Array(o);n.set(new Uint8Array(t.indices.buffer,t.indices.byteOffset,a)),e.queue.writeBuffer(s,0,n)}let c=await createImageBitmap(new Blob([t.imageBytes],{type:t.imageMimeType})),l=Math.min(1,1024/Math.max(c.width,c.height)),u=l<1?await createImageBitmap(c,{resizeWidth:Math.round(c.width*l),resizeHeight:Math.round(c.height*l),resizeQuality:`medium`}):c;l<1&&c.close();let d=e.createTexture({size:[u.width,u.height],format:`rgba8unorm`,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT});return e.queue.copyExternalImageToTexture({source:u},{texture:d},[u.width,u.height]),u.close(),{vao:{posBuf:n,nrmBuf:r,uvBuf:i,idxBuf:s,indexFormat:t.indices instanceof Uint16Array?`uint16`:`uint32`,indexCount:t.indices.length},texture:d}}function Sn(e,t,n){let r=e.createShaderModule({code:bn}),i=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:`filtering`}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`float`}},{binding:3,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},{binding:4,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},{binding:5,visibility:GPUShaderStage.FRAGMENT,sampler:{type:`comparison`}},{binding:6,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`depth`}},{binding:7,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},{binding:8,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]}),a=e.createPipelineLayout({bindGroupLayouts:[i]}),o=e.createRenderPipeline({layout:a,vertex:{module:r,entryPoint:`vs`,buffers:[{arrayStride:12,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]},{arrayStride:12,attributes:[{shaderLocation:1,offset:0,format:`float32x3`}]},{arrayStride:8,attributes:[{shaderLocation:2,offset:0,format:`float32x2`}]}]},fragment:{module:r,entryPoint:`fs`,targets:[{format:t}]},primitive:{topology:`triangle-list`,cullMode:`back`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),s=e.createRenderPipeline({layout:a,vertex:{module:r,entryPoint:`vsOutline`,buffers:[{arrayStride:12,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]},{arrayStride:12,attributes:[{shaderLocation:1,offset:0,format:`float32x3`}]}]},fragment:{module:r,entryPoint:`fsOutline`,targets:[{format:t}]},primitive:{topology:`triangle-list`,cullMode:`front`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!1,depthCompare:`less`}}),c=e.createSampler({magFilter:`linear`,minFilter:`linear`,mipmapFilter:`linear`}),l=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});function u(t,n,r){let i=f;i[0]=t[0],i[1]=t[1],i[2]=t[2],i[3]=0,i[4]=n[0],i[5]=n[1],i[6]=n[2],i[7]=r,e.queue.writeBuffer(l,0,i)}let d=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),f=new Float32Array(8),p=e.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),m=new Float32Array(4);function h(t,n){m[0]=t[0],m[1]=t[1],m[2]=t[2],m[3]=n,e.queue.writeBuffer(p,0,m)}function g(t){e.queue.writeBuffer(d,0,t)}function _(t,r,a){let o=e.createBuffer({size:Cn*4,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),s={model:t,modelBuf:o,bindGroup:e.createBindGroup({layout:i,entries:[{binding:0,resource:{buffer:d}},{binding:1,resource:c},{binding:2,resource:t.texture.createView()},{binding:3,resource:{buffer:l}},{binding:4,resource:{buffer:n.lightBuf}},{binding:5,resource:n.shadowSampler},{binding:6,resource:n.shadowView},{binding:7,resource:{buffer:o}},{binding:8,resource:{buffer:p}}]}),scratch:new Float32Array(Cn)};return v(s,r,a),s}function v(t,n,r){let i=t.scratch;i.set(n,0),i[16]=r?r[0]:1,i[17]=r?r[1]:1,i[18]=r?r[2]:1,i[19]=r?r[3]:0,e.queue.writeBuffer(t.modelBuf,0,i)}function y(e){if(e)try{e.modelBuf.destroy()}catch{}}function b(e){e.setPipeline(o)}function x(e){e.setPipeline(s)}function S(e,t){e.setBindGroup(0,t.bindGroup),e.setVertexBuffer(0,t.model.vao.posBuf),e.setVertexBuffer(1,t.model.vao.nrmBuf),e.setIndexBuffer(t.model.vao.idxBuf,t.model.vao.indexFormat),e.drawIndexed(t.model.vao.indexCount)}function ee(e,t){e.setBindGroup(0,t.bindGroup),e.setVertexBuffer(0,t.model.vao.posBuf),e.setVertexBuffer(1,t.model.vao.nrmBuf),e.setVertexBuffer(2,t.model.vao.uvBuf),e.setIndexBuffer(t.model.vao.idxBuf,t.model.vao.indexFormat),e.drawIndexed(t.model.vao.indexCount)}return{createInstance:_,updateInstance:v,destroyInstance:y,beginModels:b,draw:ee,beginOutlines:x,drawOutline:S,setOutlineStyle:h,setFog:u,setVP:g}}var Cn=20,wn={food:`farm`,wood:`sawmill`,stone:`quarry`,gold:`gold-mine`,amber:`amber-vein`},Tn={food:`Пашня`,wood:`Лесопилка`,stone:`Каменоломня`,gold:`Рудник`,amber:`Янтарная жила`};function En(e){return e>=25?5:e>=19?4:e>=13?3:e>=7?2:1}function Dn(){try{let e=window.parent;if(e&&e!==window){let t=e.mpWorldSnapshot;if(typeof t==`function`){let e=t();if(e)return e}if(e.W)return e.W}}catch{}return null}function On(){let e=Dn();return!e||!e.players[0]?null:{x:e.players[0].x,y:e.players[0].y}}var kn=16;function An(e,t,n){let r=Dn();if(!r)return null;let i=[],a=e!==void 0&&t!==void 0&&n!==void 0&&!!r.mapChunks,o=[];if(a){let i=Math.floor((e-n)/kn),a=Math.floor((e+n)/kn),s=Math.floor((t-n)/kn),c=Math.floor((t+n)/kn);for(let e=s;e<=c;e++)for(let t=i;t<=a;t++){let n=r.mapChunks[t+`,`+e];if(n)for(let e of n)o.push(e)}}else for(let e in r.map)o.push(e);let s=n===void 0?1/0:n*n,c=n!==void 0&&e!==void 0&&t!==void 0,l=new Map;for(let e of r.players)l.set(e.id,e);let u=r.players[0]?r.players[0].id:-1;for(let n of o){let a=r.map[n];if(a){if(c){let n=a.x-e,r=a.y-t;if(n*n+r*r>s)continue}if(a.t===`city`){let e=l.get(a.pid),t=e?e.race:`human`,r=e?Math.max(1,Math.min(5,En(e.b.hall))):1,o=!!e&&e.id===u,s=e?e.nick??`?`:`?`,c=e?`Ратуша `+e.b.hall:``;i.push({key:n,x:a.x+.5,y:a.y+.5,gx:a.x,gy:a.y,kind:0,model:`/models/castles/${t}-${r}.glb`,scale:10,own:o,nm:s,lv:c})}else if(a.t===`camp`||a.t===`fort`){let e=(a.t===`fort`?`Форт`:`Лагерь`)+` варваров`,t=`ур. `+(a.lv??`?`);i.push({key:n,x:a.x+.5,y:a.y+.5,gx:a.x,gy:a.y,kind:1,model:`/models/camps/barbarians.glb`,scale:a.t===`fort`?6.5:5,nm:e,lv:t})}else if(a.t===`node`){let e=wn[a.res]||`farm`,t=Tn[a.res]||`Точка`,r=`ур. `+(a.lv??`?`);i.push({key:n,x:a.x+.5,y:a.y+.5,gx:a.x,gy:a.y,kind:2,model:`/models/resources/${e}.glb`,scale:5,nm:t,lv:r})}}}return i}function jn(e){let t=0;for(let n in e)for(let r in e[n])t+=e[n][+r]||0;return t}function Mn(){try{let e=window.parent;if(e&&e!==window){let t=e.mpWorldSnapshot;if(typeof t==`function`){let e=t();if(e)return e}if(e.W)return e.W}}catch{}return null}var Nn=.004;function Pn(e,t){let n=e.path,r=e.pathCum;if(!n||n.length<2)return n&&n[0]||{x:e.tx,y:e.ty};let i=t*(e.pathLen??0);for(let e=1;e<r.length;e++)if(r[e]>=i){let t=r[e]-r[e-1],a=t>0?(i-r[e-1])/t:0,o=n[e-1],s=n[e];return{x:o.x+(s.x-o.x)*a,y:o.y+(s.y-o.y)*a}}return n[n.length-1]}function Fn(){let e=Mn();if(!e||!e.marches)return null;let t=e.players[0]?e.players[0].id:-1,n=new Map;for(let t of e.players)n.set(t.id,t);let r=[];for(let i of e.marches){let a=i.state===`gather`||i.state===`siege`||i.state===`hold`?{x:i.tx,y:i.ty}:Pn(i,Math.max(0,Math.min(1,(e.t-i.t0)/Math.max(1,i.t1-i.t0)))),o=n.get(i.pid),s=NaN;if(i.state!==`gather`&&i.state!==`siege`&&i.state!==`hold`){let t=Math.max(0,Math.min(1,(e.t-i.t0)/Math.max(1,i.t1-i.t0))),n=Pn(i,Math.max(0,t-Nn)),r=Pn(i,Math.min(1,t+Nn)),a=r.x-n.x,o=r.y-n.y;a*a+o*o>1e-12&&(s=Math.atan2(a,o))}let c=i.state===`siege`&&i.data&&i.data.battle?i.data.battle:null,l=c?{round:c.round??0,revealFromRound:c.revealFromRound??0,retreating:!!(c.retreatRequested||c.retreated),attHpLeft:c.attHpLeft??0,attStartHp:c.attStartHp??1,revealFromAttHp:c.revealFromAttHp??c.attHpLeft??0,defHpLeft:c.defHpLeft??0,defStartHp:c.defStartHp??1,revealFromDefHp:c.revealFromDefHp??c.defHpLeft??0,revealStart:c.revealStart??0,revealAt:c.revealAt??0,demolish:c.phase===`demolish`&&c.demolish?{round:c.demolish.round??0,ruinedN:c.demolish.ruined&&c.demolish.ruined.length||0,name:c.demolish.curName??null,hp:c.demolish.curHp??0,max:c.demolish.curMax??0,revealFromHp:c.demolish.revealFromHp??c.demolish.curHp??0,sameTarget:c.demolish.revealFromKey===c.demolish.curKey}:null}:null;r.push({x:a.x,y:a.y,own:i.pid===t,id:i.id,nick:o?.nick??o?.name??`?`,unitsTotal:jn(i.units),state:i.state,tx:i.tx,ty:i.ty,t1:i.t1,battle:l,race:o?.race??`human`,genId:o&&o.gen&&o.gen.id!=null?o.gen.id:null,hasGen:!!(i.hasGen??(i.data&&i.data.has_gen)),scout:i.mode===`scout`||i.mode===`scoutmarch`,yaw:s})}return r}var In=document.getElementById(`status`),Ln=(()=>{try{if(/[?&]debug=1\b/.test(location.search))return!0;if(window.parent&&window.parent!==window)return/[?&]debug=1\b/.test(window.parent.location.search)}catch{}return!1})();Ln&&(In.style.display=`block`);function Rn(e){Ln&&(In.textContent=e.join(`
`))}function zn(e){In.style.display=`block`,In.textContent=e.join(`
`)}async function Bn(){let e=[];function t(t){zn([...e,t]);try{window.parent&&window.parent!==window&&typeof window.parent.forceCityView==`function`&&window.parent.forceCityView()}catch{}}if(!(`gpu`in navigator)){t(`WebGPU: navigator.gpu отсутствует.`);return}await Wt(),e.push(`рельеф: настоящие данные высот загружены`);let n=document.getElementById(`hmVersion`);n&&(n.textContent=`h6`);let r={x:42,y:22},i=[.6,.52,.4],a=35e-5,o=On(),s=o??r,c=An(s.x,s.y,192),l=c!==null;window.parent!==window&&!Ln&&(In.style.display=`none`);let d=c??[{key:`demo-0`,x:43,y:14,gx:43,gy:14,kind:0,model:`/models/castles/human-1.glb`,scale:10,nm:`Замок`,lv:`демо`},{key:`demo-1`,x:50,y:20,gx:50,gy:20,kind:1,model:`/models/camps/barbarians.glb`,scale:5,nm:`Лагерь`,lv:`демо`},{key:`demo-2`,x:55,y:12,gx:55,gy:12,kind:2,model:`/models/resources/farm.glb`,scale:5,nm:`Пашня`,lv:`демо`},{key:`demo-3`,x:30,y:30,gx:30,gy:30,kind:2,model:`/models/resources/quarry.glb`,scale:5,nm:`Каменоломня`,lv:`демо`}];e.push(l?`данные: настоящая партия, сущностей — ${d.length}`:`данные: демо (window.parent.W недоступен)`);let f=u(),p={x:[],y:[]},m={value:[]},h=new Map,g=new Map,_=new Map,v=new Map,y=new Map,b=new Map,x=new Map,S=new Map;function ee(e){let t=Ie(f);return Ne(f,t,p),Ne(f,t,m),p.x[t]=e.x,p.y[t]=e.y,m.value[t]=e.kind,h.set(t,e.model),g.set(t,e.scale),v.set(t,e.nm),y.set(t,e.lv),b.set(t,!!e.own),x.set(t,{x:e.gx,y:e.gy}),S.set(e.key,t),Zt(e.x,e.y,e.scale*1.4),t}for(let e of d)ee(e);let C=Array.from(De(f,[p,m]));e.push(`bitECS: сущностей — ${C.length}`);let w=await navigator.gpu.requestAdapter();if(!w){t(`WebGPU: адаптер не найден.`);return}let te=await w.requestDevice();function ne(e){let t=document.getElementById(`gpu-error-banner`);t||(t=document.createElement(`div`),t.id=`gpu-error-banner`,t.style.cssText=`position:fixed;left:0;right:0;bottom:0;z-index:99999;background:#4a0f0f;color:#fff;font:11px/1.4 monospace;padding:6px 8px;max-height:40vh;overflow:auto;white-space:pre-wrap;`,document.body.appendChild(t)),t.textContent+=(t.textContent?`
---
`:``)+e}te.addEventListener(`uncapturederror`,e=>{let t=e.error.message;console.error(`WebGPU error:`,t),ne(t)});let re=`fb-gpu-reload-at`,ie=Number(sessionStorage.getItem(re)||0),ae=ie&&Date.now()-ie<6e4;te.lost.then(e=>{if(console.error(`WebGPU device lost:`,e.reason,e.message),e.reason!==`destroyed`){if(ae){ne(`WebGPU-устройство теряется повторно (${e.reason}) — похоже, объёмная карта нестабильна на этом устройстве/браузере. Карта города ниже работает независимо от WebGPU.`);try{window.parent&&window.parent!==window&&typeof window.parent.forceCityView==`function`&&window.parent.forceCityView()}catch{}return}ne(`WebGPU-устройство потеряно (${e.reason}): ${e.message}\nПерезагрузка через 2с...`),sessionStorage.setItem(re,String(Date.now())),setTimeout(()=>location.reload(),2e3)}});let T=document.getElementById(`gpu`),oe=T.getContext(`webgpu`);if(!oe){t(`WebGPU: getContext('webgpu') вернул null.`);return}let se=navigator.gpu.getPreferredCanvasFormat();function ce(){let e=T.clientWidth,t=T.clientHeight;if(e<=0||t<=0)return;let n=Math.min(2,window.devicePixelRatio||1),r=Math.max(1,Math.floor(e*n)),i=Math.max(1,Math.floor(t*n));T.width!==r&&(T.width=r),T.height!==i&&(T.height=i)}let le=()=>T.offsetParent===null&&T.clientWidth===0;ce(),new ResizeObserver(ce).observe(T),oe.configure({device:te,format:se,alphaMode:`opaque`}),e.push(`WebGPU: устройство получено, формат — ${se}`);let E=await Pt(te,oe,se);function ue(e,t){return e+`,`+t}function de(e,t){try{let n=window.parent;n&&n!==window&&typeof n.ensureWorldChunk==`function`&&n.ensureWorldChunk(e,t)}catch{}}let fe=new Map;function pe(e,t){return[e[0]*t,e[1]*t,e[2]*t]}function me(e,t,n){if(Qt(e,t))return!0;for(let r=0;r<8;r++){let i=r/8*Math.PI*2;if(Qt(e+Math.cos(i)*n,t+Math.sin(i)*n))return!0}return!1}function he(e,t,n,r){for(let i of C){let a=p.x[i]-e,o=p.y[i]-t,s=(g.get(i)??5)*n+r;if(a*a+o*o<s*s)return!0}return!1}function ge(e,t){return e>1.36?t<.62?`spruce`:t<.94?`pine`:`dead`:t<.58?`broadleaf`:t<.8?`birch`:t<.94?`spruce`:`dead`}function D(e,t){let n=[];for(let r=0;r<4;r++)for(let i=0;i<4;i++){let a=e*4+i,o=t*4+r;if(X(a,o,13122)>=.65)continue;let s=.175+X(a,o,J+778)*.65,c=.175+X(a,o,J+779)*.65,l=e*16+i*4+s*4,u=t*16+r*4+c*4,d=l+(zt(l/8.5,u/8.5,J+790)*2-1)*2,f=u+(zt(l/8.5,u/8.5,J+791)*2-1)*2;if(me(d,f,1.5)||he(d,f,.54,.68))continue;let p=X(a,o,J+781)*Math.PI*2,m=.85+X(a,o,J+782)*.3,h=Q(d,f),g=h*13,_=.0315+.5355*$t(d,f),v=X(a,o,J+780)<_,y=1+X(a,o,J+785)*1.3,b=.8+X(a,o,J+786)*.5;if(v){let e=ge(h,X(a,o,J+780));e===`broadleaf`&&X(a,o,13132)<.35&&(e=`autumn`);let t=e===`spruce`||e===`pine`?Ye:Xe,r=t[Math.floor(X(a,o,J+784)*t.length)];n.push({x:d,y:g,z:f,scale:[b,y,b],yaw:p,color:pe(r,m),kind:e})}else{let e=.019+.056999999999999995*Math.min(1,h/1.6);if(X(a,o,13140)>=e)continue;let t=$e[Math.floor(X(a,o,J+784)*$e.length)],r=.6+X(a,o,J+785)*.9,i=.6+X(a,o,J+786)*.9;n.push({x:d,y:g,z:f,scale:[i,r,i],yaw:p,color:pe(t,m),kind:`rock`})}}for(let r=0;r<8;r++)for(let i=0;i<8;i++){let a=e*8+i,o=t*8+r;if(X(a,o,13232)>=.14875)continue;let s=X(a,o,J+888),c=X(a,o,J+889),l=e*16+i*2+s*2,u=t*16+r*2+c*2;if(me(l,u,.4)||he(l,u,.36,.17))continue;let d=Q(l,u);if(d>2)continue;let f=d*13,p=X(a,o,J+890)*Math.PI*2,m=.8+X(a,o,J+891)*.4,h=Ze[Math.floor(X(a,o,J+892)*Ze.length)],g=.8+X(a,o,J+893)*.6;n.push({x:l,y:f,z:u,scale:[g,g,g],yaw:p,color:pe(h,m),kind:`grass`})}let r=16/3;for(let i=0;i<r;i++)for(let a=0;a<r;a++){let o=e*r+a,s=t*r+i;if(X(o,s,13342)>=.07875)continue;let c=X(o,s,J+998),l=X(o,s,J+999),u=e*16+a*3+c*3,d=t*16+i*3+l*3;if(me(u,d,.9)||he(u,d,.44,.34))continue;let f=Q(u,d);if(f>2)continue;let p=f*13,m=X(o,s,J+1e3)*Math.PI*2,h=.85+X(o,s,J+1001)*.3,g=Qe[Math.floor(X(o,s,J+1002)*Qe.length)],_=.9+X(o,s,J+1003)*.7;n.push({x:u,y:p,z:d,scale:[_,_,_],yaw:m,color:pe(g,h),kind:`bush`})}return n}function _e(){let e=[];for(let t of fe.values())e.push(...t);E.setDecor(e),window.__decorCount=e.length,window.__decorList=e}let ve=.5,ye=1,be=(e,t)=>e*.8+t*.2,O=new Set,xe=new Set,k=[],Se=null,Ce=null;function A(e,t,n=!1){let r=Math.floor(e/16),i=Math.floor(t/16);if(!n&&r===Se&&i===Ce)return;Se=r,Ce=i;let a=!1;for(let e=-3;e<=3;e++)for(let t=-3;t<=3;t++){let n=r+t,o=i+e,s=ue(n,o);O.has(s)||xe.has(s)||(xe.add(s),k.push({cx:n,cz:o,key:s}),a=!0)}let o=!1;for(let e of Array.from(O)){let[t,n]=e.split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>5&&(E.removeTerrainChunk(e),O.delete(e),fe.delete(e),o=!0)}for(let e of Array.from(xe)){let[t,n]=e.split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>5&&(xe.delete(e),a=!0)}a&&(k=k.filter(e=>xe.has(e.key)),k.sort((e,t)=>(e.cx-r)**2+(e.cz-i)**2-((t.cx-r)**2+(t.cz-i)**2))),window.__terrainChunkCount=O.size,o&&_e()}function we(e){let t=!1,n=0;for(;k.length&&!(n>0&&performance.now()+ve>e);){let{cx:e,cz:r,key:i}=k.shift();if(!xe.has(i))continue;xe.delete(i);let a=performance.now(),o=e*16,s=r*16,c=un(o,s,o+16,s+16,1);E.setTerrainChunk(i,c),O.add(i),de(e,r),fe.set(i,D(e,r)),t=!0,ve=be(ve,performance.now()-a),n++}return t&&(window.__terrainChunkCount=O.size,_e()),n}function Te(e,t){let n=ue(e,t);if(!O.has(n))return;let r=e*16,i=t*16;E.setTerrainChunk(n,un(r,i,r+16,i+16,1))}function Ee(e,t,n,r){let i=Math.floor(n/16),a=Math.floor(r/16),o=(i-3)*16,s=(i+3+1)*16,c=(a-3)*16,l=(a+3+1)*16,u=e*64,d=t*64;return u>=o&&u+64<=s&&d>=c&&d+64<=l}let j=new Set,M=new Set,N=[],Oe=null,ke=null;function Ae(e,t,n=!1){let r=Math.floor(e/64),i=Math.floor(t/64);if(!n&&r===Oe&&i===ke)return;Oe=r,ke=i;let a=!1;for(let n=-2;n<=2;n++)for(let o=-2;o<=2;o++){let s=r+o,c=i+n,l=`far:`+s+`,`+c;j.has(l)||M.has(l)||Ee(s,c,e,t)||(M.add(l),N.push({cx:s,cz:c,rkey:l}),a=!0)}for(let n of Array.from(j)){let[a,o]=n.slice(4).split(`,`).map(Number),s=Math.max(Math.abs(a-r),Math.abs(o-i))>3,c=Ee(a,o,e,t);(s||c)&&(E.removeTerrainChunk(n),j.delete(n))}for(let e of Array.from(M)){let[t,n]=e.slice(4).split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>3&&(M.delete(e),a=!0)}a&&(N=N.filter(e=>M.has(e.rkey)),N.sort((e,t)=>(e.cx-r)**2+(e.cz-i)**2-((t.cx-r)**2+(t.cz-i)**2))),window.__farChunkCount=j.size}function je(e,t){let n=0;for(;N.length&&!(!(n===0&&t)&&performance.now()+ye>e);){let{cx:e,cz:t,rkey:r}=N.shift();if(!M.has(r))continue;M.delete(r);let i=performance.now(),a=e*64,o=t*64,s=un(a,o,a+64,o+64,4,.35);E.setTerrainChunk(r,s),j.add(r),ye=be(ye,performance.now()-i),n++}window.__farChunkCount=j.size}let P=Sn(te,se,E.getShadowResources()),F=new Map;function I(e){let t=F.get(e);return t||(t=yn(e).then(e=>xn(te,e)),F.set(e,t)),t}let Me=new Set(Array.from(C,e=>h.get(e)));await Promise.allSettled(Array.from(Me,e=>I(e)));let L=new Map,Pe=0,R=0;for(let t of C){let n=p.x[t],r=p.y[t],i=Q(n,r)*13;_.set(t,i);let a=We(n,i,r,0,g.get(t)??5),o=h.get(t);try{let e=await I(o);L.set(t,P.createInstance(e,a)),Pe++}catch(t){R++,e.push(`модель: ошибка на ${o} — ${t instanceof Error?t.message:String(t)}`)}}e.push(`модели: загружено ${Pe}/${C.length}${R?`, ошибок: `+R:``}`),Rn(e),window.__ecsFound=C.length,window.__foundPositions=()=>C.map(e=>({x:p.x[e],z:p.y[e],scale:g.get(e)??5}));let Fe=o?o.x:r.x,Re=o?o.y:r.y,z={yaw:0,pitch:.55,dist:42,target:[Fe,Q(Fe,Re)*13+2,Re]},B=gn(T,z);A(z.target[0],z.target[2],!0),Ae(z.target[0],z.target[2],!0);let Ue=performance.now()+40;we(Ue),je(Ue,!0);let et=un(-Rt,-600,Rt,600,12,1.2);E.setTerrainChunk(`world-backdrop`,et),e.push(`рельеф: чанков ${O.size} (16×16) + дальних ${j.size} (64×64, шаг 4) + задник (шаг 12, весь мир), в очереди ещё ${k.length+N.length}`),Rn(e),window.__coverageCheck=(e,t)=>{for(let n of O){let[r,i]=n.split(`,`).map(Number),a=r*16,o=i*16;if(e>=a&&e<a+16&&t>=o&&t<o+16)return`near`}for(let n of j){let[r,i]=n.slice(4).split(`,`).map(Number),a=r*64,o=i*64;if(e>=a&&e<a+64&&t>=o&&t<o+64)return`far`}return null},Object.defineProperty(window,"cam",{value:{get tx(){return z.target[0]},set tx(e){z.target[0]=e,B.stopAuto()},get ty(){return z.target[1]},set ty(e){z.target[1]=e,B.stopAuto()},get tz(){return z.target[2]},set tz(e){z.target[2]=e,B.stopAuto()},get dist(){return z.dist},set dist(e){z.dist=e,B.stopAuto()},get pitch(){return z.pitch},set pitch(e){z.pitch=e,B.stopAuto()}}}),window.H=(e,t)=>Q(e,t)*13,window.__camState=()=>({yaw:z.yaw,pitch:z.pitch,dist:z.dist,target:[...z.target]}),window.__isAutoOrbiting=()=>B.isAutoOrbiting();let tt=document.getElementById(`coordX`),H=document.getElementById(`coordY`),nt=document.getElementById(`coordGo`),U=!1;for(let e of[tt,H])e.addEventListener(`input`,()=>{U=!0});function rt(){let e=parseFloat(tt.value),t=parseFloat(H.value);!isFinite(e)||!isFinite(t)||(z.target[0]=Math.max(-Rt,Math.min(Rt,e)),z.target[2]=Math.max(-600,Math.min(600,t)),z.target[1]=Q(z.target[0],z.target[2])*13+2,B.stopAuto(),U=!1)}nt.addEventListener(`click`,rt);for(let e of[tt,H])e.addEventListener(`keydown`,t=>{t.key===`Enter`&&(t.preventDefault(),rt(),e.blur())});let it=new Float32Array(16),W=[0,0,0],at=document.getElementById(`selected`),ot=3.2,st=2.6,ct=e=>e.scout?st:ot,lt=e=>Q(e.x,e.y)*13+ct(e),ut=e=>Q(e.x,e.y)*13+ct(e)*.5,dt=[1,.86,.42],ft=1500,pt=null,mt=null,ht=[.35,.85,.45],gt=null,_t=null,G=null;window.startFollowMarch=e=>{B.stopAuto(),G=e},B.onInteract(()=>{G=null});function vt(e){_t=null,gt=e;let t=(v.get(e)??`?`)+` · `+(y.get(e)??`?`);window.__markerActive=!0,window.__selectedLabel=t,at.textContent=t,at.style.display=`block`}function yt(){gt=null,window.__markerActive=!1,window.__selectedLabel=null,at.style.display=`none`}function bt(e,t){let n=T.width/Math.max(1,T.height),r=Math.tan(K/2),i=e/T.width*2-1,a=1-t/T.height*2,o=V(ze(W,z.target)),s=V(Be([0,1,0],o)),c=Be(o,s),l=V([i*n*r*s[0]+a*r*c[0]-o[0],i*n*r*s[1]+a*r*c[1]-o[1],i*n*r*s[2]+a*r*c[2]-o[2]]);return{origin:W,dir:l}}let K=.72;function xt(e,t){let n=0;for(let r=2;r<=400;r+=2){let i=e[0]+t[0]*r;if(e[1]+t[1]*r-Q(i,e[2]+t[2]*r)*13<=0){let i=n,a=r;for(let n=0;n<12;n++){let n=(i+a)/2,r=e[0]+t[0]*n,o=e[2]+t[2]*n;e[1]+t[1]*n-Q(r,o)*13>0?i=n:a=n}return{t:a,x:e[0]+t[0]*a,z:e[2]+t[2]*a}}n=r}return null}function St(e,t){try{let n=window.parent;n&&n!==window&&typeof n.renderCartoucheFor==`function`&&n.renderCartoucheFor(e,t)}catch{}}function Ct(e){try{let t=window.parent;t&&t!==window&&typeof t.renderMarchCartoucheFor==`function`&&t.renderMarchCartoucheFor(e)}catch{}}function wt(e){let t=qe(it,e);return t.w<=.001?null:{sx:(t.x/t.w*.5+.5)*T.width,sy:(1-(t.y/t.w*.5+.5))*T.height,w:t.w}}function Tt(e,t){let n=.5*T.height/Math.tan(K/2),r=null,i=1/0;for(let a of C){let o=p.x[a],s=p.y[a],c=g.get(a)??5,l=[o,(_.get(a)??Q(o,s)*13)+c*.5,s],u=wt(l);if(!u)continue;let d=Math.max(26,n*c/u.w),f=e-u.sx,m=t-u.sy,h=f*f+m*m;h>d*d||h>=i||(i=h,r={kind:`entity`,eid:a,distToCam:Math.hypot(o-W[0],l[1]-W[1],s-W[2])})}for(let a of q){let o=[a.x,ut(a),a.y],s=wt(o);if(!s)continue;let c=Math.max(3,ct(a)*.5),l=Math.max(26,n*c/s.w),u=e-s.sx,d=t-s.sy,f=u*u+d*d;f>l*l||f>=i||(i=f,r={kind:`march`,march:a,distToCam:Math.hypot(a.x-W[0],o[1]-W[1],a.y-W[2])})}let{origin:a,dir:o}=bt(e,t),s=xt(a,o);return r&&!(s!==null&&s.t+5<r.distToCam)?r.kind===`entity`?{kind:`entity`,eid:r.eid,t:r.distToCam}:{kind:`march`,march:r.march,t:r.distToCam}:s===null?null:{kind:`ground`,x:s.x,z:s.z,t:s.t}}B.onTap((e,t)=>{let n=T.getBoundingClientRect(),r=Tt((e-n.left)*(T.width/n.width),(t-n.top)*(T.height/n.height));if(r?.kind===`entity`){vt(r.eid);let e=x.get(r.eid);e&&St(e.x,e.y);return}if(r?.kind===`march`){yt(),_t=r.march.id,window.__selectedMarchId=r.march.id,Ct(r.march.id);return}yt(),_t=null,r?.kind===`ground`&&St(Math.floor(r.x),Math.floor(r.z))});function Et(e,t){let n=T.getBoundingClientRect();return[(e-n.left)*(T.width/n.width),(t-n.top)*(T.height/n.height)]}function Dt(e,t){let[n,r]=Et(e,t),i=Tt(n,r);if(!i)return null;if(i.kind===`ground`)return{x:i.x,z:i.z};if(i.kind===`entity`){let e=x.get(i.eid);if(e)return{x:e.x+.5,z:e.y+.5}}return i.kind===`march`?{x:i.march.x,z:i.march.y}:null}function Ot(e,t){let n=Dt(e,t);if(!n){mt=null;return}mt={x:n.x,y:Q(n.x,n.z)*13+3,z:n.z,color:ht}}B.onGrab((e,t)=>{let[n,r]=Et(e,t),i=Tt(n,r);return i?.kind!==`march`||!i.march.own?!1:(pt=i.march.id,Ot(e,t),!0)},(e,t)=>{pt!==null&&Ot(e,t)},(e,t)=>{let n=pt;if(pt=null,mt=null,n===null||!isFinite(e)||!isFinite(t))return;let r=Dt(e,t);if(r)try{let e=window.parent;e&&e!==window&&typeof e.redirectMarchTo==`function`&&e.redirectMarchTo(n,Math.floor(r.x),Math.floor(r.z))}catch{}});let kt=!1,At=0;async function jt(){let e=An(z.target[0],z.target[2],192);if(!e)return;let t=new Set,n=[],r=new Set;for(let i of e){t.add(i.key);let e=S.get(i.key);if(e!==void 0){if(v.set(e,i.nm),y.set(e,i.lv),b.set(e,!!i.own),gt===e&&vt(e),h.get(e)!==i.model){h.set(e,i.model),g.set(e,i.scale);let t=p.x[e],r=p.y[e],a=Q(t,r)*13;_.set(e,a);let o=We(t,a,r,0,i.scale);n.push(I(i.model).then(t=>{P.destroyInstance(L.get(e)),L.set(e,P.createInstance(t,o))}).catch(()=>{}))}continue}let a=ee(i),o=Q(i.x,i.y)*13;_.set(a,o);let s=We(i.x,o,i.y,0,i.scale);n.push(I(i.model).then(e=>{P.destroyInstance(L.get(a)),L.set(a,P.createInstance(e,s))}).catch(()=>{})),r.add(ue(Math.floor(i.x/16),Math.floor(i.y/16))),Te(Math.floor(i.x/16),Math.floor(i.y/16))}for(let[e,n]of Array.from(S))t.has(e)||(r.add(ue(Math.floor(p.x[n]/16),Math.floor(p.y[n]/16))),Le(f,n),P.destroyInstance(L.get(n)),L.delete(n),h.delete(n),g.delete(n),_.delete(n),v.delete(n),y.delete(n),b.delete(n),x.delete(n),S.delete(e),gt===n&&yt());await Promise.allSettled(n),C=Array.from(De(f,[p,m]));let i=!1;for(let e of r){if(!O.has(e))continue;let[t,n]=e.split(`,`).map(Number);fe.set(e,D(t,n)),i=!0}i&&_e(),At++,window.__ecsFound=C.length,window.__syncCount=At}l&&setInterval(()=>{le()||kt||(kt=!0,jt().catch(e=>console.error(`live sync:`,e)).finally(()=>{kt=!1}))},3e3);let q=[];function Mt(){if(!l){q=[];return}q=Fn()||[],window.__marchPositions=q}let Nt=new Set([`human`,`dwarf`,`elf`,`undead`]),Ft=[.62,1.14,.72,.32],It=[1.22,.55,.5,.32];function Lt(e){let t=Nt.has(e.race)?e.race:`human`;return e.scout?`/models/marches/scout-${t}.glb`:e.hasGen?`/models/marches/gen-${t}-${+(e.genId===1)}.glb`:`/models/marches/army-${t}.glb`}let Y=new Map;function Bt(){for(let e of q){let t=Lt(e),n=Y.get(e.id);if(n&&n.path!==t&&(P.destroyInstance(n.inst??void 0),Y.delete(e.id),n=void 0),!n){n={path:t,inst:null,yaw:Number.isFinite(e.yaw)?e.yaw:0},Y.set(e.id,n);let r=n,i=e.id;I(t).then(e=>{Y.get(i)===r&&(r.inst=P.createInstance(e,We(0,-1e6,0,0,1),Ft))},()=>{})}if(Number.isFinite(e.yaw)&&(n.yaw=e.yaw),n.inst){let t=e.scout?st:ot;P.updateInstance(n.inst,We(e.x,Q(e.x,e.y)*13,e.y,n.yaw,t),e.own?Ft:It)}}if(Y.size>q.length){let e=new Set(q.map(e=>e.id));for(let[t,n]of Y)e.has(t)||(P.destroyInstance(n.inst??void 0),Y.delete(t))}}let Vt=document.getElementById(`labels`),Ht=new Map,Ut=Ge(),Gt=1024;function Kt(){let e=new Set,t=T.clientWidth,n=T.clientHeight;for(let r of C){let i=p.x[r],a=p.y[r],o=i-z.target[0],s=a-z.target[2];if(o*o+s*s>Gt)continue;let c=(_.get(r)??Q(i,a)*13)+(g.get(r)??5)*.6+1.1,l=Ke(it,i,c,a,Ut);if(l.w<=.001)continue;let u=(l.x/l.w*.5+.5)*t,d=(1-(l.y/l.w*.5+.5))*n;if(u<-40||u>t+40||d<-40||d>n+40)continue;e.add(r);let f=Ht.get(r);if(!f){let e=document.createElement(`div`);e.className=`wlabel`;let t=document.createElement(`div`);t.className=`nm`;let n=document.createElement(`div`);n.className=`lv`,e.appendChild(t),e.appendChild(n),Vt.appendChild(e),f={root:e,nm:t,lv:n,lastNm:``,lastLv:``,lastMine:!1},Ht.set(r,f)}let m=v.get(r)??`?`;f.lastNm!==m&&(f.nm.textContent=m,f.lastNm=m);let h=!!b.get(r);f.lastMine!==h&&(f.nm.classList.toggle(`mine`,h),f.lastMine=h);let x=y.get(r)??``;f.lastLv!==x&&(f.lv.textContent=x,f.lastLv=x),f.root.style.transform=`translate(${u.toFixed(1)}px,${d.toFixed(1)}px) translate(-50%,-100%)`}for(let[t,n]of Ht)e.has(t)||(n.root.remove(),Ht.delete(t))}let Z=new Map;function qt(e,t,n,r){if(!r||!n||r<=n)return t;let i=Math.max(0,Math.min(1,(Date.now()-n)/(r-n)));return e+(t-e)*i}function Jt(){let e=new Set,t=T.clientWidth,n=T.clientHeight;for(let r of q){let i=r.battle;if(!i)continue;let a=r.x-z.target[0],o=r.y-z.target[2];if(a*a+o*o>Gt)continue;let s=lt(r)+1.6,c=qe(it,[r.x,s,r.y]);if(c.w<=.001)continue;let l=(c.x/c.w*.5+.5)*t,u=(1-(c.y/c.w*.5+.5))*n;if(l<-60||l>t+60||u<-60||u>n+60)continue;e.add(r.id);let d=Z.get(r.id);if(!d){let e=document.createElement(`div`);e.className=`blabel`;let t=document.createElement(`div`);t.className=`btitle`;let n=document.createElement(`div`);n.className=`bbar atk`;let i=document.createElement(`i`);n.appendChild(i);let a=document.createElement(`div`);a.className=`bbar def`;let o=document.createElement(`i`);a.appendChild(o),e.appendChild(t),e.appendChild(n),e.appendChild(a),Vt.appendChild(e),d={root:e,title:t,atkFill:i,defFill:o},Z.set(r.id,d)}let f=i.retreating,p=!f&&i.revealFromRound===0,m=i.demolish;d.root.className=`blabel`+(f?` retreat`:p?` deploy`:m?` demolish`:``),d.title.textContent=f?`Отступление`:p?`Развёртывание`:m?m.name?`Таранят: `+m.name:`Город разбирают`:`Бой — раунд `+i.round;let h=Math.max(0,Math.min(100,qt(i.revealFromAttHp,i.attHpLeft,i.revealStart,i.revealAt)/Math.max(1,i.attStartHp)*100)),g=m?Math.max(0,Math.min(100,qt(m.sameTarget?m.revealFromHp:m.hp,m.hp,i.revealStart,i.revealAt)/Math.max(1,m.max)*100)):Math.max(0,Math.min(100,qt(i.revealFromDefHp,i.defHpLeft,i.revealStart,i.revealAt)/Math.max(1,i.defStartHp)*100));d.atkFill.style.width=h.toFixed(1)+`%`,d.defFill.style.width=g.toFixed(1)+`%`,d.root.style.transform=`translate(${l.toFixed(1)}px,${u.toFixed(1)}px) translate(-50%,-100%)`}for(let[t,n]of Z)e.has(t)||(n.root.remove(),Z.delete(t))}let Yt=Ge();function Xt(e,t,n,r,i){let a=p.x[e],o=p.y[e],s=g.get(e)??5,c=(_.get(e)??0)+s*.6,l=a-W[0],u=c-W[1],d=o-W[2],f=l*l+u*u+d*d;if(f<3600)return!0;if(f>16900)return!1;let m=Ke(t,a,c,o,Yt);if(m.w<=.001)return!1;let h=(m.x/m.w*.5+.5)*n,v=(1-(m.y/m.w*.5+.5))*r,y=i*s/m.w+24;return h>-y&&h<n+y&&v>-y&&v<r+y}let $={frame:0,chunks:0,render:0,labels:0,maxFrame:0,maxChunks:0,maxRender:0,maxLabels:0,n:0,worstFrame:0,worstChunks:0,worstRender:0,worstLabels:0};function en(){$.maxFrame=Math.max($.maxFrame,$.frame),$.maxChunks=Math.max($.maxChunks,$.chunks),$.maxRender=Math.max($.maxRender,$.render),$.maxLabels=Math.max($.maxLabels,$.labels),++$.n>=60&&($.worstFrame=$.maxFrame,$.worstChunks=$.maxChunks,$.worstRender=$.maxRender,$.worstLabels=$.maxLabels,$.maxFrame=$.maxChunks=$.maxRender=$.maxLabels=0,$.n=0,Rn([`кадр (худший из 60): ${$.worstFrame.toFixed(1)} мс`,`  стройка чанков: ${$.worstChunks.toFixed(1)} мс`,`  отрисовка:      ${$.worstRender.toFixed(1)} мс`,`  подписи:        ${$.worstLabels.toFixed(1)} мс`,`чанков ${window.__terrainChunkCount??0} · моделей в кадре ${window.__modelDrawCount??0} · сущностей ${window.__ecsFound??C.length} · декора ${window.__decorCount??0}`,`в очереди на стройку: ${k.length} ближних`])),window.__perf=$}let tn=!1;function nn(e){let t=Ln?performance.now():0;try{rn(e)}catch(e){console.error(`draw:`,e),tn||(tn=!0,ne(`Сбой в кадре: ${e instanceof Error?e.message:String(e)}`))}Ln&&($.frame=performance.now()-t,en()),requestAnimationFrame(nn)}function rn(e){if(le())return;B.isAutoOrbiting()&&(z.yaw=e*15e-5),B.update(e),Mt();let t=[];if(G!==null){let e=q.find(e=>e.id===G);e?(z.target[0]=e.x,z.target[2]=e.y,z.target[1]=Q(e.x,e.y)*13+1):G=null}U||(tt.value=z.target[0].toFixed(1),H.value=z.target[2].toFixed(1)),A(z.target[0],z.target[2]),Ae(z.target[0],z.target[2]);let n=performance.now(),r=n+3;je(r,we(r)===0),Ln&&($.chunks=performance.now()-n);let o=[z.target[0]+Math.sin(z.yaw)*Math.cos(z.pitch)*z.dist,z.target[1]+Math.sin(z.pitch)*z.dist,z.target[2]+Math.cos(z.yaw)*Math.cos(z.pitch)*z.dist],s=Q(o[0],o[2])*13+2;o[1]<s&&(o[1]=s);let c=T.width/Math.max(1,T.height),l=Ve(He(K,c,.5,392),Je(o,z.target,[0,1,0]));it=l,W=o,E.setVP(l),E.setFog(o,i,a,e/1e3),E.setSunTarget(z.target[0],z.target[2]);{let t=V(ze(o,z.target)),n=V(Be([0,1,0],t)),r=Be(t,n);E.setSkyCamera(n,r,t,Math.tan(K/2),c,e/1e3)}P.setFog(o,i,a),P.setVP(l),_t!==null&&!q.some(e=>e.id===_t)&&(_t=null),mt&&t.push(mt),E.setMarkers(t),Bt(),window.__marchCount=q.length;let u=T.clientWidth,d=T.clientHeight,f=.5*d/Math.tan(K/2),p=0,m=Ln?performance.now():0,h=gt===null?_t===null?null:Y.get(_t)?.inst??null:L.get(gt)??null;if(h){let t=.5-.5*Math.cos(e%ft/ft*Math.PI*2);P.setOutlineStyle(dt,.003+.0017999999999999995*t)}E.frame({r:i[0],g:i[1],b:i[2],a:1},e=>{P.beginModels(e);for(let t of C){if(!Xt(t,l,u,d,f))continue;let n=L.get(t);n&&(P.draw(e,n),p++)}for(let t of Y.values())t.inst&&(P.draw(e,t.inst),p++);h&&(P.beginOutlines(e),P.drawOutline(e,h))}),window.__modelDrawCount=p,Ln&&($.render=performance.now()-m);let g=Ln?performance.now():0;Kt(),Jt(),Ln&&($.labels=performance.now()-g)}requestAnimationFrame(nn),window.__engineReady=!0}Bn().catch(e=>{zn([`Ошибка: ${e instanceof Error?e.message:String(e)}`]),console.error(e)});