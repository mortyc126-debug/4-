...
---
`:``)+e}te.addEventListener(`uncapturederror`,e=>{let t=e.error.message;console.error(`WebGPU error:`,t),ne(t)});let re=`fb-gpu-reload-at`,ie=Number(sessionStorage.getItem(re)||0),ae=ie&&Date.now()-ie<6e4;te.lost.then(e=>{if(console.error(`WebGPU device lost:`,e.reason,e.message),e.reason!==`destroyed`){if(ae){ne(`WebGPU-устройство теряется повторно (${e.reason}) — похоже, объёмная карта нестабильна на этом устройстве/браузере. Карта города ниже работает независимо от WebGPU.`);try{window.parent&&window.parent!==window&&typeof window.parent.forceCityView==`function`&&window.parent.forceCityView()}catch{}return}ne(`WebGPU-устройство потеряно (${e.reason}): ${e.message}\nПерезагрузка через 2с...`),sessionStorage.setItem(re,String(Date.now())),setTimeout(()=>location.reload(),2e3)}});let T=document.getElementById(`gpu`),oe=T.getContext(`webgpu`);if(!oe){t(`WebGPU: getContext('webgpu') вернул null.`);return}let se=navigator.gpu.getPreferredCanvasFormat();function ce(){let e=T.clientWidth,t=T.clientHeight;if(e<=0||t<=0)return;let n=Math.min(2,window.devicePixelRatio||1),r=Math.max(1,Math.floor(e*n)),i=Math.max(1,Math.floor(t*n));T.width!==r&&(T.width=r),T.height!==i&&(T.height=i)}let le=()=>T.offsetParent===null&&T.clientWidth===0;ce(),new ResizeObserver(ce).observe(T),oe.configure({device:te,format:se,alphaMode:`opaque`}),e.push(`WebGPU: устройство получено, формат — ${se}`);let E=await Et(te,oe,se);function D(e,t){return e+`,`+t}function O(e,t){try{let n=window.parent;n&&n!==window&&typeof n.ensureWorldChunk==`function`&&n.ensureWorldChunk(e,t)}catch{}}let ue=new Map;function k(e,t){return[e[0]*t,e[1]*t,e[2]*t]}function de(e,t,n){if(Kt(e,t))return!0;for(let r=0;r<8;r++){let i=r/8*Math.PI*2;if(Kt(e+Math.cos(i)*n,t+Math.sin(i)*n))return!0}return!1}function fe(e,t,n,r){for(let i of C){let a=p.x[i]-e,o=p.y[i]-t,s=(g.get(i)??5)*n+r;if(a*a+o*o<s*s)return!0}return!1}function pe(e,t){return e>1.36?t<.62?`spruce`:t<.94?`pine`:`dead`:t<.58?`broadleaf`:t<.8?`birch`:t<.94?`spruce`:`dead`}function A(e,t){let n=[];for(let r=0;r<4;r++)for(let i=0;i<4;i++){let a=e*4+i,o=t*4+r;if(Q(a,o,13122)>=.65)continue;let s=.175+Q(a,o,Z+778)*.65,c=.175+Q(a,o,Z+779)*.65,l=e*16+i*4+s*4,u=t*16+r*4+c*4,d=l+(Mt(l/8.5,u/8.5,Z+790)*2-1)*2,f=u+(Mt(l/8.5,u/8.5,Z+791)*2-1)*2;if(de(d,f,1.5)||fe(d,f,.54,.68))continue;let p=Q(a,o,Z+781)*Math.PI*2,m=.85+Q(a,o,Z+782)*.3,h=$(d,f),g=h*13,_=.0315+.5355*Jt(d,f),v=Q(a,o,Z+780)<_,y=1+Q(a,o,Z+785)*1.3,b=.8+Q(a,o,Z+786)*.5;if(v){let e=pe(h,Q(a,o,Z+780));e===`broadleaf`&&Q(a,o,13132)<.35&&(e=`autumn`);let t=e===`spruce`||e===`pine`?Ue:We,r=t[Math.floor(Q(a,o,Z+784)*t.length)];n.push({x:d,y:g,z:f,scale:[b,y,b],yaw:p,color:k(r,m),kind:e})}else{let e=.019+.056999999999999995*Math.min(1,h/1.6);if(Q(a,o,13140)>=e)continue;let t=qe[Math.floor(Q(a,o,Z+784)*qe.length)],r=.6+Q(a,o,Z+785)*.9,i=.6+Q(a,o,Z+786)*.9;n.push({x:d,y:g,z:f,scale:[i,r,i],yaw:p,color:k(t,m),kind:`rock`})}}for(let r=0;r<8;r++)for(let i=0;i<8;i++){let a=e*8+i,o=t*8+r;if(Q(a,o,13232)>=.14875)continue;let s=Q(a,o,Z+888),c=Q(a,o,Z+889),l=e*16+i*2+s*2,u=t*16+r*2+c*2;if(de(l,u,.4)||fe(l,u,.36,.17))continue;let d=$(l,u);if(d>2)continue;let f=d*13,p=Q(a,o,Z+890)*Math.PI*2,m=.8+Q(a,o,Z+891)*.4,h=Ge[Math.floor(Q(a,o,Z+892)*Ge.length)],g=.8+Q(a,o,Z+893)*.6;n.push({x:l,y:f,z:u,scale:[g,g,g],yaw:p,color:k(h,m),kind:`grass`})}let r=16/3;for(let i=0;i<r;i++)for(let a=0;a<r;a++){let o=e*r+a,s=t*r+i;if(Q(o,s,13342)>=.07875)continue;let c=Q(o,s,Z+998),l=Q(o,s,Z+999),u=e*16+a*3+c*3,d=t*16+i*3+l*3;if(de(u,d,.9)||fe(u,d,.44,.34))continue;let f=$(u,d);if(f>2)continue;let p=f*13,m=Q(o,s,Z+1e3)*Math.PI*2,h=.85+Q(o,s,Z+1001)*.3,g=Ke[Math.floor(Q(o,s,Z+1002)*Ke.length)],_=.9+Q(o,s,Z+1003)*.7;n.push({x:u,y:p,z:d,scale:[_,_,_],yaw:m,color:k(g,h),kind:`bush`})}return n}function me(){let e=[];for(let t of ue.values())e.push(...t);E.setDecor(e),window.__decorCount=e.length,window.__decorList=e}let j=new Set,M=new Set,N=[],he=null,ge=null;function P(e,t,n=!1){let r=Math.floor(e/16),i=Math.floor(t/16);if(!n&&r===he&&i===ge)return;he=r,ge=i;let a=!1;for(let e=-3;e<=3;e++)for(let t=-3;t<=3;t++){let n=r+t,o=i+e,s=D(n,o);j.has(s)||M.has(s)||(M.add(s),N.push({cx:n,cz:o,key:s}),a=!0)}let o=!1;for(let e of Array.from(j)){let[t,n]=e.split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>5&&(E.removeTerrainChunk(e),j.delete(e),ue.delete(e),o=!0)}for(let e of Array.from(M)){let[t,n]=e.split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>5&&(M.delete(e),a=!0)}a&&(N=N.filter(e=>M.has(e.key)),N.sort((e,t)=>(e.cx-r)**2+(e.cz-i)**2-((t.cx-r)**2+(t.cz-i)**2))),window.__terrainChunkCount=j.size,o&&me()}function _e(e){let t=!1;for(;N.length&&performance.now()<e;){let{cx:e,cz:n,key:r}=N.shift();if(!M.has(r))continue;M.delete(r);let i=e*16,a=n*16,o=an(i,a,i+16,a+16,1);E.setTerrainChunk(r,o),j.add(r),O(e,n),ue.set(r,A(e,n)),t=!0}t&&(window.__terrainChunkCount=j.size,me())}function ve(e,t){let n=D(e,t);if(!j.has(n))return;let r=e*16,i=t*16;E.setTerrainChunk(n,an(r,i,r+16,i+16,1))}function ye(e,t,n,r){let i=Math.floor(n/16),a=Math.floor(r/16),o=(i-3)*16,s=(i+3+1)*16,c=(a-3)*16,l=(a+3+1)*16,u=e*64,d=t*64;return u>=o&&u+64<=s&&d>=c&&d+64<=l}let F=new Set,I=new Set,L=[],be=null,R=null;function z(e,t,n=!1){let r=Math.floor(e/64),i=Math.floor(t/64);if(!n&&r===be&&i===R)return;be=r,R=i;let a=!1;for(let n=-2;n<=2;n++)for(let o=-2;o<=2;o++){let s=r+o,c=i+n,l=`far:`+s+`,`+c;F.has(l)||I.has(l)||ye(s,c,e,t)||(I.add(l),L.push({cx:s,cz:c,rkey:l}),a=!0)}for(let n of Array.from(F)){let[a,o]=n.slice(4).split(`,`).map(Number),s=Math.max(Math.abs(a-r),Math.abs(o-i))>3,c=ye(a,o,e,t);(s||c)&&(E.removeTerrainChunk(n),F.delete(n))}for(let e of Array.from(I)){let[t,n]=e.slice(4).split(`,`).map(Number);Math.max(Math.abs(t-r),Math.abs(n-i))>3&&(I.delete(e),a=!0)}a&&(L=L.filter(e=>I.has(e.rkey)),L.sort((e,t)=>(e.cx-r)**2+(e.cz-i)**2-((t.cx-r)**2+(t.cz-i)**2))),window.__farChunkCount=F.size}function Se(e){for(;L.length&&performance.now()<e;){let{cx:e,cz:t,rkey:n}=L.shift();if(!I.has(n))continue;I.delete(n);let r=e*64,i=t*64,a=an(r,i,r+64,i+64,4,.35);E.setTerrainChunk(n,a),F.add(n)}window.__farChunkCount=F.size}let B=vn(te,se,E.getShadowResources()),Ce=new Map;function we(e){let t=Ce.get(e);return t||(t=hn(e).then(e=>_n(te,e)),Ce.set(e,t)),t}let Te=new Set(Array.from(C,e=>h.get(e)));await Promise.allSettled(Array.from(Te,e=>we(e)));let V=new Map,H=0,Ee=0;for(let t of C){let n=p.x[t],r=p.y[t],i=$(n,r)*13;_.set(t,i);let a=Be(n,i,r,0,g.get(t)??5),o=h.get(t);try{let e=await we(o);V.set(t,B.createInstance(e,a)),H++}catch(t){Ee++,e.push(`модель: ошибка на ${o} — ${t instanceof Error?t.message:String(t)}`)}}e.push(`модели: загружено ${H}/${C.length}${Ee?`, ошибок: `+Ee:``}`),Mn(e),window.__ecsFound=C.length,window.__foundPositions=()=>C.map(e=>({x:p.x[e],z:p.y[e],scale:g.get(e)??5}));let De=o?o.x:r.x,ke=o?o.y:r.y,U={yaw:0,pitch:.55,dist:42,target:[De,$(De,ke)*13+2,ke]},W=fn(T,U);P(U.target[0],U.target[2],!0),z(U.target[0],U.target[2],!0);let Me=performance.now()+40;_e(Me),Se(Me);let Ne=an(-At,-600,At,600,12,1.2);E.setTerrainChunk(`world-backdrop`,Ne),e.push(`рельеф: чанков ${j.size} (16×16) + дальних ${F.size} (64×64, шаг 4) + задник (шаг 12, весь мир), в очереди ещё ${N.length+L.length}`),Mn(e),window.__coverageCheck=(e,t)=>{for(let n of j){let[r,i]=n.split(`,`).map(Number),a=r*16,o=i*16;if(e>=a&&e<a+16&&t>=o&&t<o+16)return`near`}for(let n of F){let[r,i]=n.slice(4).split(`,`).map(Number),a=r*64,o=i*64;if(e>=a&&e<a+64&&t>=o&&t<o+64)return`far`}return null},Object.defineProperty(window,"cam",{value:{get tx(){return U.target[0]},set tx(e){U.target[0]=e,W.stopAuto()},get ty(){return U.target[1]},set ty(e){U.target[1]=e,W.stopAuto()},get tz(){return U.target[2]},set tz(e){U.target[2]=e,W.stopAuto()},get dist(){return U.dist},set dist(e){U.dist=e,W.stopAuto()},get pitch(){return U.pitch},set pitch(e){U.pitch=e,W.stopAuto()}}}),window.H=(e,t)=>$(e,t)*13,window.__camState=()=>({yaw:U.yaw,pitch:U.pitch,dist:U.dist,target:[...U.target]}),window.__isAutoOrbiting=()=>W.isAutoOrbiting();let Fe=document.getElementById(`coordX`),ze=document.getElementById(`coordY`),Je=document.getElementById(`coordGo`),Ye=!1;for(let e of[Fe,ze])e.addEventListener(`input`,()=>{Ye=!0});function K(){let e=parseFloat(Fe.value),t=parseFloat(ze.value);!isFinite(e)||!isFinite(t)||(U.target[0]=Math.max(-At,Math.min(At,e)),U.target[2]=Math.max(-600,Math.min(600,t)),U.target[1]=$(U.target[0],U.target[2])*13+2,W.stopAuto(),Ye=!1)}Je.addEventListener(`click`,K);for(let e of[Fe,ze])e.addEventListener(`keydown`,t=>{t.key===`Enter`&&(t.preventDefault(),K(),e.blur())});let q=new Float32Array(16),J=[0,0,0],Xe=document.getElementById(`selected`),Ze=[.95,.78,.35],Qe=[.42,.78,.46],$e=[.82,.24,.26],Y=null,et=null,tt=null,nt=null;window.startFollowMarch=e=>{W.stopAuto(),nt=e},W.onInteract(()=>{nt=null});function rt(e){tt=null,et=e;let t=(v.get(e)??`?`)+` · `+(y.get(e)??`?`),n=p.x[e],r=p.y[e];Y={x:n,y:$(n,r)*13+(g.get(e)??5)*.9+2,z:r,color:Ze},window.__markerActive=!0,window.__selectedLabel=t,Xe.textContent=t,Xe.style.display=`block`}function it(){et=null,Y=null,window.__markerActive=!1,window.__selectedLabel=null,Xe.style.display=`none`}function at(e,t){let n=T.width/Math.max(1,T.height),r=Math.tan(ot/2),i=e/T.width*2-1,a=1-t/T.height*2,o=G(Pe(J,U.target)),s=G(Ie([0,1,0],o)),c=Ie(o,s),l=G([i*n*r*s[0]+a*r*c[0]-o[0],i*n*r*s[1]+a*r*c[1]-o[1],i*n*r*s[2]+a*r*c[2]-o[2]]);return{origin:J,dir:l}}let ot=.72;function st(e,t){let n=0;for(let r=2;r<=400;r+=2){let i=e[0]+t[0]*r;if(e[1]+t[1]*r-$(i,e[2]+t[2]*r)*13<=0){let i=n,a=r;for(let n=0;n<12;n++){let n=(i+a)/2,r=e[0]+t[0]*n,o=e[2]+t[2]*n;e[1]+t[1]*n-$(r,o)*13>0?i=n:a=n}return{t:a,x:e[0]+t[0]*a,z:e[2]+t[2]*a}}n=r}return null}function ct(e,t){try{let n=window.parent;n&&n!==window&&typeof n.renderCartoucheFor==`function`&&n.renderCartoucheFor(e,t)}catch{}}function X(e){try{let t=window.parent;t&&t!==window&&typeof t.renderMarchCartoucheFor==`function`&&t.renderMarchCartoucheFor(e)}catch{}}function lt(e){let t=Ve(q,e);return t.w<=.001?null:{sx:(t.x/t.w*.5+.5)*T.width,sy:(1-(t.y/t.w*.5+.5))*T.height,w:t.w}}function ut(e,t){let n=.5*T.height/Math.tan(ot/2),r=null,i=1/0;for(let a of C){let o=p.x[a],s=p.y[a],c=g.get(a)??5,l=[o,(_.get(a)??$(o,s)*13)+c*.5,s],u=lt(l);if(!u)continue;let d=Math.max(26,n*c/u.w),f=e-u.sx,m=t-u.sy,h=f*f+m*m;h>d*d||h>=i||(i=h,r={kind:`entity`,eid:a,distToCam:Math.hypot(o-J[0],l[1]-J[1],s-J[2])})}for(let a of pt){let o=[a.x,$(a.x,a.y)*13+2.2,a.y],s=lt(o);if(!s)continue;let c=Math.max(26,n*3/s.w),l=e-s.sx,u=t-s.sy,d=l*l+u*u;d>c*c||d>=i||(i=d,r={kind:`march`,march:a,distToCam:Math.hypot(a.x-J[0],o[1]-J[1],a.y-J[2])})}let{origin:a,dir:o}=at(e,t),s=st(a,o);return r&&!(s!==null&&s.t+5<r.distToCam)?r.kind===`entity`?{kind:`entity`,eid:r.eid,t:r.distToCam}:{kind:`march`,march:r.march,t:r.distToCam}:s===null?null:{kind:`ground`,x:s.x,z:s.z,t:s.t}}W.onTap((e,t)=>{let n=T.getBoundingClientRect(),r=ut((e-n.left)*(T.width/n.width),(t-n.top)*(T.height/n.height));if(r?.kind===`entity`){rt(r.eid);let e=x.get(r.eid);e&&ct(e.x,e.y);return}if(r?.kind===`march`){it(),tt=r.march.id,window.__selectedMarchId=r.march.id,X(r.march.id);return}it(),tt=null,r?.kind===`ground`&&ct(Math.floor(r.x),Math.floor(r.z))});let dt=0;async function ft(){let e=Tn(U.target[0],U.target[2],192);if(!e)return;let t=new Set,n=[],r=new Set;for(let i of e){t.add(i.key);let e=S.get(i.key);if(e!==void 0){if(v.set(e,i.nm),y.set(e,i.lv),b.set(e,!!i.own),et===e&&rt(e),h.get(e)!==i.model){h.set(e,i.model),g.set(e,i.scale);let t=p.x[e],r=p.y[e],a=$(t,r)*13;_.set(e,a);let o=Be(t,a,r,0,i.scale);n.push(we(i.model).then(t=>void V.set(e,B.createInstance(t,o))).catch(()=>{}))}continue}let a=ee(i),o=$(i.x,i.y)*13;_.set(a,o);let s=Be(i.x,o,i.y,0,i.scale);n.push(we(i.model).then(e=>void V.set(a,B.createInstance(e,s))).catch(()=>{})),r.add(D(Math.floor(i.x/16),Math.floor(i.y/16))),ve(Math.floor(i.x/16),Math.floor(i.y/16))}for(let[e,n]of Array.from(S))t.has(e)||(r.add(D(Math.floor(p.x[n]/16),Math.floor(p.y[n]/16))),je(f,n),V.delete(n),h.delete(n),g.delete(n),_.delete(n),v.delete(n),y.delete(n),b.delete(n),x.delete(n),S.delete(e),et===n&&it());await Promise.allSettled(n),C=Array.from(xe(f,[p,m]));let i=!1;for(let e of r){if(!j.has(e))continue;let[t,n]=e.split(`,`).map(Number);ue.set(e,A(t,n)),i=!0}i&&me(),dt++,window.__ecsFound=C.length,window.__syncCount=dt}l&&setInterval(()=>{le()||ft().catch(e=>console.error(`live sync:`,e))},3e3);let pt=[];function mt(){if(!l)return pt=[],[];let e=kn();return e?(pt=e,window.__marchPositions=e,e.map(e=>({x:e.x,y:$(e.x,e.y)*13+2.2,z:e.y,color:e.own?Qe:$e}))):(pt=[],[])}let ht=document.getElementById(`labels`),gt=new Map,_t=1024;function vt(){let e=new Set,t=T.clientWidth,n=T.clientHeight;for(let r of C){let i=p.x[r],a=p.y[r],o=i-U.target[0],s=a-U.target[2];if(o*o+s*s>_t)continue;let c=$(i,a)*13+(g.get(r)??5)*.6+1.1,l=Ve(q,[i,c,a]);if(l.w<=.001)continue;let u=(l.x/l.w*.5+.5)*t,d=(1-(l.y/l.w*.5+.5))*n;if(u<-40||u>t+40||d<-40||d>n+40)continue;e.add(r);let f=gt.get(r);if(!f){let e=document.createElement(`div`);e.className=`wlabel`;let t=document.createElement(`div`);t.className=`nm`;let n=document.createElement(`div`);n.className=`lv`,e.appendChild(t),e.appendChild(n),ht.appendChild(e),f={root:e,nm:t,lv:n},gt.set(r,f)}f.nm.textContent=v.get(r)??`?`,f.nm.classList.toggle(`mine`,!!b.get(r)),f.lv.textContent=y.get(r)??``,f.root.style.transform=`translate(${u.toFixed(1)}px,${d.toFixed(1)}px) translate(-50%,-100%)`}for(let[t,n]of gt)e.has(t)||(n.root.remove(),gt.delete(t))}let yt=new Map;function bt(e,t,n,r){if(!r||!n||r<=n)return t;let i=Math.max(0,Math.min(1,(Date.now()-n)/(r-n)));return e+(t-e)*i}function xt(){let e=new Set,t=T.clientWidth,n=T.clientHeight;for(let r of pt){let i=r.battle;if(!i)continue;let a=r.x-U.target[0],o=r.y-U.target[2];if(a*a+o*o>_t)continue;let s=$(r.x,r.y)*13+2.2+1.6,c=Ve(q,[r.x,s,r.y]);if(c.w<=.001)continue;let l=(c.x/c.w*.5+.5)*t,u=(1-(c.y/c.w*.5+.5))*n;if(l<-60||l>t+60||u<-60||u>n+60)continue;e.add(r.id);let d=yt.get(r.id);if(!d){let e=document.createElement(`div`);e.className=`blabel`;let t=document.createElement(`div`);t.className=`btitle`;let n=document.createElement(`div`);n.className=`bbar atk`;let i=document.createElement(`i`);n.appendChild(i);let a=document.createElement(`div`);a.className=`bbar def`;let o=document.createElement(`i`);a.appendChild(o),e.appendChild(t),e.appendChild(n),e.appendChild(a),ht.appendChild(e),d={root:e,title:t,atkFill:i,defFill:o},yt.set(r.id,d)}let f=i.retreating,p=!f&&i.revealFromRound===0;d.root.className=`blabel`+(f?` retreat`:p?` deploy`:``),d.title.textContent=f?`Отступление`:p?`Развёртывание`:`Бой — раунд `+i.round;let m=Math.max(0,Math.min(100,bt(i.revealFromAttHp,i.attHpLeft,i.revealStart,i.revealAt)/Math.max(1,i.attStartHp)*100)),h=Math.max(0,Math.min(100,bt(i.revealFromDefHp,i.defHpLeft,i.revealStart,i.revealAt)/Math.max(1,i.defStartHp)*100));d.atkFill.style.width=m.toFixed(1)+`%`,d.defFill.style.width=h.toFixed(1)+`%`,d.root.style.transform=`translate(${l.toFixed(1)}px,${u.toFixed(1)}px) translate(-50%,-100%)`}for(let[t,n]of yt)e.has(t)||(n.root.remove(),yt.delete(t))}function St(e,t,n,r,i){let a=p.x[e],o=p.y[e],s=g.get(e)??5,c=Ve(t,[a,(_.get(e)??0)+s*.6,o]);if(c.w<=.001)return!1;let l=(c.x/c.w*.5+.5)*n,u=(1-(c.y/c.w*.5+.5))*r,d=i*s/c.w+24;return l>-d&&l<n+d&&u>-d&&u<r+d}function Ct(e){if(le()){requestAnimationFrame(Ct);return}W.isAutoOrbiting()&&(U.yaw=e*15e-5),W.update(e);let t=mt();if(nt!==null){let e=pt.find(e=>e.id===nt);e?(U.target[0]=e.x,U.target[2]=e.y,U.target[1]=$(e.x,e.y)*13+1):nt=null}Ye||(Fe.value=U.target[0].toFixed(1),ze.value=U.target[2].toFixed(1)),P(U.target[0],U.target[2]),z(U.target[0],U.target[2]);let n=performance.now()+6;_e(n),Se(n);let r=[U.target[0]+Math.sin(U.yaw)*Math.cos(U.pitch)*U.dist,U.target[1]+Math.sin(U.pitch)*U.dist,U.target[2]+Math.cos(U.yaw)*Math.cos(U.pitch)*U.dist],o=$(r[0],r[2])*13+2;r[1]<o&&(r[1]=o);let s=T.width/Math.max(1,T.height),c=Le(Re(ot,s,.5,300),He(r,U.target,[0,1,0]));q=c,J=r,E.setVP(c),E.setFog(r,i,a,e/1e3),E.setSunTarget(U.target[0],U.target[2]);{let t=G(Pe(r,U.target)),n=G(Ie([0,1,0],t)),i=Ie(t,n);E.setSkyCamera(n,i,t,Math.tan(ot/2),s,e/1e3)}if(B.setFog(r,i,a),tt!==null){let e=pt.find(e=>e.id===tt);e?Y={x:e.x,y:$(e.x,e.y)*13+3.2,z:e.y,color:Ze}:(tt=null,Y=null)}Y&&t.push(Y),E.setMarkers(t),window.__marchCount=t.length-+!!Y;let l=T.clientWidth,u=T.clientHeight,d=.5*u/Math.tan(ot/2),f=0;E.frame({r:i[0],g:i[1],b:i[2],a:1},e=>{for(let t of C){if(!St(t,c,l,u,d))continue;let n=V.get(t);n&&(B.draw(e,n,c),f++)}}),window.__modelDrawCount=f,vt(),xt(),requestAnimationFrame(Ct)}requestAnimationFrame(Ct),window.__engineReady=!0}Pn().catch(e=>{Nn([`Ошибка: ${e instanceof Error?e.message:String(e)}`]),console.error(e)});