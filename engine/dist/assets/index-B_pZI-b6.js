...
`,xt=.5,St=1.4,Ct=new Float32Array([0,St,0,xt,0,0,0,0,xt,0,St,0,0,0,xt,-.5,0,0,0,St,0,-.5,0,0,0,0,-.5,0,St,0,0,0,-.5,xt,0,0]),wt=Ct.length/3,Tt=7;async function Et(e,t,n){let r=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),i=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),a=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),o=e.createTexture({size:[dt,dt],format:`depth32float`,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}).createView(),s=e.createSampler({compare:`less`,magFilter:`linear`,minFilter:`linear`}),c=Be(-1,1,-1,1,.1,1),l=0,u=0;function d(t,n){l=t,u=n;let r=Ue([t+ut[0]*X,ut[1]*X,n+ut[2]*X],[t,0,n],[0,1,0]);c=Re(Be(-60,ft,-60,ft,pt,mt),r),e.queue.writeBuffer(a,0,c)}let[f,p,m,h,g,_,v,y,b,x,S]=await Promise.all([Y(e,`/textures/ground/sand.png`),Y(e,`/textures/ground/grass.png`),Y(e,`/textures/ground/dry_meadow.png`),Y(e,`/textures/ground/scree.png`),Y(e,`/textures/ground/rock.png`),Y(e,`/textures/ground/snow.png`),Y(e,`/textures/ground/forest_floor.png`),Y(e,`/textures/ground/desert.png`),Y(e,`/textures/ground/marsh.png`),Y(e,`/textures/ground/tundra_moss.png`),Y(e,`/textures/water/detail.png`)]),C=e.createSampler({addressModeU:`repeat`,addressModeV:`repeat`,magFilter:`linear`,minFilter:`linear`}),ee=e.createShaderModule({code:ht}),w=e.createRenderPipeline({layout:`auto`,vertex:{module:ee,entryPoint:`vs`,buffers:[{arrayStride:60,attributes:[{shaderLocation:0,offset:0,format:`float32x3`},{shaderLocation:1,offset:12,format:`float32x3`},{shaderLocation:2,offset:24,format:`float32x3`},{shaderLocation:3,offset:36,format:`float32x2`},{shaderLocation:4,offset:44,format:`float32`},{shaderLocation:5,offset:48,format:`float32`},{shaderLocation:6,offset:52,format:`float32`},{shaderLocation:7,offset:56,format:`float32`}]}]},fragment:{module:ee,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`,cullMode:`back`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),te=e.createBindGroup({layout:w.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}},{binding:2,resource:C},{binding:3,resource:f.createView()},{binding:4,resource:p.createView()},{binding:5,resource:m.createView()},{binding:6,resource:h.createView()},{binding:7,resource:g.createView()},{binding:8,resource:{buffer:a}},{binding:9,resource:s},{binding:10,resource:o},{binding:11,resource:_.createView()},{binding:12,resource:v.createView()},{binding:13,resource:y.createView()},{binding:14,resource:b.createView()},{binding:15,resource:x.createView()},{binding:16,resource:S.createView()}]}),[ne,re]=await Promise.all([Y(e,`/textures/sky/sky.png`),Y(e,`/textures/sky/clouds.png`)]),ie=e.createSampler({addressModeU:`repeat`,addressModeV:`clamp-to-edge`,magFilter:`linear`,minFilter:`linear`}),T=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),E=e.createShaderModule({code:bt}),ae=e.createRenderPipeline({layout:`auto`,vertex:{module:E,entryPoint:`vs`},fragment:{module:E,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`,cullMode:`none`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!1,depthCompare:`always`}}),oe=e.createBindGroup({layout:ae.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:T}},{binding:1,resource:ie},{binding:2,resource:ne.createView()},{binding:3,resource:re.createView()}]});function se(t,n,r,i,a,o){let s=new Float32Array([t[0],t[1],t[2],0,n[0],n[1],n[2],0,r[0],r[1],r[2],0,i,a,o,0]);e.queue.writeBuffer(T,0,s)}let D=e.createShaderModule({code:vt}),ce=e.createRenderPipeline({layout:`auto`,vertex:{module:D,entryPoint:`vs`,buffers:[{arrayStride:60,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]}]},primitive:{topology:`triangle-list`,cullMode:`back`},depthStencil:{format:`depth32float`,depthWriteEnabled:!0,depthCompare:`less`}}),le=e.createBindGroup({layout:ce.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:a}}]}),O=new Map,ue=e.createShaderModule({code:gt}),de=e.createBuffer({size:Ct.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(de,0,Ct);let fe=e.createRenderPipeline({layout:`auto`,vertex:{module:ue,entryPoint:`vs`,buffers:[{arrayStride:12,stepMode:`vertex`,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]},{arrayStride:28,stepMode:`instance`,attributes:[{shaderLocation:1,offset:0,format:`float32x3`},{shaderLocation:2,offset:12,format:`float32`},{shaderLocation:3,offset:16,format:`float32x3`}]}]},fragment:{module:ue,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),pe=e.createBindGroup({layout:fe.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}}]}),k=null,me=0,A=0,j=e.createShaderModule({code:_t});function M(t){let n=e.createBuffer({size:Math.max(t.vertexCount*10*4,4),usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),r=new Float32Array(t.vertexCount*10);for(let e=0;e<t.vertexCount;e++)r.set(t.positions.subarray(e*3,e*3+3),e*10),r.set(t.normals.subarray(e*3,e*3+3),e*10+3),r[e*10+6]=t.materialIds[e],r[e*10+7]=t.shades[e],r.set(t.uvs.subarray(e*2,e*2+2),e*10+8);return e.queue.writeBuffer(n,0,r),n}let he=await Promise.all(Object.entries({bark:`/textures/decor/bark.png`,birchBark:`/textures/decor/birch_bark.png`,conifer:`/textures/decor/conifer_a.png`,conifer2:`/textures/decor/conifer_b.png`,broadleaf:`/textures/decor/broadleaf.png`,autumn:`/textures/decor/autumn.png`,birchLeaf:`/textures/decor/birch_leaf.png`,bush:`/textures/decor/bush.png`,grassTuft:`/textures/decor/grass_tuft.png`}).map(async([t,n])=>[t,await Y(e,n)])),ge={...Object.fromEntries(he),rock:g},_e=e.createSampler({magFilter:`linear`,minFilter:`linear`}),N={spruce:{trunk:`bark`,canopy:`conifer`},pine:{trunk:`bark`,canopy:`conifer2`},broadleaf:{trunk:`bark`,canopy:`broadleaf`},autumn:{trunk:`bark`,canopy:`autumn`},birch:{trunk:`birchBark`,canopy:`birchLeaf`},dead:{trunk:`bark`,canopy:`bark`},bush:{trunk:`bark`,canopy:`bush`},grass:{trunk:`bark`,canopy:`grassTuft`},rock:{trunk:`bark`,canopy:`rock`}},ve={spruce:Xe,pine:Ze,broadleaf:Qe,autumn:Qe,birch:$e,dead:et,bush:tt,grass:nt,rock:lt},ye=[{arrayStride:40,stepMode:`vertex`,attributes:[{shaderLocation:0,offset:0,format:`float32x3`},{shaderLocation:1,offset:12,format:`float32x3`},{shaderLocation:2,offset:24,format:`float32`},{shaderLocation:3,offset:28,format:`float32`},{shaderLocation:4,offset:32,format:`float32x2`}]},{arrayStride:40,stepMode:`instance`,attributes:[{shaderLocation:5,offset:0,format:`float32x3`},{shaderLocation:6,offset:12,format:`float32x3`},{shaderLocation:7,offset:24,format:`float32`},{shaderLocation:8,offset:28,format:`float32x3`}]}],P=e.createRenderPipeline({layout:`auto`,vertex:{module:j,entryPoint:`vs`,buffers:ye},fragment:{module:j,entryPoint:`fs`,targets:[{format:n}]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!0,depthCompare:`less`}}),F=e.createShaderModule({code:yt}),I=e.createRenderPipeline({layout:`auto`,vertex:{module:F,entryPoint:`vs`,buffers:ye},fragment:{module:F,entryPoint:`fs`,targets:[]},primitive:{topology:`triangle-list`},depthStencil:{format:`depth32float`,depthWriteEnabled:!0,depthCompare:`less`}}),L=new Map;for(let t of Object.keys(N)){let n=ve[t](),c=N[t],l=e.createBindGroup({layout:P.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:r}},{binding:1,resource:{buffer:i}},{binding:2,resource:_e},{binding:3,resource:ge[c.trunk].createView()},{binding:4,resource:ge[c.canopy].createView()},{binding:5,resource:{buffer:a}},{binding:6,resource:s},{binding:7,resource:o}]}),u=e.createBindGroup({layout:I.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:a}},{binding:1,resource:_e},{binding:2,resource:ge[c.canopy].createView()}]});L.set(t,{mesh:n,localBuf:M(n),instBuf:null,instCapacity:0,instanceCount:0,bindGroup:l,shadowBindGroup:u})}let R=null,be=null;function xe(){let n=t.canvas.width,r=t.canvas.height;R&&R.width===n&&R.height===r||(R?.destroy(),R=e.createTexture({size:[n,r],format:`depth24plus`,usage:GPUTextureUsage.RENDER_ATTACHMENT}),be=R.createView())}function Se(t,n){O.get(t)?.buf.destroy();let r=e.createBuffer({size:Math.max(n.vertexCount*15*4,4),usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),i=new Float32Array(n.vertexCount*15),a=1/0,o=-1/0,s=1/0,c=-1/0;for(let e=0;e<n.vertexCount;e++){let t=n.positions[e*3],r=n.positions[e*3+2];t<a&&(a=t),t>o&&(o=t),r<s&&(s=r),r>c&&(c=r),i.set(n.positions.subarray(e*3,e*3+3),e*15),i.set(n.colors.subarray(e*3,e*3+3),e*15+3),i.set(n.normals.subarray(e*3,e*3+3),e*15+6),i.set(n.uvs.subarray(e*2,e*2+2),e*15+9),i[e*15+11]=n.elevations[e],i[e*15+12]=n.waterFlags[e],i[e*15+13]=n.forestFracs[e],i[e*15+14]=n.moistureFracs[e]}e.queue.writeBuffer(r,0,i),O.set(t,{buf:r,vertexCount:n.vertexCount,minX:a,maxX:o,minZ:s,maxZ:c})}function z(e){let t=O.get(e);t&&(t.buf.destroy(),O.delete(e))}function Ce(t){A=t.length;let n=new Float32Array(A*Tt);t.forEach((e,t)=>{let r=t*Tt;n[r]=e.x,n[r+1]=e.y,n[r+2]=e.z,n[r+3]=1,n[r+4]=e.color[0],n[r+5]=e.color[1],n[r+6]=e.color[2]}),A>me&&(k?.destroy(),me=Math.max(A,8),k=e.createBuffer({size:me*Tt*4,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST})),k&&n.byteLength>0&&e.queue.writeBuffer(k,0,n)}function we(t,n){let r=t.length,i=new Float32Array(r*10);t.forEach((e,t)=>{let n=t*10;i[n]=e.x,i[n+1]=e.y,i[n+2]=e.z,i[n+3]=e.scale[0],i[n+4]=e.scale[1],i[n+5]=e.scale[2],i[n+6]=e.yaw,i[n+7]=e.color[0],i[n+8]=e.color[1],i[n+9]=e.color[2]}),n.instanceCount=r,r>n.instCapacity&&(n.instBuf?.destroy(),n.instCapacity=Math.max(r,8),n.instBuf=e.createBuffer({size:n.instCapacity*10*4,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST})),n.instBuf&&i.byteLength>0&&e.queue.writeBuffer(n.instBuf,0,i)}function Te(e){for(let[t,n]of L)we(e.filter(e=>e.kind===t),n)}function B(t){e.queue.writeBuffer(r,0,t)}function Ee(t,n,r,a){let o=new Float32Array([t[0],t[1],t[2],a,n[0],n[1],n[2],r]);e.queue.writeBuffer(i,0,o)}function V(n,r){xe();let i=e.createCommandEncoder();{let e=i.beginRenderPass({colorAttachments:[],depthStencilAttachment:{view:o,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}}),t=l-ft,n=l+ft,r=u-ft,a=u+ft;if(O.size>0){e.setPipeline(ce),e.setBindGroup(0,le);for(let i of O.values())i.vertexCount!==0&&(i.maxX<t||i.minX>n||i.maxZ<r||i.minZ>a||(e.setVertexBuffer(0,i.buf),e.draw(i.vertexCount)))}let s=!1;for(let e of L.values())if(e.instanceCount>0){s=!0;break}if(s){e.setPipeline(I);for(let t of L.values())t.instanceCount===0||!t.instBuf||(e.setBindGroup(0,t.shadowBindGroup),e.setVertexBuffer(0,t.localBuf),e.setVertexBuffer(1,t.instBuf),e.draw(t.mesh.vertexCount,t.instanceCount))}e.end()}let a=t.getCurrentTexture().createView(),s=i.beginRenderPass({colorAttachments:[{view:a,clearValue:n,loadOp:`clear`,storeOp:`store`}],depthStencilAttachment:{view:be,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}});if(s.setPipeline(ae),s.setBindGroup(0,oe),s.draw(3),O.size>0){s.setPipeline(w),s.setBindGroup(0,te);for(let e of O.values())e.vertexCount!==0&&(s.setVertexBuffer(0,e.buf),s.draw(e.vertexCount))}A>0&&k&&(s.setPipeline(fe),s.setBindGroup(0,pe),s.setVertexBuffer(0,de),s.setVertexBuffer(1,k),s.draw(wt,A));let c=!1;for(let e of L.values())if(e.instanceCount>0){c=!0;break}if(c){s.setPipeline(P);for(let e of L.values())e.instanceCount===0||!e.instBuf||(s.setBindGroup(0,e.bindGroup),s.setVertexBuffer(0,e.localBuf),s.setVertexBuffer(1,e.instBuf),s.draw(e.mesh.vertexCount,e.instanceCount))}r?.(s),s.end(),e.queue.submit([i.finish()])}function De(){return{lightBuf:a,shadowView:o,shadowSampler:s}}return{setTerrainChunk:Se,removeTerrainChunk:z,setMarkers:Ce,setDecor:Te,setVP:B,setFog:Ee,setSunTarget:d,setSkyCamera:se,getShadowResources:De,frame:V}}var Z=12345,Dt=.235,Ot=2400,kt=1200,At=Ot/2;kt/2;var jt=2.5;function Q(e,t,n){let r=e*374761393+t*668265263+n*1274126177;return r=Math.imul(r^r>>>13,1274126177),((r^r>>>16)>>>0)/4294967296}function Mt(e,t,n){let r=Math.floor(e),i=Math.floor(t),a=e-r,o=t-i,s=a*a*(3-2*a),c=o*o*(3-2*o),l=Q(r,i,n),u=Q(r+1,i,n),d=Q(r,i+1,n),f=Q(r+1,i+1,n);return(l*(1-s)+u*s)*(1-c)+(d*(1-s)+f*s)*c}var Nt=null,Pt=null,Ft=null;async function It(e,t){let n=await fetch(e);if(!n.ok)throw Error(`${e}: HTTP ${n.status}`);let r=await n.arrayBuffer();if(r.byteLength!==t)throw Error(`${e}: неверный размер (${r.byteLength} байт, ожидалось ${t})`);return r}async function Lt(){let e=Ot*kt,[t,n,r]=await Promise.all([It(`/heightmap/elevation-v6.bin`,e*2),It(`/heightmap/forest.bin`,e),It(`/heightmap/moisture.bin`,e)]);Nt=new Uint16Array(t),Pt=new Uint8Array(n),Ft=new Uint8Array(r)}function Rt(e,t,n,r){let i=Math.floor(t),a=Math.floor(n),o=Math.min(i+1,2399),s=Math.min(a+1,1199),c=t-i,l=n-a,u=a*Ot+i,d=a*Ot+o,f=s*Ot+i,p=s*Ot+o,m=e[u]+(e[d]-e[u])*c;return(m+(e[f]+(e[p]-e[f])*c-m)*l)*r}function zt(e,t){return[Math.max(0,Math.min(2399,e+At)),Math.max(0,Math.min(1199,t+600))]}function Bt(e,t){if(!Nt)return .285;let[n,r]=zt(e,t);return Rt(Nt,n,r,jt/65535)}function Vt(e,t){let n=Bt(e,t),r=(Bt(e+.7,t)+Bt(e-.7,t)+Bt(e,t+.7)+Bt(e,t-.7))*.25;return n*.55+r*.45}var Ht=32,Ut=new Map;function Wt(e,t){return Math.floor(e/Ht)+`,`+Math.floor(t/Ht)}function Gt(e,t,n){let r={x:e,z:t,targetH:Vt(e,t),radius:n},i=Wt(e,t),a=Ut.get(i);a?a.push(r):Ut.set(i,[r])}function $(e,t){let n=Bt(e,t);if(n<.235||Ut.size===0)return n;let r=Math.floor(e/Ht),i=Math.floor(t/Ht),a=null,o=0;for(let n=-1;n<=1;n++)for(let s=-1;s<=1;s++){let c=Ut.get(r+s+`,`+(i+n));if(c)for(let n of c){let r=Math.hypot(e-n.x,t-n.z);if(r>=n.radius)continue;let i=n.radius*.55,s=r<=i?1:1-((r-i)/(n.radius-i))**2*(3-2*((r-i)/(n.radius-i)));s>o&&(o=s,a=n)}}return a?n*(1-o)+a.targetH*o:n}function Kt(e,t){return $(e,t)<Dt}function qt(e,t){if(!Ft)return .5;let[n,r]=zt(e,t);return Rt(Ft,n,r,1/255)}function Jt(e,t){if(!Pt)return 0;let[n,r]=zt(e,t);return Rt(Pt,n,r,1/255)}var Yt=(e,t,n)=>[e[0]+(t[0]-e[0])*n,e[1]+(t[1]-e[1])*n,e[2]+(t[2]-e[2])*n],Xt=[.14,.24,.28],Zt=[.05,.11,.19];function Qt(e){return Yt(Xt,Zt,Math.min(1,e))}var $t=[0,1,0],en=6;function tn(e,t){let n=.5,r=$(e-n,t)*13,i=$(e+n,t)*13,a=$(e,t-n)*13,o=$(e,t+n)*13;return W([-(i-r)/(2*n),1,-(o-a)/(2*n)])}function nn(e,t,n,r,i=1,a=0){let o=Math.round((n-e)/i),s=Math.round((r-t)/i),c=i===1,l=[],u=[],d=[],f=[],p=[],m=[],h=[],g=[];function _(e,t){let n=$(e,t),r=n<Dt,i=r?[e,Dt*13-a,t]:[e,n*13-a,t],o=r?Qt((Dt-n)*3):[0,0,0],s=r?$t:c?tn(e,t):$t,l=r?0:Jt(e,t),u=r?0:qt(e,t);return{p:i,c:o,n:s,uv:[e/en,t/en],e:n,water:+!!r,forest:l,moisture:u}}let v=[];for(let n=0;n<=s;n++){let r=[];for(let a=0;a<=o;a++)r.push(_(e+a*i,t+n*i));v.push(r)}function y(e,t,n){let r=c?null:W(Le(Fe(t.p,e.p),Fe(n.p,e.p)));for(let i of[e,t,n]){l.push(i.p[0],i.p[1],i.p[2]),u.push(i.c[0],i.c[1],i.c[2]);let e=r??i.n;d.push(e[0],e[1],e[2]),f.push(i.uv[0],i.uv[1]),p.push(i.e),m.push(i.water),h.push(i.forest),g.push(i.moisture)}}for(let e=0;e<s;e++)for(let t=0;t<o;t++){let n=v[e][t],r=v[e][t+1],i=v[e+1][t],a=v[e+1][t+1];y(n,a,r),y(n,i,a)}return{positions:new Float32Array(l),colors:new Float32Array(u),normals:new Float32Array(d),uvs:new Float32Array(f),elevations:new Float32Array(p),waterFlags:new Float32Array(m),forestFracs:new Float32Array(h),moistureFracs:new Float32Array(g),vertexCount:l.length/3}}var rn=9,an=140,on=10,sn=380,cn={d:[1,0],arrowright:[1,0],a:[-1,0],arrowleft:[-1,0],w:[0,1],arrowup:[0,1],s:[0,-1],arrowdown:[0,-1]},ln=700;function un(e,t){let n=!0,r=new Map,i=null,a=null,o=null,s=null,c=null;function l(){n=!1,c?.()}function u(){let e=[...r.values()];return{x:(e[0].x+e[1].x)/2,y:(e[0].y+e[1].y)/2,d:Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y)}}function d(){let e=[...r.values()];return Math.atan2(e[1].y-e[0].y,e[1].x-e[0].x)}function f(e,n){let r=t.dist*.0022,i=e*r,a=n*r,o=Math.cos(t.yaw),s=Math.sin(t.yaw);t.target[0]=Math.max(-At,Math.min(At,t.target[0]-(i*o-a*s))),t.target[2]=Math.max(-600,Math.min(600,t.target[2]+(i*s+a*o))),t.target[1]=$(t.target[0],t.target[2])*13+1}e.addEventListener(`pointerdown`,n=>{n.preventDefault(),l(),r.set(n.pointerId,{x:n.clientX,y:n.clientY});try{e.setPointerCapture(n.pointerId)}catch{}if(r.size===1)i={x:n.clientX,y:n.clientY,tx:t.target[0],tz:t.target[2]},o={x:n.clientX,y:n.clientY,t:performance.now()};else if(r.size===2){i=null,o=null;let e=u();a={d:e.d,y:e.y,dist:t.dist,yaw:t.yaw,pitch:t.pitch,angle:d()}}}),e.addEventListener(`pointermove`,e=>{if(r.has(e.pointerId)){if(e.preventDefault(),r.set(e.pointerId,{x:e.clientX,y:e.clientY}),o&&Math.hypot(e.clientX-o.x,e.clientY-o.y)>on&&(o=null),r.size>=2&&a){let e=u();t.dist=Math.max(rn,Math.min(an,a.dist*(a.d/Math.max(12,e.d)))),t.yaw=a.yaw+(d()-a.angle),t.pitch=Math.max(.08,Math.min(1.42,a.pitch+(e.y-a.y)*.005));return}i&&(t.target[0]=i.tx,t.target[2]=i.tz,f(e.clientX-i.x,i.y-e.clientY))}});function p(e){if(o&&r.size===1&&performance.now()-o.t<sn&&s?.(o.x,o.y),o=null,r.delete(e.pointerId),r.size<2&&(a=null),r.size===0)i=null;else if(r.size===1){let e=[...r.values()][0];i={x:e.x,y:e.y,tx:t.target[0],tz:t.target[2]}}}e.addEventListener(`pointerup`,p),e.addEventListener(`pointercancel`,p),e.addEventListener(`wheel`,e=>{e.preventDefault(),l(),t.dist=Math.max(rn,Math.min(an,t.dist*(e.deltaY<0?.9:1.11)))},{passive:!1});let m=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();t in cn&&(m.add(t),l())}),window.addEventListener(`keyup`,e=>{m.delete(e.key.toLowerCase())});let h=null;function g(e){if(h===null){h=e;return}let t=Math.min(.1,(e-h)/1e3);if(h=e,m.size===0||i)return;let n=0,r=0;for(let e of m){let[t,i]=cn[e];n+=t,r+=i}(n!==0||r!==0)&&f(n*ln*t,r*ln*t)}return{isAutoOrbiting:()=>n,stopAuto:l,update:g,onTap(e){s=e},onInteract(e){c=e}}}var dn={5121:Uint8Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},fn={SCALAR:1,VEC2:2,VEC3:3,VEC4:4};async function pn(e){let t=await(await fetch(e)).arrayBuffer(),n=new DataView(t);if(n.getUint32(0,!0)!==1179937895)throw Error(`не glTF-контейнер: `+e);let r=n.getUint32(8,!0),i=12,a=null,o=null;for(;i<r;){let e=n.getUint32(i,!0),r=n.getUint32(i+4,!0),s=t.slice(i+8,i+8+e);r===1313821514?a=JSON.parse(new TextDecoder().decode(s)):r===5130562&&(o=s),i+=8+e}if(!a||!o)throw Error(`GLB без JSON/BIN чанка: `+e);let s=e=>a.accessors[e],c=e=>a.bufferViews[e];function l(e){let t=s(e),n=c(t.bufferView),r=dn[t.componentType],i=(n.byteOffset||0)+(t.byteOffset||0);return new r(o,i,t.count*fn[t.type])}let u=a.meshes[0].primitives[0],d=l(u.attributes.POSITION),f=l(u.attributes.NORMAL),p=l(u.attributes.TEXCOORD_0),m=l(u.indices),h=a.materials[u.material].pbrMetallicRoughness.baseColorTexture.index,g=a.images[a.textures[h].source],_=c(g.bufferView);return{positions:d,normals:f,uvs:p,indices:m,imageBytes:o.slice(_.byteOffset||0,(_.byteOffset||0)+_.byteLength),imageMimeType:g.mimeType}}var mn=`
